...
public class DelegatingDataTreeListener<T extends DataObject> implements AutoCloseable, DataTreeChangeListener<T> {
    ...
    protected NetvirtSfcClassifierDataProcessorBase<T> dataProcessor;
    ...
    public DelegatingDataTreeListener(NetvirtSfcClassifierDataProcessorBase<T> dataProcessor,
                                      DataBroker db, DataTreeIdentifier<T> treeId) {
        this.dataProcessor = Preconditions.checkNotNull(dataProcessor, "dataProcessor can not be null!");
