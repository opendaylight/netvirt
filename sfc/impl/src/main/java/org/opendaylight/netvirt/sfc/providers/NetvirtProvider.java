...
public class NetvirtProvider {
    ...
    public NetvirtProvider(final DataBroker dataBroker, final MDSALUtil mdsalUtils) {
    ...
    public Optional<List<String>> getLogicalInterfacesFromNeutronNetwork(NeutronNetwork nw) {
        ...
        Optional<NetworkMap> networkMap =
                mdsalUtils.read(LogicalDatastoreType.CONFIGURATION, networkMapIdentifier, dataBroker);
        ...
        for(Uuid subnetUuid : subnetUuidList) {
            ...
            Optional<Subnetmap> subnet = mdsalUtils.read(LogicalDatastoreType.CONFIGURATION, subnetId, dataBroker);
    ...
    private String getNeutronPort(Uuid portUuid) {
        ...
        Optional<Port> port = mdsalUtils.read(LogicalDatastoreType.CONFIGURATION, instId, dataBroker);
