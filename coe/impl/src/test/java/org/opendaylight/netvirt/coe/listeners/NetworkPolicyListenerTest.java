...
public class NetworkPolicyListenerTest extends AbstractConcurrentDataBrokerTest {
    ...
    public void testNetworkPolicy() throws ExecutionException, InterruptedException {
        ...
        NetworkPolicy networkPolicy = buildNetworkPolicy(policyUuid, policyName, networkPolicySpec);
        ...
        LoggingFutures.addErrorLogging(txRunner.callWithNewWriteOnlyTransactionAndSubmit(CONFIGURATION, tx -> {
            tx.mergeParentStructureMerge(networkPolicyIid, networkPolicy);
        ...
        verifyAce(policyUuid, "11111111-1111-1111-1111-111111111111_ingress_port_TCP_53");
        verifyAce(policyUuid, "11111111-1111-1111-1111-111111111111_ingress_port_UDP_53");
        verifyAce(policyUuid, "11111111-1111-1111-1111-111111111111_ingress_peer_cidr_10.1.1.1/16");
        verifyAce(policyUuid, "11111111-1111-1111-1111-111111111111_egress_port_TCP_53");
        verifyAce(policyUuid, "11111111-1111-1111-1111-111111111111_egress_port_UDP_53");
        verifyAce(policyUuid, "11111111-1111-1111-1111-111111111111_egress_peer_cidr_10.1.1.1/16");
    }
    ...
    private void verifyAce(String policyUuid, String ruleName) {
