...
public class TerminationPointStateListener extends
    ...
    private static void unbindService(ManagedNewTransactionRunner txRunner, JobCoordinator coordinator,
    ...
    private static void bindKubeProxyService(ReadWriteTransaction tx, String interfaceName) {
        ...
        InstanceIdentifier<BoundServices> boundServicesInstanceIdentifier = buildBoundServicesIId(
                serviceInfo.getServicePriority(), interfaceName, ServiceModeIngress.class);
        tx.put(LogicalDatastoreType.CONFIGURATION, boundServicesInstanceIdentifier, serviceInfo,true);
    }

    private static InstanceIdentifier<BoundServices> buildBoundServicesIId(
            short servicePriority, String interfaceName, Class<? extends ServiceModeBase> serviceMode) {
