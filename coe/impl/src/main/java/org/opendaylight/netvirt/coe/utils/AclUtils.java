...
public final class AclUtils {
    ...
    @Nonnull
    public static String buildName2(String string1, String string2) {
        return String.join("_", string1, string2);
    }

    @Nonnull
    public static String buildName3(String string1, String string2, String string3) {
        return String.join("_", string1, string2, string3);
    }
}
