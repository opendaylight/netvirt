...
public class NeutronSecurityRuleListener
    ...
    protected void remove(InstanceIdentifier<SecurityRule> instanceIdentifier, SecurityRule securityRule) {
        ...
        try {
            ...
            /*
            Changing to WARN, if an out of sequence event occurs and newly introduced SG Listener deletes parent-node
            ("access-lists") before child-node ("ace") entries are deleted.
            This might result in Exception, but not error. Since child node deletion is handled as part of SG deletion.
             */
