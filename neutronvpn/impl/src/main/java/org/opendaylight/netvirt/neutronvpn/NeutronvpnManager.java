...
import org.opendaylight.yang.gen.v1.urn.huawei.params.xml.ns.yang.l3vpn.rev150602.vpn.instances.vpn.instance.VpnTargets;
import org.opendaylight.yang.gen.v1.urn.huawei.params.xml.ns.yang.l3vpn.rev150602.vpn.instances.vpn.instance.VpnTargetsBuilder;
import org.opendaylight.yang.gen.v1.urn.huawei.params.xml.ns.yang.l3vpn.rev150602.vpn.instances.vpn.instance.vpntargets.VpnTarget;
import org.opendaylight.yang.gen.v1.urn.huawei.params.xml.ns.yang.l3vpn.rev150602.vpn.instances.vpn.instance.vpntargets.VpnTargetBuilder;
import org.opendaylight.yang.gen.v1.urn.huawei.params.xml.ns.yang.l3vpn.rev150602.vpn.instances.vpn.instance.vpntargets.VpnTargetKey;
...
public class NeutronvpnManager implements NeutronvpnService, AutoCloseable, EventListener {
    ...
    public void createL3InternalVpn(Uuid vpn, @Nullable String name, @Nullable Uuid tenant, @Nullable List<String> rd,
        ...
        updateVpnInstanceNode(vpn, rd, irt, ert, false /*isL2Vpn*/, 0 /*l3vni*/, ipVersChoices);
