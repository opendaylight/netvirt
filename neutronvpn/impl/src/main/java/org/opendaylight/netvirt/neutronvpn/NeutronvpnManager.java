...
public class NeutronvpnManager implements NeutronvpnService, AutoCloseable, EventListener {
     ...
     */
    public void createVpn(Uuid vpnId, String name, Uuid tenantId, List<String> rdList, List<String> irtList, List<String> ertList,
                          Uuid routerId, List<Uuid> networkList, VpnInstance.Type type, long l3vni)
                                    throws Exception {
...
//                    interfaces.add(routerInterface);
    ...
    protected List<String> associateNetworksToVpn(@Nonnull Uuid vpnId, @Nonnull List<Uuid> networkList) {
        ...
        LOG.debug("Network(s) {} associated to L3VPN {} successfully", passedNwList.toString(), vpnId.getValue());
        return failedNwList;
    }
    ...
    protected List<String> dissociateNetworksFromVpn(@Nonnull Uuid vpnId, @Nonnull List<Uuid> networkList) {
        ...
        LOG.debug("Network(s) {} disassociated from L3VPN {} successfully", passedNwList.toString(),
                vpnId.getValue());
        return failedNwList;
    }
