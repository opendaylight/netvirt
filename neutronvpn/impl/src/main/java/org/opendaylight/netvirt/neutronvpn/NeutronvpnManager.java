        ...
        if (neutronvpnUtils.isV6SubnetPartOfRouter(routerId)) {
            ...
            for (Subnetmap sm : snList) {
                ...
                if (addOrRemove == NwConstants.ADD_FLOW) {
                    ...
                    /* This method will get executed only on when internet VPN is getting disassociated
                     * from external network after router-gw is been set with external network.
                     */
                    neutronvpnUtils.updateVpnInstanceWithIpFamily(internetVpnId.getValue(), IpVersionChoice.IPV6,
                            false);
                    LOG.info("programV6InternetFlows: withdraw IPv6 Private subnet {} from Internet VPN {}",
                            sm.getId().getValue(), internetVpnId.getValue());
                }
