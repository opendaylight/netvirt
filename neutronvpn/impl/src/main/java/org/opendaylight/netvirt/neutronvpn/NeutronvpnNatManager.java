...
public class NeutronvpnNatManager implements AutoCloseable {
    ...
    private void addExternalNetworkToRouter(Router update) {
        ...
        Map<ExternalFixedIpsKey, ExternalFixedIps> externalFixedIps = update.getExternalGatewayInfo().getExternalFixedIps();
        ...
        try {
            ...
            updateExternalSubnetsForRouter(routerId, extNetId,
                    new ArrayList<ExternalFixedIps>(externalFixedIps.values()));
        ...
        for (String infName : extElanInterfaces) {
            ...
            try {
                ...
                if (optionalAdjacencies.isPresent()) {
                    Map<AdjacencyKey, Adjacency> adjacencies = optionalAdjacencies.get().getAdjacency();
                    Iterator<Adjacency> adjacencyIter = adjacencies.values().iterator();
