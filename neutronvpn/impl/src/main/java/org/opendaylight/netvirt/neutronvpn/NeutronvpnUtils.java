...
public class NeutronvpnUtils {
    ...
    public boolean shouldVpnHandleIpVersionChoiceChange(IpVersionChoice ipVersion, Uuid routerId, boolean add) {
        ...
        /* ADD: Update vpnInstanceOpDataEntry with address family only on first IPv4/IPv6 address family
         * for the VPN Instance.
         *
         * REMOVE: Update vpnInstanceOpDataEntry with address family only on last IPv4/IPv6 address family
         * for the VPN Instance.
         */
