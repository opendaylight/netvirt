...
public class NeutronNetItUtil {
     ...
     * @param secGroups Optional NeutronSecurityGroup objects {@see org.opendaylight.netvirt.utils.neutron.utils.NeutronUtils#createNeutronSecurityGroup(String, NeutronSecurityRule...)}
     * @throws InterruptedException if we're interrupted while waiting for objects to be created
     */
