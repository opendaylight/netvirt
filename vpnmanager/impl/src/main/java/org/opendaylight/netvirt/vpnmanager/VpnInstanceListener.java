    ...
    private class AddVpnInstanceWorker implements Callable<List<ListenableFuture<Void>>> {
        ...
        public List<ListenableFuture<Void>> call() {
            ...
            futures.add(txRunner.callWithNewWriteOnlyTransactionAndSubmit(CONFIGURATION, confTx -> {
                ...
                ListenableFutures.addErrorLogging(future, LOG, "{} call: error creating VPN {} rd {}",LOGGING_PREFIX_ADD,
                        vpnInstance.getVpnInstanceName(), vpnInstance.getIpv4Family().getRouteDistinguisher());
                futures.add(future);
            }));
