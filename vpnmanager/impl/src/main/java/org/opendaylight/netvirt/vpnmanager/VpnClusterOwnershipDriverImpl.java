...
@Singleton
public class VpnClusterOwnershipDriverImpl implements IVpnClusterOwnershipDriver, EntityOwnershipListener, AutoCloseable {

    private static final Logger LOG = LoggerFactory.getLogger(VpnClusterOwnershipDriverImpl.class);
    ...
    private String VPN_SERVICE_ENTITY = "VPN_SERVICE";
    private boolean amIOwner = false;

    @Inject
    public VpnClusterOwnershipDriverImpl(final EntityOwnershipService entityOwnershipService) {
