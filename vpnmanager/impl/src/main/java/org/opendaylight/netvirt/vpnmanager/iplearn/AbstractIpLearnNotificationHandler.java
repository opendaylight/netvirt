...
public abstract class AbstractIpLearnNotificationHandler {
    ...
    protected void handlePacketReceived(String srcInterface, IpAddress srcIP, MacAddress srcMac,
        ...
        if (srcSubnetId == null || metadata == null || Objects.equals(metadata, BigInteger.ZERO)) {
            String msg = srcSubnetId == null ? "srcSubnetId is null," : "Metadata is null or zero,";
            LOG.debug("{} ignoring IP learning for interface={}, srcIP={}, srcMAC={}, srcSubnetId={}, targetIP={}", msg,
