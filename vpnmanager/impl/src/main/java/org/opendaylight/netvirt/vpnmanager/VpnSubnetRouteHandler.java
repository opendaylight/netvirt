...
public class VpnSubnetRouteHandler {
    ...
    public void onSubnetAddedToVpn(Subnetmap subnetmap, boolean isBgpVpn, Long elanTag, BgpvpnType bgpVpnType) {
        ...
        try {
            ...
            LOG.error("{} onSubnetAddedToVpn: Unable to add subnet {} with ip {} to vpn {} ",
        ...
        try {
            ...
            try {
                ...
                LOG.error("{} onSubnetDeletedFromVpn: Removal of SubnetOpDataEntry for subnet {} with subnetIp {}"
                          + " vpnId {} failed ", LOGGING_PREFIX, subnetId.getValue(),
            ...
            LOG.error("{} onSubnetDeletedFromVpn: Unable to handle subnet {} with Ip {} removed from vpn {} ",
                      LOGGING_PREFIX, subnetId.getValue(), subnetmap.getSubnetIp(), vpnId.getValue(), e);
        }
    }
            ...
            try {
                ...
                try {
                    ...
                    LOG.error("{} onPortAddedToSubnet: Unable to obtain dpnId for interface {} from subnet {} "
                              + "subnetIp {} vpn {} rd {}. Subnetroute inclusion failed ",
                ...
                LOG.error("{} onPortAddedToSubnet: subnetOpEntry update for port {} from subnet {} failed ",
    ...
    public void onInterfaceUp(BigInteger dpnId, String intfName, Uuid subnetId) {
        ...
        try {
            ...
            try {
                ...
                LOG.error("{} onInterfaceUp: SubnetOpDataEntry update for subnet {} on port {} UP event failed ",
                          LOGGING_PREFIX, subnetId.getValue(), intfName, ex);
            } finally {
                VpnUtil.unlockSubnet(lockManager, subnetId.getValue());
            }
        } catch (RuntimeException e) {
            LOG.error("{} onInterfaceUp: Unable to handle interface UP event for port {} from subnet {} ",
        ...
        try {
            ...
            try {
                ...
                LOG.error("{} onInterfaceDown: SubnetOpDataEntry update on interface {} DOWN event for subnet {} "
                          + "failed ", LOGGING_PREFIX, interfaceName, subnetId.getValue(), ex);
            } finally {
                VpnUtil.unlockSubnet(lockManager, subnetId.getValue());
            }
        } catch (RuntimeException e) {
            LOG.error("{} onInterfaceDown: Unable to handle interface DOWN event for port {} from subnet {} ",
    ...
    public void updateSubnetRouteOnTunnelUpEvent(Uuid subnetId, BigInteger dpnId) {
        ...
        try {
            ...
            try {
                ...
                LOG.error("{} updateSubnetRouteOnTunnelUpEvent: update subnetRoute for subnet {} on dpn {} failed ",
    ...
    public void updateSubnetRouteOnTunnelDownEvent(Uuid subnetId, BigInteger dpnId) {
        ...
        try {
            ...
            try {
                ...
                LOG.error("{} updateSubnetRouteOnTunnelDownEvent: SubnetOpDataEntry update for subnet {} on dpn {} "
                          + "failed ", LOGGING_PREFIX, subnetId.getValue(), dpnId, ex);
            } finally {
                VpnUtil.unlockSubnet(lockManager, subnetId.getValue());
            }
        } catch (RuntimeException e) {
