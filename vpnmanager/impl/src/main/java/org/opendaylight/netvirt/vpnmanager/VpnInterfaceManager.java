...
public class VpnInterfaceManager extends AsyncDataTreeChangeListenerBase<VpnInterface, VpnInterfaceManager> {
    ...
    protected void update(final InstanceIdentifier<VpnInterface> identifier, final VpnInterface original,
        ...
        final BigInteger dpnId = vpnUtil.getDpnIdForVpnInterface(ifaceMgrRpcService, vpnInterfaceName);
    ...
    private boolean handleVpnInstanceUpdateForVpnInterface(InstanceIdentifier<VpnInterface> identifier,
        ...
        if (!oldVpnList.isEmpty() || !newVpnList.isEmpty()) {
            /* Internet BGP-VPN Instance update in dual router:
             * ================================================
             ...
             *     Third VPN Instance type will be Internet BGP-VPN for public network access.
             *
             * Update VPN Instance for ADD: oldVpnList = 0 and newVpnList = 1 (any VPN type)
             * Update VPN Instance for REMOVE: oldVpnList = 1 and newVpnList = 0 (any VPN type)
             *
             ...
             *
             * Update VPN Instance for ADD: oldVpnList = 0 and newVpnList = 1 (Internet BGP-VPN)
             * Update VPN Instance for REMOVE: oldVpnList = 1 and newVpnList = 0 (Internet BGP-VPN)
             *
             * External BGP-VPN Instance update with router:
             * =============================================
             ...
             *
             * Update VPN Instance for ADD: oldVpnList = 1 and newVpnList = 1 (internal VPN to Ext-BGPVPN)
             * Update VPN Instance for REMOVE: oldVpnList = 1 and newVpnList = 1 (Ext-BGPVPN to internal VPN)
             */
