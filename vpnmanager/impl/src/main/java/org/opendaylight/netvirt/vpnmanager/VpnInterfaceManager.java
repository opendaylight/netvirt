        ...
        if (adjacencies.isPresent() && !adjacencies.get().getAdjacency().isEmpty()) {
            ...
            for (Adjacency nextHop : nextHops) {
                ...
                if (vpnPortipToPort != null) {
                    ...
                    LOG.info("removeAdjacenciesFromVpn: VpnInterfaceManager removed vpnPortipToPort for Interface {}"
                             + " ip {} on dpn {} for vpn {}", vpnPortipToPort.getPortName(), ip, dpnId, vpnName);
                }
            }
        } else {
