...
public class ExtraRoutePortBindingService implements IExtraRoutePortBindingService {
    ...
    @Override
    public void unbindIfPresent(final String vpnName, final String interfaceName, final String nextHop) {
    ...
    private void updateExtraRouteAdjacency(final String vpnName, final String interfaceName, final String nextHop,
                                           final Action action) {
                                            ...
                                            case REMOVE: {
                                                if (existingNextHop.getInterfaceName() != null) {
                                                    ...
                                                    LOG.warn("updateExtraRouteAdjacency: Nexthop {} already unbound"
                                                            + " on vpn {} Ignoring unbind action", nextHop, vpnName);
                                                }
                                            }
                                            break;
                                            default: {
