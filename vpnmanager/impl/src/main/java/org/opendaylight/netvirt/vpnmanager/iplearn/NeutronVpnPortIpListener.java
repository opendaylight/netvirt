...
@Singleton
public class NeutronVpnPortIpListener extends AbstractAsyncDataTreeChangeListener<VpnPortipToPort> {
    ...
    public NeutronVpnPortIpListener(final DataBroker dataBroker, AlivenessMonitorService alivenessManager,
        ...
        super(dataBroker, LogicalDatastoreType.CONFIGURATION, InstanceIdentifier
                        .create(NeutronVpnPortipPortData.class).child(VpnPortipToPort.class),
                Executors.newListeningSingleThreadExecutor("NeutronVpnPortIpListener", LOG));
    ...
    @Override
    public void update(InstanceIdentifier<VpnPortipToPort> id, VpnPortipToPort value,
                          VpnPortipToPort dataObjectModificationAfter) {
    }

    @Override
    public void add(InstanceIdentifier<VpnPortipToPort> identifier, VpnPortipToPort value) {
    ...
    @Override
    public void remove(InstanceIdentifier<VpnPortipToPort> key, VpnPortipToPort value) {
    ...
    public java.util.Optional<Uint32> getMonitorProfileId(String ipAddress) {
