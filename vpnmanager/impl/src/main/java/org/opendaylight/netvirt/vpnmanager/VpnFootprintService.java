...
public class VpnFootprintService implements IVpnFootprintService {
    ...
    private void cleanUpDpnForVpn(long vpnId, String rd, BigInteger dpnId, String vpnName) {
        ...
        //   SubnetRoute, BroadCast,...). These flow entries are created for internal VPN when at least one VPN
        //   interfaces exists on the VPN and should be removed when the last VPN interface are removed.
        ...
        //   associated with the VPN. The cleanup DPN for external subnet VPN should be done when the external
        //   subnet is deleted.
        // - When deleting last VPN interface on internal subnet, cleanup DPN for subnet should be done before
        //   removing the VpnToDpnList.
