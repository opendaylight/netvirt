                ...
                ListenableFuture<Void> future = txRunner.callWithNewReadWriteTransactionAndSubmit(tx -> {
                    ...
                    if (vpnInterfaces.remove(currVpnInterface)) {
                        if (vpnInterfaces.isEmpty()) {
                            ...
                            DpnsBuilder dpnsBuilder = new DpnsBuilder(dpnOpElements.get());
                            dpnsBuilder.setVpnInterfaces(null);
            ...
            ListenableFuture<Void> future = txRunner.callWithNewReadWriteTransactionAndSubmit(tx -> {
                ...
                if (ipAddresses.remove(currIpAddress)) {
                    if (ipAddresses.isEmpty()) {
                        ...
                        DpnsBuilder dpnsBuilder = new DpnsBuilder(dpnOpElements).setIpAddresses(null);
