...
public abstract class L3vpnPopulator implements VpnPopulator {
                    ...
                    InstanceIdentifier<VrfTables> importingVrfTableId =
                            InstanceIdentifier.builder(FibEntries.class)
                                    .child(VpnInstanceNames.class,
                                            new VpnInstanceNamesKey(vpnInstance.getVpnInstanceName()))
    ...
    public void addToLabelMapper(Long label, BigInteger dpnId, String prefix, List<String> nextHopIpList, Long vpnId,
            String vpnInterfaceName, Long elanTag, boolean isSubnetRoute, String vpnName, String rd) {
        ...
        Preconditions.checkNotNull(vpnName, "addToLabelMapper: vpnInstanceName cannot be null or empty!");
        ...
        synchronized (label.toString().intern()) {
            addErrorLogging(txRunner.callWithNewWriteOnlyTransactionAndSubmit(tx -> {
                ...
                if (dpnId != null) {
                    ...
                    VpnInstanceOpDataEntry vpnInstanceOpDataEntry = VpnUtil.getVpnInstanceOpData(broker, vpnName);
    ...
    protected void addPrefixToBGP(String vpnName, String rd, String primaryRd, String macAddress,
                                  String prefix, String nextHopIp, VrfEntry.EncapType encapType,
                                  long label, long l3vni, String gatewayMac,
