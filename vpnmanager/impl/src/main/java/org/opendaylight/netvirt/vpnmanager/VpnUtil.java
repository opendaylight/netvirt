...
public final class VpnUtil {
    ...
    Set<org.opendaylight.yang.gen.v1.urn.huawei.params.xml.ns.yang.l3vpn.rev140815.vpn
            .instances.vpn.instance.vpntargets.VpnTarget> getRtListForVpn(String vpnName) {
        Set<org.opendaylight.yang.gen.v1.urn.huawei.params.xml.ns.yang.l3vpn.rev140815.vpn
                .instances.vpn.instance.vpntargets.VpnTarget> rtList = new HashSet<>();
        ...
        if (vpnInstanceOptional.isPresent()) {
            org.opendaylight.yang.gen.v1.urn.huawei.params.xml.ns.yang.l3vpn.rev140815.vpn.instances
