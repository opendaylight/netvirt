...
public final class VpnUtil {
    ...
    public static void removePrefixToInterfaceForVpnId(long vpnId,
    ...
    public static void removeVpnExtraRouteForVpn(String vpnName,
                                                    @Nonnull TypedWriteTransaction<Datastore.Operational> operTx) {
    ...
    // TODO Clean up the exception handling
    @SuppressWarnings("checkstyle:IllegalCatch")
    public static void removeVpnOpInstance(String vpnName,
                                                    @Nonnull TypedWriteTransaction<Datastore.Operational> operTx) {
        // Clean up VPNInstanceOpDataEntry
        operTx.delete(getVpnInstanceOpDataIdentifier(vpnName));
    }

    public static void removeVpnInstanceToVpnId(String vpnName,
    ...
    public static void removeVpnIdToVpnInstance(long vpnId,
                                                @Nonnull TypedWriteTransaction<Datastore.Configuration> confTx) {
        confTx.delete(getVpnIdToVpnInstanceIdentifier(vpnId));
    }

    public static void removeL3nexthopForVpnId(long vpnId,
                                               @Nonnull TypedWriteTransaction<Datastore.Operational> operTx) {
