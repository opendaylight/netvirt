...
public final class VpnUtil {
    ...
    public static FlowEntity buildL3vpnGatewayFlow(DataBroker broker, BigInteger dpId, String gwMacAddress, long vpnId,
        ...
        Subnetmap sn = getSubnetmapFromItsUuid(broker, Uuid.getDefaultInstance(getVpnName(broker, subnetVpnId)));
        if (sn != null && sn.getSubnetIp() != null) {
            IpVersionChoice ipVersionChoice = getIpVersionFromString(sn.getSubnetIp());
