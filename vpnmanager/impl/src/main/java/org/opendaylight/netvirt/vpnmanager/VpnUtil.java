...
public final class VpnUtil {
    ...
    protected static void createLearntVpnVipToPortEvent(DataBroker broker, String vpnName, String fixedIp, String
            portName, String macAddress, LearntVpnVipToPortEventAction action, WriteTransaction writeOperTxn) {
        ...
        LearntVpnVipToPortEventBuilder builder = new LearntVpnVipToPortEventBuilder().setKey(
                new LearntVpnVipToPortEventKey(eventId)).setVpnName(vpnName).setPortFixedip(fixedIp).setPortName
                (portName).setMacAddress(macAddress.toLowerCase()).setEventAction(action);
        if (writeOperTxn != null) {
            writeOperTxn.delete(LogicalDatastoreType.OPERATIONAL, id);
        } else {
            MDSALUtil.syncWrite(broker, LogicalDatastoreType.OPERATIONAL, id, builder.build());
        }
        LOG.info("createLearntVpnVipToPortEvent: ARP learned for fixedIp: {}, vpn {}, interface {}, mac {}, isSubnetIp {} added to " +
    ...
    private static InstanceIdentifier<LearntVpnVipToPortEvent> buildLearntVpnVipToPortEventIdentifier(String eventId) {
        InstanceIdentifier<LearntVpnVipToPortEvent> id = InstanceIdentifier.builder(LearntVpnVipToPortEventData.class).child
                (LearntVpnVipToPortEvent.class, new LearntVpnVipToPortEventKey(eventId)).build();
        return id;
    }
    ...
    public static void removeMipAdjAndLearntIp(DataBroker dataBroker, String vpnName, String vpnInterface, String prefix) {
