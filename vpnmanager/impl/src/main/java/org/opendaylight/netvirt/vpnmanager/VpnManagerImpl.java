...
public class VpnManagerImpl implements IVpnManager {
    ...
    public boolean removeOrUpdateDSForExtraRoute(String vpnName, String primaryRd, String extraRouteRd,
        ...
        boolean areNextHopsClearedForRd = true;
        Optional<Routes> optVpnExtraRoutes = VpnExtraRouteHelper
    ...
    public void removePrefixFromBGP(String vpnName, String primaryRd, String extraRouteRd, String vpnInterfaceName,
        ...
        try {
            ...
            synchronized (vpnNamePrefixKey.intern()) {
                if (removeOrUpdateDSForExtraRoute(vpnName, primaryRd, extraRouteRd, vpnInterfaceName, prefix, nextHop,
                        nextHopTunnelIp, writeConfigTxn)) {
                    return;
                }
    ...
    private void doAddArpResponderFlowsToExternalNetworkIps(String id, Collection<String> fixedIps, String macAddress,
            BigInteger dpnId, String extInterfaceName) {
