...
public class SubnetmapChangeListener extends AsyncDataTreeChangeListenerBase<Subnetmap, SubnetmapChangeListener> {
    ...
    protected void add(InstanceIdentifier<Subnetmap> identifier, Subnetmap subnetmap) {
        LOG.trace("SubnetmapChangeListener add subnetmap method - key: {}, value: {}", identifier,
                  subnetmap.toString());
        ...
        if (subnetmap.getVpnId() != null) {
            ...
            LOG.info("SubnetMapChangeListener:add: onSubnetAddedToVpn: subnetmap {}, isBgpVpn {}, elanTag {}",
                     subnetmap.toString(), isBgpVpn , elanTag.toString());
        ...
        if (subnetmap.getInternetVpnId() != null) {
            ...
            LOG.info("SubnetMapChangeListener:add: getInternetVpnId");
            // subnet added to VPN case upon config DS replay after reboot
            // ports added to subnet upon config DS replay after reboot are handled implicitly by subnetAddedToVpn
            // in SubnetRouteHandler
    ...
    protected void update(InstanceIdentifier<Subnetmap> identifier, Subnetmap subnetmapOriginal, Subnetmap
            subnetmapUpdate) {
        LOG.debug("SubnetmapListener update method - key {}, original {}, update {}", identifier,
        ...
        if (subnetmapUpdate.getNetworkId() == null
            ...
            LOG.info("SubnetmapListener:update: network was not found for subnetId: {}", subnetId);
            return;
        }
        if (VpnUtil.getIsExternal(network)) {
        ...
        // check that original and updated VpnInstances are BGP VPNs
        if (Objects.equals(subnetmapOriginal.getVpnId(), subnetmapOriginal.getRouterId())) {
            return;
        } else if (Objects.equals(subnetmapUpdate.getVpnId(), subnetmapUpdate.getRouterId())) {
            return;
        }
