...
A single L3 BGPVPN would be associated to both routers. As consequence, IPv4 and
IPv6 FIB entries would be gathered in the same L3 BGPVPN. Separation of IPv4 and
IPv6 neutron router configurations in this case permits to have an external
network access.
