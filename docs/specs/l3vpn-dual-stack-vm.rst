...
BgpConfigurationManager class uses addVrf() and delVrf() methods should also be
changed in appropriate way, because they call addVrf() and deleteVrf() from
BgpManager instance.
...
events is processed in VpnInstanceListener class. VpnInstanceListener class
