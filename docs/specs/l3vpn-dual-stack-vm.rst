...
The following combinations are not taken into account:

- associate VPN to two IPv4 routers, or dual stack router with IPv4 router, or associating

- associate VPN to dual stack router with IPv4 router ( or IPv6 router)
