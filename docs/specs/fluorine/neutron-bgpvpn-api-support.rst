...
The steps for this use-case (single HOT template)
template 1 - Create a VPN1 with RD1
             Create Network1, Create IPv4 Subnet11, Create IPv6 Subnet12
             Create Network2, Create IPv4 Subnet21, Create IPv6 Subnet22,
             Boot VMs on the Network1
             Boot VMs on the Network2
             Create Router1, 
             Add Subnet11 to Router1,
             Add Subnet12 to Router1,
             Add Subnet21 to Router1
             Add Subnet22 to Router1 and Associate Router1 into VPN1
