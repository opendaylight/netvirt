...
#. Verify the L3 Data Traffic with Router.
#. Verify the L3 Data Traffic(L3VPN) with Router Associated with BGP-VPN.
#. Verify the L3 Data Traffic with IPv6 Subnet Associated with Router.
#. Verify the L3 Data Traffic with IPv6 Subnet Dissociated with Router.
...
CSIT
----
New CSIT test cases will be added for this feature.
