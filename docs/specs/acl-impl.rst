...
* One negative test, checking ICMP connectivity between two VMs, using the SG
configured with the ICMP and TCP rules, and delete the TCP rule. This should not affect the ICMP
communication.
