...
VLAN_INTERFACE_INGRESS_TABLE => L3VNI_EXTERNAL_TUNNEL_DEMUX_TABLE =>
...
PSNAT_TABLE => OUTBOUND_NAPT_TABLE => NAPT_PFIB_TABLE  => L3_FIB_TABLE =>
(set the DST MAC Address, SET TUNNEL ID as L3VNI, Output to EXTERNAL VXLAN Tunnel Port)
