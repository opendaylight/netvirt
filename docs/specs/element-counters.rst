...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  | Egress counters table (260): ``match: lport-tag=vmB-interface, dst-ip=vmB-ip, actions: go to table 220`` =>
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  | Egress dispatcher table (220): ``match: lport-tag=vmB-interface, actions: go to table 260`` =>
  | Egress counters table (260): ``match: lport-tag=vmB-interface, tcp, actions: go to table 220`` =>
