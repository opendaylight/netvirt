...
NexthopManager - sleep introduced to sync groups before flows for setting up Load balancing group (createLoadBalancingNextHop)
...
Area 2:
+++++++
This area realization needs pipeline changes.
