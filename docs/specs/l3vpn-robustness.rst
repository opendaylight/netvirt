...
After these steps, all of the VM IPs (and their secondaries) must be hanging around in the new VPN2.
None of the VM IPs (and their secondaries) must be hanging around in old VPN1.
...
After these steps, none of the VM IPs (and their secondaries) must be hanging around in both VPN1 and VPN2.
...
After these steps, none of the VM IPs (and their secondaries) must be hanging around in VPN at all.
...
After these steps, none of the VM IPs (and their secondaries) must be hanging around in both the VPNs at all.
