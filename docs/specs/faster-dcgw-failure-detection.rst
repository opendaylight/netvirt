...
In summary : For a CSC (Cloud SDN Controller) to recover from a node reboot takes ~24 seconds.
...
Proposal
--------
Enable Control Path monitoring using BFD (between CSC and DC-Gwy).
