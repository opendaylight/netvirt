...
- table 11: TransportIngress table.
...
- table 251: Egress Classifier TransportIngress table.
...
.. code-block:: none
  ...
  cookie=0x14 table=250, n_packets=0, n_bytes=0,
    ...
    // Pkt has NSH, if NSH C1/C2 = 0, Set C1/C2, Egress pkt
  cookie=0x14 table=251, n_packets=11, n_bytes=918,
      priority=260,nshc1=0,nshc2=0
      actions=load:0x0->NXM_NX_NSH_C1[],
          load:0x0->NXM_NX_NSH_C2[],
          outport:6

    // Pkt has NSH, but NSH C1/C2 aleady set, Egress pkt
  cookie=0x14 table=251, n_packets=11, n_bytes=918,
      priority=250
      actions=outport:6
