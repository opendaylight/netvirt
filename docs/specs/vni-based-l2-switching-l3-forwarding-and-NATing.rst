...
network and L3 forwarding across VxLAN-type networks using routers and l3bgpvpns will use tenant
...
* Complete removal of use of ``MPLS labels`` everywhere in ODL: Use of ``MPLS labels`` for
  realizing an inter-dc communication over L3 BGPVPN will be retained.
...
#. Traffic between Trunk port and Subport over a BGPVPN will carry VNI enforced
   ...
   network-associated and/or router-associated.
