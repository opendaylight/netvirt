...
* Communication between a VM and a PNF in two different networks.
  The VM is located in a tenant network, the PNF is located in a provider network (external network).
...
* East/West communication between VMs and PNFs in a two diffrent tenant networks,
