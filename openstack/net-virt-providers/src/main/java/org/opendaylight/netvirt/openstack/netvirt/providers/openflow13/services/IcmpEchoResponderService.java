...
public class IcmpEchoResponderService extends AbstractServiceInstance implements IcmpEchoProvider {
    ...
    public IcmpEchoResponderService(final BundleContext bundleContext,
        ...
        orchestrator.registerService(bundleContext.getServiceReference(IcmpEchoProvider.class.getName()), this);
    }
