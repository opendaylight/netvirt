...
import org.opendaylight.netvirt.openstack.netvirt.providers.openflow13.services.NwConstants.LearnFlowModsType;
...
public class L2ForwardingLearnService  extends AbstractServiceInstance implements ConfigInterface, L2ForwardingLearnProvider {
    ...
    public void programL2ForwardingLearnRule(Long dpidLong) {
        ...
        // NXM_NX_TUN_ID[]
        flowMod[0] = new String[] { NwConstants.LearnFlowModsType.MATCH_FROM_FIELD.name(),
                NwConstants.NxmOfFieldType.NXM_NX_TUN_ID.getHexType(),
                NwConstants.NxmOfFieldType.NXM_NX_TUN_ID.getHexType(),
                NwConstants.NxmOfFieldType.NXM_NX_TUN_ID.getFlowModHeaderLen() };
        ...
        flowMod[1] = new String[] { NwConstants.LearnFlowModsType.MATCH_FROM_FIELD.name(),
                ...
                NwConstants.NxmOfFieldType.NXM_OF_ETH_DST.getFlowModHeaderLen()};
        // output:NXM_OF_IN_PORT[]
        flowMod[2] = new String[] { NwConstants.LearnFlowModsType.OUTPUT_TO_PORT.name(),
                NwConstants.NxmOfFieldType.NXM_OF_IN_PORT.getHexType(),
                NwConstants.NxmOfFieldType.NXM_OF_IN_PORT.getFlowModHeaderLen() };
