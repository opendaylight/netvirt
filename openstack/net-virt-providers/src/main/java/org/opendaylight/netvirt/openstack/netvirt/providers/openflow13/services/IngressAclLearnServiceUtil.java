...
public class IngressAclLearnServiceUtil {
     ...
     * "table=90,dl_src=fa:16:3e:d3:bb:8a,tcp,priority=61002,tcp_dst=22,
     *     actions=learn(table=39,idle_timeout=300,fin_idle_timeout=0,
     *     fin_hard_timeout=60,priority=61010, cookie=0x6900000,eth_type=0x800,nw_proto=6,
     *     NXM_OF_IP_SRC[]=NXM_OF_IP_DST[],NXM_OF_IP_DST[]=NXM_OF_IP_SRC[],
     *     NXM_OF_TCP_SRC[]=NXM_OF_TCP_DST[],NXM_OF_TCP_DST[]=NXM_OF_TCP_SRC[],
     *     load:0x1->NXM_NX_REG6[0..7]),resubmit(,100)"
     */
    public static FlowBuilder programIngressAclLearnRuleForTcp(FlowBuilder flowBuilder,
        ...
        return buildLearnFlow(flowBuilder, instructionBuilder, header, flowMod);
    }

    public static FlowBuilder programIngressAclLearnRuleForIpv6Tcp(FlowBuilder flowBuilder,
                                                                   InstructionBuilder instructionBuilder) {
        String[] header = new String[] {
                String.valueOf(NetvirtProvidersProvider.getSecurityGroupTcpIdleTimeout()),
                String.valueOf(NetvirtProvidersProvider.getSecurityGroupTcpHardTimeout()),
        ...
        flowMod[1] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_VALUE.name(),
                ...
                LearnConstants.NxmOfFieldType.NXM_OF_IP_PROTO.getHexType(),
                LearnConstants.NxmOfFieldType.NXM_OF_IP_PROTO.getFlowModHeaderLen() };
        // NXM_NX_IPV6_SRC[]=NXM_NX_IPV6_DST[]
        flowMod[2] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_FIELD.name(),
                LearnConstants.NxmOfFieldType.NXM_NX_IPV6_DST.getHexType(),
                LearnConstants.NxmOfFieldType.NXM_NX_IPV6_SRC.getHexType(),
                LearnConstants.NxmOfFieldType.NXM_NX_IPV6_DST.getFlowModHeaderLen()};
        // NXM_NX_IPV6_DST[]=NXM_NX_IPV6_SRC[]
        flowMod[3] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_FIELD.name(),
                LearnConstants.NxmOfFieldType.NXM_NX_IPV6_SRC.getHexType(),
                LearnConstants.NxmOfFieldType.NXM_NX_IPV6_DST.getHexType(),
                LearnConstants.NxmOfFieldType.NXM_NX_IPV6_SRC.getFlowModHeaderLen()};
        // NXM_OF_TCP_SRC[]=NXM_OF_TCP_DST[]
        flowMod[4] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_FIELD.name(),
                LearnConstants.NxmOfFieldType.NXM_OF_TCP_DST.getHexType(),
                LearnConstants.NxmOfFieldType.NXM_OF_TCP_SRC.getHexType(),
     ...
     * Match: reg6 = LearnConstants.NxmOfFieldType.NXM_NX_REG6
     * Action: learn and resubmit to next table
     * "table=90,dl_src=fa:16:3e:d3:bb:8a,udp,priority=61002,udp_dst=22,
     *     actions=learn(table=39,idle_timeout=300,fin_idle_timeout=0,
     *     fin_hard_timeout=0,priority=61010, cookie=0x6900000,eth_type=0x800,nw_proto=6,
     *     NXM_OF_IP_SRC[]=NXM_OF_IP_DST[],NXM_OF_IP_DST[]=NXM_OF_IP_SRC[],
     *     NXM_OF_UDP_SRC[]=NXM_OF_UDP_DST[],NXM_OF_UDP_DST[]=NXM_OF_UDP_SRC[],
     *     load:0x1->NXM_NX_REG6[0..7]),resubmit(,100)"
     */
     ...
     * Match: reg6 = LearnConstants.NxmOfFieldType.NXM_NX_REG6
     * Action: learn and resubmit to next table
     * "table=90,dl_src=fa:16:3e:d3:bb:8a,udp6,priority=61002,udp_dst=22,
     *     actions=learn(table=39,idle_timeout=300,fin_idle_timeout=0,
     *     fin_hard_timeout=0,priority=61010, cookie=0x6900000,eth_type=0x86dd,nw_proto=6,
     *     NXM_OF_IPV6_SRC[]=NXM_NX_IPV6_DST[],NXM_NX_IPV6_DST[]=NXM_OF_IPV6_SRC[],
     *     NXM_OF_UDP_SRC[]=NXM_OF_UDP_DST[],NXM_OF_UDP_DST[]=NXM_OF_UDP_SRC[],
     *     load:0x1->NXM_NX_REG6[0..7]),resubmit(,100)"
     */
    public static FlowBuilder programIngressAclLearnRuleForIpv6Udp(FlowBuilder flowBuilder,
                                                                   InstructionBuilder instructionBuilder) {
        String[] header = new String[] {
                String.valueOf(NetvirtProvidersProvider.getSecurityGroupUdpIdleTimeout()),
                String.valueOf(NetvirtProvidersProvider.getSecurityGroupUdpHardTimeout()),
     ...
     * Match: reg6 = LearnConstants.NxmOfFieldType.NXM_NX_REG6
     * Action: learn and resubmit to next table
     * "table=90,dl_src=fa:16:3e:d3:bb:8a,icmp,priority=61002,icmp_type=8,icmp_code=0,
     *     actions=learn(table=39,idle_timeout=300,fin_idle_timeout=0,
     *     fin_hard_timeout=0,priority=61010, cookie=0x6900000,eth_type=0x800,nw_proto=1,
     *     NXM_OF_IP_SRC[]=NXM_OF_IP_DST[],NXM_OF_IP_DST[]=NXM_OF_IP_SRC[],
     *     icmp_code=<reversed_icmp_code>,icmp_type=<reversed_icmp_type>
     *     load:0x1->NXM_NX_REG6[0..7]),resubmit(,100)"
     */
    public static FlowBuilder programIngressAclLearnRuleForIcmp(FlowBuilder flowBuilder,
                                                                InstructionBuilder instructionBuilder,
     ...
     * Match: reg6 = LearnConstants.NxmOfFieldType.NXM_NX_REG6
     * Action: learn and resubmit to next table
     * "table=90,icmp6,dl_dst=<dest-mac>,icmp_type=<icmpv6_type>,icmp_code=<icmpv6_code>
     *     actions=learn(table=39,idle_timeout=300,hard_timeout=0,priority=61010,
     *     eth_type=0x86dd,nw_proto=58,NXM_NX_IPV6_SRC[]=NXM_NX_IPV6_DST[],NXM_NX_IPV6_DST[]=NXM_NX_IPV6_SRC[],
     *     icmpv6_code=<reversed_icmpv6_code>,icmpv6_type=<reversed_icmpv6_type>,load:0x1->NXM_NX_REG6[0..7]),
     *     resubmit(,100)"
     */
    public static FlowBuilder programIngressAclLearnRuleForIpv6Icmp(FlowBuilder flowBuilder,
                                                                    InstructionBuilder instructionBuilder,
                                                                    String icmpType, String icmpCode) {
        String[] header = new String[]{
                String.valueOf(NetvirtProvidersProvider.getSecurityGroupDefaultIdleTimeout()),
        ...
        //nw_proto=58
        flowMod[1] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_VALUE.name(),
                Integer.toString(LearnConstants.IP_PROT_ICMPV6),
                LearnConstants.NxmOfFieldType.NXM_OF_IP_PROTO.getHexType(),
                LearnConstants.NxmOfFieldType.NXM_OF_IP_PROTO.getFlowModHeaderLen() };
        // NXM_NX_IPV6_SRC[]=NXM_NX_IPV6_DST[]
        flowMod[2] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_FIELD.name(),
        ...
        flowMod[4] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_VALUE.name(), icmpCode,
                LearnConstants.NxmOfFieldType.NXM_NX_ICMPV6_CODE.getHexType(),
                LearnConstants.NxmOfFieldType.NXM_NX_ICMPV6_CODE.getFlowModHeaderLen()};
        // icmpv6_type=icmpv6_type>
        flowMod[5] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_VALUE.name(), icmpType,
                LearnConstants.NxmOfFieldType.NXM_NX_ICMPV6_TYPE.getHexType(),
                LearnConstants.NxmOfFieldType.NXM_NX_ICMPV6_TYPE.getFlowModHeaderLen()};
        flowMod[6] = new String[] {
                LearnConstants.LearnFlowModsType.COPY_FROM_VALUE.name(), LearnConstants.LEARN_MATCH_REG_VALUE,
                LearnConstants.NxmOfFieldType.NXM_NX_REG6.getHexType(), "8" };
        return buildLearnFlow(flowBuilder, instructionBuilder, header, flowMod);
     ...
     * Match: reg6 = LearnConstants.NxmOfFieldType.NXM_NX_REG6
     * Action: learn and resubmit to next table
     * "table=90,dl_src=fa:16:3e:d3:bb:8a,priority=61002,icmp,dl_dst=fa:16:3e:bb:79:c1 ,
     *     actions=learn(table=39,idle_timeout=300,fin_idle_timeout=0,
     *     fin_hard_timeout=6,priority=61010, cookie=0x6900000,eth_type=0x800,nw_proto=6,
     *     NXM_OF_IP_SRC[]=NXM_OF_IP_DST[],NXM_OF_IP_DST[]=NXM_OF_IP_SRC[],
     *     NXM_OF_ICMP_TYPE[]=NXM_OF_ICMP_TYPE[],NXM_OF_ICMP_CODE[]=NXM_OF_ICMP_CODE[],
     *     load:0x1->NXM_NX_REG6[0..7]),resubmit(,100)"
     */
    public static FlowBuilder programIngressAclLearnRuleForIcmpAll(FlowBuilder flowBuilder,
                                                                   InstructionBuilder instructionBuilder) {
        String[] header = new String[]{
                String.valueOf(NetvirtProvidersProvider.getSecurityGroupDefaultIdleTimeout()),
                String.valueOf(NetvirtProvidersProvider.getSecurityGroupDefaultHardTimeout()),
     ...
     * Match: reg6 = LearnConstants.NxmOfFieldType.NXM_NX_REG6
     * Action: learn and resubmit to next table
     * "table=90,dl_src=fa:16:3e:d3:bb:8a,priority=61002,icmp6,
     *     actions=learn(table=39,idle_timeout=18000,fin_idle_timeout=60,
     *     fin_hard_timeout=60,priority=61010, cookie=0x6900000,eth_type=0x86dd,nw_proto=58,
     *     NXM_NX_IPV6_SRC[]=NXM_OF_IPV6_DST[],NXM_OF_IPV6_DST[]=NXM_NX_IPV6_SRC[],
     *     NXM_NX_ICMPV6_TYPE[]=NXM_NX_ICMPV6_TYPE[],NXM_NX_ICMPV6_TYPE[]=NXM_NX_ICMPV6_TYPE[],
     *     load:0x1->NXM_NX_REG6[0..7]),resubmit(,100)"
     */
    public static FlowBuilder programIngressAclLearnRuleForIcmpV6All(FlowBuilder flowBuilder,
                                                                     InstructionBuilder instructionBuilder) {
        String[] header = new String[] {
                String.valueOf(NetvirtProvidersProvider.getSecurityGroupDefaultIdleTimeout()),
                String.valueOf(NetvirtProvidersProvider.getSecurityGroupDefaultHardTimeout()),
    ...
    private static FlowBuilder buildLearnFlow(FlowBuilder flowBuilder,
                                              InstructionBuilder instructionBuilder,
                                              String[] header, String[][] flowMod) {
