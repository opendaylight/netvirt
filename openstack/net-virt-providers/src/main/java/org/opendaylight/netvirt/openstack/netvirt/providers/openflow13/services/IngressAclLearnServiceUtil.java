...
public class IngressAclLearnServiceUtil {
     ...
     */
    public static FlowBuilder programIngressAclLearnRuleForTcp(FlowBuilder flowBuilder, InstructionBuilder instructionBuilder, boolean isDrop) {
     ...
     */
    public static FlowBuilder programIngressAclLearnRuleForUdp(FlowBuilder flowBuilder, InstructionBuilder instructionBuilder, boolean isDrop) {
     ...
     * Match: reg0 = ClassifierService.REG_VALUE_FROM_REMOTE
     * Action: learn and goto next table
     *  cookie=0x0, duration=2424.188s, table=40, n_packets=1130, n_bytes=110740, priority=61002,icmp,dl_src=fa:16:3e:a0:dc:82,icmp_type=8,
     *  icmp_code=0 actions=learn(table=39,idle_timeout=18000,fin_idle_timeout=60,fin_hard_timeout=60,priority=61010,cookie=0x6900000,
     *  eth_type=0x800,nw_proto=1,NXM_OF_ETH_SRC[]=NXM_OF_ETH_DST[],NXM_OF_ETH_DST[]=NXM_OF_ETH_SRC[],icmp_code=0,icmp_type=0,
     *  load:0x1->NXM_NX_REG6[0..7]),resubmit(,50)
     */
    public static FlowBuilder programIngressAclLearnRuleForIcmp(FlowBuilder flowBuilder, InstructionBuilder instructionBuilder, boolean isDrop) {
        ...
        flowMod[2] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_FIELD.name(),
                ...
                LearnConstants.NxmOfFieldType.NXM_OF_ETH_SRC.getFlowModHeaderLen()};
     ...
     // NXM_NX_TUN_ID[]
      ...
      //icmp_code=0
        ...
        //icmp_type=0
        flowMod[6] = new String[] { LearnConstants.LearnFlowModsType.MATCH_FROM_VALUE.name(),
                Integer.toString((int) 0),
    ...
    private static org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action createResubmitActions() {
        ...
        gttb.setTable(Short.parseShort("100"));
