...
public class GatewayMacResolverService extends AbstractServiceInstance
    ...
    public GatewayMacResolverService(final NotificationProviderService notificationProviderService,
        ...
        orchestrator.registerService(Service.GATEWAY_RESOLVER, this);
    }
