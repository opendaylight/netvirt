...
public class IngressAclService extends AbstractServiceInstance implements IngressAclProvider {
    ...
    public IngressAclService(final BundleContext bundleContext,
        ...
        orchestrator.registerService(bundleContext.getServiceReference(IngressAclProvider.class.getName()), this);
    }
