...
public class L2ForwardingService extends AbstractServiceInstance implements ConfigInterface, L2ForwardingProvider {
    ...
    public void programLocalUcastOut(Long dpidLong, String segmentationId,
        ...
        System.arraycopy(portBytes, 0, cookieBytes, 0, portBytes.length);
        System.arraycopy(macBytes, 0, cookieBytes, portBytes.length, macBytes.length);
        flowBuilder.setCookie(new FlowCookie(new BigInteger(cookieBytes)));
