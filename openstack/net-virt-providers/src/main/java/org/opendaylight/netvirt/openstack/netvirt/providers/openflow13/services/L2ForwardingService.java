...
public class L2ForwardingService extends AbstractServiceInstance implements L2ForwardingProvider {
    ...
    public L2ForwardingService(final BundleContext bundleContext,
        ...
        orchestrator.registerService(bundleContext.getServiceReference(L2ForwardingProvider.class.getName()), this);
    }
