...
public class ArpResponderService extends AbstractServiceInstance implements ArpProvider {
    ...
    public ArpResponderService(final BundleContext bundleContext,
        ...
        orchestrator.registerService(bundleContext.getServiceReference(ArpProvider.class.getName()), this);
    }
