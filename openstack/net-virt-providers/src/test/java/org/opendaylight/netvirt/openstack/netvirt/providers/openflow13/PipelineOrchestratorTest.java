...
public class PipelineOrchestratorTest {
    ...
    public void testPipeline() {
        ...
        assertEquals(orchestrator.getNextServiceInPipeline(Service.INBOUND_NAT), Service.RESUBMIT_SERVICE);
        assertEquals(orchestrator.getNextServiceInPipeline(Service.RESUBMIT_SERVICE), Service.ACL_LEARN_SERVICE);
