...
public interface SecurityServicesManager {
     ...
     * @param dpIdNodeMap dpIdNodeMap
     * @param write whether to add/delete flow.
     */
    void syncSecurityRule(NeutronPort port, NeutronSecurityRule securityRule, Neutron_IPs vmIp, NodeId nodeId, Map<NodeId, Long> dpIdNodeMap, boolean write);
    /**
