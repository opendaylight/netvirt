...
public interface EgressAclProvider {
     ...
     * @param neutronSubnet in the neutron subnet
     */
    void programFixedSecurityGroup(Long dpid, String segmentationId,String attachedMac, String dhcpMacAddress, long localPort,
     ...
     */
    void removeFixedSecurityGroup(Long dpid, String segmentationId, String attachedMac, String dhcpMacAddress, long localPort,
                                  List<Neutron_IPs> srcAddressList, boolean write, NeutronSubnet neutronSubnet);
