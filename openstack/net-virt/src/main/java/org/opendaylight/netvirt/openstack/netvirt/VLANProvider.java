...
public class VLANProvider implements ConfigInterface {
    ...
    public void programProviderNetworkFlow(Node envNode, OvsdbTerminationPointAugmentation port, NeutronNetwork network,
        ...
        try {
            ...
            outboundNatProvider.programProviderNetworkOutput(dpIdInt, ofPort, patchIntPort, macAddress, write);
            outboundNatProvider.programProviderNetworkPopVlan(dpIdInt, network.getProviderSegmentationID(),
                   ofPort, patchIntPort, write);
            outboundNatProvider.programProviderNetworkPushVlan(dpIdExt, network.getProviderSegmentationID(),
                   patchExtPort, macAddress, write);
            outboundNatProvider.programProviderNetworkDrop(dpIdExt, patchExtPort, write);
        } catch(Exception e) {
