...
public class LearnConstants {
    ...
    public static final int IP_PROT_ICMPV6 = 58;
    ...
    public static final HashMap<Integer, String> ICMPV6_TYPE_MAP = new HashMap<Integer, String>();
    static
    {
        ICMPV6_TYPE_MAP.put(128, "129");
        ICMPV6_TYPE_MAP.put(139, "140");
    }
    ...
    public enum NxmOfFieldType {
        ...
        NXM_NX_ICMPV6_CODE(0x0001, 22, 1, 8),
