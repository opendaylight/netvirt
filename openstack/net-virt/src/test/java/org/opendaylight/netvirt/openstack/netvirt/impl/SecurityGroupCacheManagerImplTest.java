...
public class SecurityGroupCacheManagerImplTest {
    ...
    @Mock Map<NodeId, Long> dpIdNodeMap = new HashMap<NodeId, Long>();
    ...
    public void setUp() throws Exception {
        ...
        when(neutronL3Adapter.getPortDetailsByPortUUID(NEUTRON_PORT_ID_VM_1)).thenReturn(neutronPort_Vm1);
    }
    ...
    public void testPortAddedWithNoRemoteSGInCache() {
        ...
        verify(securityServicesManager, times(0)).syncSecurityRule(any(NeutronPort.class), any(NeutronSecurityRule.class), any(Neutron_IPs.class), any(NodeId.class), any(Map.class), anyBoolean());
    }
    ...
    public void testPortAddedWithSelfInCache() {
        ...
        securityServicesManager.syncSecurityRule(neutronPort_Vm1, neutronSecurityRule_1, neutron_ip_2, nodeId_1, dpIdNodeMap, true);
        verify(securityServicesManager, times(1)).syncSecurityRule(eq(neutronPort_Vm1), eq(neutronSecurityRule_1), eq(neutron_ip_2), eq(nodeId_1), eq(dpIdNodeMap), eq(true));
    }
    ...
    public void testPortRemovedWithSelfInCache() {
        ...
        securityServicesManager.syncSecurityRule(neutronPort_Vm1, neutronSecurityRule_1, neutron_ip_2, nodeId_1, dpIdNodeMap, false);
        verify(securityServicesManager, times(1)).syncSecurityRule(eq(neutronPort_Vm1), eq(neutronSecurityRule_1), eq(neutron_ip_2), eq(nodeId_1), eq(dpIdNodeMap), eq(false));
    }
    ...
    public void testPortAddedWithCidrInCache() {
        ...
        securityServicesManager.syncSecurityRule(neutronPort_Vm3, neutronSecurityRule_3, neutron_ip_2, nodeId_1, dpIdNodeMap, true);
       verify(securityServicesManager, times(1)).syncSecurityRule(eq(neutronPort_Vm3), eq(neutronSecurityRule_3), eq(neutron_ip_2), eq(nodeId_1), eq(dpIdNodeMap), eq(true));
    }
    ...
    public void testPortRemovedWithCidrInCache() {
        ...
        securityServicesManager.syncSecurityRule(neutronPort_Vm3, neutronSecurityRule_3, neutron_ip_2, nodeId_1, dpIdNodeMap, false);
        verify(securityServicesManager, times(1)).syncSecurityRule(eq(neutronPort_Vm3), eq(neutronSecurityRule_3), eq(neutron_ip_2), eq(nodeId_1), eq(dpIdNodeMap), eq(false));
    }
