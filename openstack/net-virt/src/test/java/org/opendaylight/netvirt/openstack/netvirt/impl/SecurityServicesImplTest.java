...
public class SecurityServicesImplTest {
    ...
    public void setUp(){
        ...
        when(neutronPort_Dhcp.getMacAddress()).thenReturn("dhcpPort-getMacAddress");
    }
    ...
    public void testSyncSecurityGroupAddition() {
        ...
        verify(ingressAclService, times(1)).programPortSecurityGroup(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityGroup_1), eq(NEUTRON_PORT_ID_VM_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(true));
        verify(egressAclService, times(1)).programPortSecurityGroup(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityGroup_1), eq(NEUTRON_PORT_ID_VM_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(true));
    }
    ...
    public void testSyncSecurityGroupDeletion() {
        ...
        verify(ingressAclService, times(1)).programPortSecurityGroup(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityGroup_1), eq(NEUTRON_PORT_ID_VM_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(false));
        verify(egressAclService, times(1)).programPortSecurityGroup(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityGroup_1), eq(NEUTRON_PORT_ID_VM_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(false));
    }
    ...
    public void testSyncSecurityGroupPortNull() {
        ...
        verify(ingressAclService, times(0)).programPortSecurityGroup(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityGroup_1), eq(NEUTRON_PORT_ID_VM_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(false));
        verify(egressAclService, times(0)).programPortSecurityGroup(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityGroup_1), eq(NEUTRON_PORT_ID_VM_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(false));
    }
    ...
    public void testSyncSecurityRuleAdditionEgress() {
        ...
        verify(egressAclService, times(1)).programPortSecurityRule(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityRule_1), eq(neutron_ip_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(true));
    }
    ...
    public void testSyncSecurityRuleAdditionIngress() {
        ...
        when(neutronSecurityRule_1.getSecurityRuleEthertype()).thenReturn(NeutronSecurityRule.ETHERTYPE_IPV4);
        securityServicesImpl.syncSecurityRule(neutronPort_Vm1, neutronSecurityRule_1, neutron_ip_1, true);
        verify(ingressAclService, times(1)).programPortSecurityRule(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityRule_1), eq(neutron_ip_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(true));
    }
    ...
    public void testSyncSecurityRuleDeletionEgress() {
        ...
        verify(egressAclService, times(1)).programPortSecurityRule(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityRule_1), eq(neutron_ip_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(false));
    }
    ...
    public void testSyncSecurityRuleDeletionIngress() {
        ...
        when(neutronSecurityRule_1.getSecurityRuleEthertype()).thenReturn(NeutronSecurityRule.ETHERTYPE_IPV4);
        securityServicesImpl.syncSecurityRule(neutronPort_Vm1, neutronSecurityRule_1, neutron_ip_1, false);
        verify(ingressAclService, times(1)).programPortSecurityRule(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityRule_1), eq(neutron_ip_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(false));
    }
    ...
    public void testSyncSecurityRuleDeletionIngressPortNull() {
        ...
        verify(ingressAclService, times(0)).programPortSecurityRule(eq(new Long(1)), eq("1000"), eq("attached-mac"), eq(2L), eq(neutronSecurityRule_1), eq(neutron_ip_1), eq("dhcpPort-getMacAddress"), eq(subnet), eq(false));
    }
