...
DSMAP = {
         ...
         'l3vpn':['l3vpn-config.log','config','l3vpn:vpn-interfaces','vpn-interfaces','vpn-interface'],
         ...
         'elaninterface':['elan-interfaces.log','config','elan:elan-interfaces','elan-interfaces','elan-interface'],
