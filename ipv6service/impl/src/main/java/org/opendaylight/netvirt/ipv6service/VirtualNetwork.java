...
public class VirtualNetwork implements IVirtualNetwork {
    ...
    public static class DpnInterfaceInfo {
        ...
        ConcurrentMap<Ipv6Prefix, Integer> subnetCidrPuntFlowConfiguredMap;
        ...
        DpnInterfaceInfo(BigInteger dpnId) {
            ...
            subnetCidrPuntFlowConfiguredMap = new ConcurrentHashMap<>();
        }
        ...
        public int getSubnetCidrFlowConfiguredStatus(Ipv6Prefix subnetPrefix) {
            if (!subnetCidrPuntFlowConfiguredMap.isEmpty()
                    && subnetCidrPuntFlowConfiguredMap.containsKey(subnetPrefix)) {
                return subnetCidrPuntFlowConfiguredMap.get(subnetPrefix);
            }
            return Ipv6Constants.FLOWS_NOT_CONFIGURED;
        }
