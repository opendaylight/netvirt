...
public class Ipv6ServiceUtils {
    ...
    public ActionInfo getLearnActionForNsDrop(int hardTimeout) {
        ...
        List<ActionLearn.FlowMod> flowMods = Arrays.asList(
                ...
                new ActionLearn.MatchFromValue(58, NwConstants.NxmOfFieldType.NXM_OF_IP_PROTO.getType(),
                ...
                new ActionLearn.MatchFromValue(135, NwConstants.NxmOfFieldType.OXM_OF_ICMPV6_TYPE.getType(),
    ...
    public void instIcmpv6NsMatchFlow(short tableId, BigInteger dpId, Long elanTag, int lportTag, String vmMacAddress,
        ...
        List<InstructionInfo> instructions = new ArrayList<>();
        List<ActionInfo> actionsInfos = new ArrayList<>();
        actionsInfos.add(getLearnActionForNsDrop(30));
    ...
    public void installIcmpv6NaResponderFlow(short tableId, BigInteger dpId,
    ...
    public void installIcmpv6NsDefaultPuntFlow(short tableId, BigInteger dpId,  Long elanTag, String ipv6Address,
        ...
        instructions.add(new InstructionApplyActions(actionsInfos));
        FlowEntity rsFlowEntity = MDSALUtil.buildFlowEntity(dpId, tableId,
                getIPv6FlowRef(dpId, elanTag, ipv6Address),Ipv6ServiceConstants.DEFAULT_OVS_FLOW_PRIORITY, "IPv6NS",
