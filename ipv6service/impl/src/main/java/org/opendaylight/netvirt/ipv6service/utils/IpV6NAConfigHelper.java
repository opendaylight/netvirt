...
public class IpV6NAConfigHelper {
    ...
    public IpV6NAConfigHelper(Ipv6serviceConfig ipv6serviceConfig) {
        ...
        this.ipv6RouterReachableTimeinMS = ipv6serviceConfig.getIpv6RouterReachableTime();
        this.nsSlowProtectionTimeOutinMs = ipv6serviceConfig.getNsSlowPathProtectionTimeout();
    }
