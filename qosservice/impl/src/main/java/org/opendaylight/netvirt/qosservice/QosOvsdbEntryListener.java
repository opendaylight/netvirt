...
public class QosOvsdbEntryListener extends
        AsyncClusteredDataTreeChangeListenerBase<QosEntries, QosOvsdbEntryListener> {
    ...
    public QosOvsdbEntryListener(final DataBroker dataBroker,
        ...
        super(QosEntries.class, QosOvsdbEntryListener.class);
    ...
    @Override
    protected InstanceIdentifier<QosEntries> getWildCardPath() {
    ...
    @Override
    protected void remove(InstanceIdentifier<QosEntries> key, QosEntries dataObjectModification) {

    }

    @Override
    protected void update(InstanceIdentifier<QosEntries> key,
                          QosEntries dataObjectModificationBefore, QosEntries dataObjectModificationAfter) {

    }

    @Override
    protected void add(InstanceIdentifier<QosEntries> identifier, QosEntries qosOvsdbEntry) {
    ...
    @Override
    protected QosOvsdbEntryListener getDataTreeChangeListener() {
        return QosOvsdbEntryListener.this;
    }
