...
@Command(scope = "qos", name = "show-config", description = "qos config display")
public class QosConfigCLI extends OsgiCommandSupport {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(QosConfigCLI.class);
