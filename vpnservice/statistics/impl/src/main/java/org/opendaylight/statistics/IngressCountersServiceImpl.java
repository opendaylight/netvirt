...
public class IngressCountersServiceImpl extends AbstractCountersService {
    ...
    public void installDefaultCounterRules(String interfaceId) {
        ...
        String defaultFlowName = CountersServiceUtils.DEFAULT_INGRESS_COUNTER_FLOW_PREFIX + dpn;
        ...
        syncFlow(dpn, NwConstants.INGRESS_COUNTERS_TABLE, defaultFlowName,
                CountersServiceUtils.COUNTER_TABLE_DEFAULT_FLOW_PRIORITY, CountersServiceUtils.COUNTER_FLOW_NAME, 0, 0,
                CountersServiceUtils.COOKIE_COUNTERS_BASE, defaultFlowMatches, instructions, FlowOperations.INSTALL);
    }

    @Override
    public void syncCounterFlows(ElementCountersRequest ecr, FlowOperations operation) {
        ...
        syncFlow(dpn, NwConstants.INGRESS_COUNTERS_TABLE, flowName,
    ...
    private String createFlowName(ElementCountersRequest ecr, int lportTag, BigInteger dpn) {
        return "Ingress_Counters" + dpn + "_" + lportTag + "_" + ecr.toString();
    }
