...
//                    southbound.getTerminationPointOfBridge(nodeInfo.bridgeNode, VpnserviceITConstants.PORT_NAME);
//            Assert.assertNotNull("Did not find " + VpnserviceITConstants.PORT_NAME, ovsdbTerminationPointAugmentation);
