...
public class WildCardListener implements AutoCloseable, ClusteredDataTreeChangeListener<DataObject> {
    ...
    ListenerRegistration<LdhDataTreeChangeListenerBase> registration;
        ...
        for (DataTreeModification<DataObject> change : changes) {
            ...
            switch (mod.getModificationType()) {
                ...
                case DELETE:
                    ...
                    wildCardOnDataTreeChangeCallbackHandling(key, waitingForDeleteIids, waitingDeleteListeners, "DELETE");
                    break;
            }
        }
    }
    ...
    private void wildCardListenerDecrUnregister(List<DependencyData> dataModifiedDependentIid,
        ...
        if ((dataModifiedDependentIid != null) && (listener!=null)) {
            ...
            listener.expiredEventDecrementUnregisterListerHandling(dataModifiedDependentIid, listener.clazz.getSimpleName());
        }
    }
}
