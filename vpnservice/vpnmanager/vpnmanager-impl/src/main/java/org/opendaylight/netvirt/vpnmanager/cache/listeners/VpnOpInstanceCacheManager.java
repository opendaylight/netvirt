...
public class VpnOpInstanceCacheManager
    ...
    private static final Logger logger = LoggerFactory.getLogger(VpnOpInstanceCacheManager.class);
    ...
    public VpnOpInstanceCacheManager(final DataBroker broker) {
        ...
        try {
            ...
            logger.error("VpnOpInstance CacheManager registration failed", e);
        }
    }
    ...
    public void close() {
        if (listenerRegistration != null) {
            try {
                ...
                logger.error("Error when cleaning up VpnOpInstance CacheManager.", e);
            }
            listenerRegistration = null;
        }
        logger.trace("VpnOpInstance CacheManager Closed");
    }
