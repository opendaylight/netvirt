        ...
        try {
            if (L2vlan.class.equals(intrf.getType())) {
                ...
                if (intrf.getOperStatus().equals(Interface.OperStatus.Up)) {
                    ...
                    if (subnetId == null) {
                        LOG.error("SubnetRouteInterfaceListener add: Port {} doesnt exist in configDS", intrf.getName());
                        return;
                    }
    ...
    protected void update(InstanceIdentifier<Interface> identifier,
        ...
        try {
            ...
            if (L2vlan.class.equals(update.getType())) {
                ...
                if (subnetId == null) {
                    LOG.error("SubnetRouteInterfaceListener update: Port {} doesnt exist in configDS", update.getName());
                    return;
                }
                DataStoreJobCoordinator dataStoreCoordinator = DataStoreJobCoordinator.getInstance();
                dataStoreCoordinator.enqueueJob("SUBNETROUTE-" + subnetId,
