...
public class VpnFootprintService implements IVpnFootprintService {
    ...
    public void updateVpnToDpnMapping(BigInteger dpId, String vpnName, String interfaceName, boolean add) {
        ...
        if (!dpId.equals(BigInteger.ZERO)) {
            if (add) {
                ...
                publishInterfaceAddedOnDpnNotification(interfaceName, dpId, vpnName);
            } else {
                removeOrUpdateVpnToDpnList(vpnId, dpId, interfaceName, vpnName);
                publishInterfaceRemovedOnDpnNotification(interfaceName, dpId, vpnName);
            }
        }
    }
    ...
    private void publishInterfaceAddedOnDpnNotification(String interfaceName, BigInteger dpnId, String vpnName) {
    ...
    private void publishInterfaceRemovedOnDpnNotification(String interfaceName, BigInteger dpnId, String vpnName) {
