...
public class VpnUtil {
    ...
    static Network getNeutronNetwork(DataBroker broker, Uuid networkId) {
        ...
        InstanceIdentifier<Network> inst = InstanceIdentifier.create(Neutron.class).child(org.opendaylight.yang.gen.v1.urn.opendaylight.neutron.networks.rev150712.networks.attributes.Networks.class)
