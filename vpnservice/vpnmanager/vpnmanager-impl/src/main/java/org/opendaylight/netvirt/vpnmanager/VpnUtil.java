...
public class VpnUtil {
    ...
    static Prefixes getPrefixToInterface(BigInteger dpId, String vpnInterfaceName, String ipPrefix, final String srcMac,
            final SourceMacFrom srcMacFrm) {
        return new PrefixesBuilder().setDpnId(dpId).setVpnInterfaceName(vpnInterfaceName).setIpAddress(ipPrefix)
                .setSourceMac(srcMac).setSourceMacFrom(srcMacFrm).build();
    }
    ...
    public static Prefixes resolveGwSourceMacForVpnInterface(final DataBroker dataBroker,
            final WriteTransaction writeOperTxn, final BigInteger dpnId, final String vpnName,
            final String interfaceName, final String prefix, final String gwIp) {
