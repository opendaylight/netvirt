...
public final class VpnUtil {
    ...
    static Optional<List<String>> getVpnAssociatedWithInterface(DataBroker broker, String interfaceName) {
        ...
        if (optConfiguredVpnInterface.isPresent()) {
            Optional<List<VpnInstanceNames>> optVpnInstanceList =
                 Optional.of(optConfiguredVpnInterface.get().getVpnInstanceNames());
    ...
    public static IpVersionChoice getVpnType(DataBroker dataBroker, String vpnName) {
        ...
        if (vpnInstanceOpDataEntry.isIpv6Configured()) {
            ipVersion.addVersion(IpVersionChoice.IPV6);
        }
        return ipVersion;
    }
