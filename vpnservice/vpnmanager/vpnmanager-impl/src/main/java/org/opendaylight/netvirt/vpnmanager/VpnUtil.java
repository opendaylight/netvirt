...
public final class VpnUtil {
    ...
    static InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.l3vpn.rev130911.dpn.to.vpn.list.dpn.list.VpnInstances> getDpnToVpnListVpnInstanceIdentifier(BigInteger dpnId, String vpnName) {
        return InstanceIdentifier.builder(DpnToVpnList.class)
                .child(DpnList.class, new DpnListKey(dpnId))
                .child(org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.l3vpn.rev130911.dpn.to.vpn.list.dpn.list.VpnInstances.class, new VpnInstancesKey(vpnName)).build();
    }

    static InstanceIdentifier<DpnList> getDpnToVpnListIdentifier(BigInteger dpnId) {
        return InstanceIdentifier.builder(DpnToVpnList.class)
    ...
    static VpnConstants.ITMTunnelLocType getTunnelType (StateTunnelList stateTunnelList) {
        VpnConstants.ITMTunnelLocType tunTypeVal;
        if (stateTunnelList.getDstInfo().getTepDeviceType() == TepTypeInternal.class) {
            ...
            tunTypeVal = VpnConstants.ITMTunnelLocType.Hwvtep;
        } else {
            tunTypeVal = VpnConstants.ITMTunnelLocType.Invalid;
        }
        return tunTypeVal;
    }

    static List<String> getDpnInterfaceList(OdlInterfaceRpcService intfRpcService, BigInteger dpnId) {
