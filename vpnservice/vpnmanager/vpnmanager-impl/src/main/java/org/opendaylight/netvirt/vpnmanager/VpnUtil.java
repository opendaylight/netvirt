...
public class VpnUtil {
    ...
    public static VpnInterfaceToGwSrcMacData resolveGwSourceMacForVpnInterface(final DataBroker dataBroker, final WriteTransaction writeOperTxn,
        ...
        final InstanceIdentifier<VpnInterfaceToGwSrcMacData> path = InstanceIdentifier.create(VpnInterfaceToGwSrcMac.class).child(VpnInterfaceToGwSrcMacData.class, new VpnInterfaceToGwSrcMacDataKey(interfaceName, vpnName));
        final VpnInterfaceToGwSrcMacData srcGwMac = new VpnInterfaceToGwSrcMacDataBuilder().setSrcMac(macaddress).setMacSource(gwSrcType).setVpnInterface(interfaceName).setVpnName(vpnName).setKey(new VpnInterfaceToGwSrcMacDataKey(interfaceName, vpnName)).build();
        if(writeOperTxn != null){
    ...
    public static java.util.Optional<VpnInterfaceToGwSrcMacData> getGwSrcMac(final DataBroker dataBroker, final String vpnName,
                                final String interfaceName){

        final InstanceIdentifier<VpnInterfaceToGwSrcMacData> identifier = InstanceIdentifier.create(VpnInterfaceToGwSrcMac.class).child(VpnInterfaceToGwSrcMacData.class, new VpnInterfaceToGwSrcMacDataKey(interfaceName, vpnName));
    ...
    @SuppressWarnings("deprecation")
    public static void releaseGwSourceMacForVpnInterface(final DataBroker dataBroker, final WriteTransaction writeOperTxn, final String vpnName, final String interfaceName){
