...
public class TunnelInterfaceStateListener extends AsyncDataTreeChangeListenerBase<StateTunnelList,
    ...
    private void handleTunnelEventForDPNVpn(StateTunnelList stateTunnelList,
                                            List<VpnInstances> vpnInstanceList,
        ...
        for (VpnInstanceNames vpnInstance : cfgVpnInterface.getVpnInstanceNames()) {
            ...
            if (opVpnInterface.isPresent()) {
                ...
                String prefix = null;
                VpnInstances vpnInst = vpnInstanceList.stream().filter(instances ->
                        instances.getVpnInstanceName().equals(vpnInterface.getVpnInstanceName())).findAny().orElse(null);
                ...
                if (vpnInst != null) {
                    ...
                    LOG.debug("handleTunnelEventForDPNVpn: VpnInterface {} VpnId {} vpnInstance {} doesnt have footprint on" +
                            " dpn {}", vpnInterface, vpnId, vpnInterface.getVpnInstanceName() , srcDpnId);
                }
            }
        }
    }
