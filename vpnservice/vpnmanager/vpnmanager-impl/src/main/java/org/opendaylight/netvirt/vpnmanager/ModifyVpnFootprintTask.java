...
import org.opendaylight.netvirt.vpnmanager.intervpnlink.DpnEnterExitVpnWorker;
...
public class ModifyVpnFootprintTask implements Callable<List<ListenableFuture<Void>>> {
     ...
     */
    public void waitTillPersisted_bak(long maxTimeWait) throws InterruptedException, ExecutionException, TimeoutException {
    ...
    public void waitTillPersisted(long maxTimeWait) throws InterruptedException, ExecutionException, TimeoutException {
        ...
        while (this.future == null && ( t1 - t0 ) < ( maxTimeWait * 1000000 )) {
            Thread.sleep(50);
            t1 = System.nanoTime();
        }
