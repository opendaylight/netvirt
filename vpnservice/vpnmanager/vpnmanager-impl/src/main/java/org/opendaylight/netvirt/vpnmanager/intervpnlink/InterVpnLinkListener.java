...
public class InterVpnLinkListener extends AsyncDataTreeChangeListenerBase<InterVpnLink, InterVpnLinkListener>
    ...
    protected void update(InstanceIdentifier<InterVpnLink> identifier, InterVpnLink original, InterVpnLink update) {
        ...
        dsJobCoordinator.enqueueJob("REMOVE.INTERVPNLINK." + identifier.firstKeyOf(InterVpnLink.class).getName(),
                new InterVpnLinkRemoverTask(dataBroker, identifier));
        dsJobCoordinator.enqueueJob("IVPNLINK.CLEANED.CHECKER" + original.getName(),
                new InterVpnLinkCleanedCheckerTask(dataBroker, original));
        dsJobCoordinator.enqueueJob("IVpnLink.creation." + update.getName(),
                new InterVpnLinkCreatorTask(dataBroker, update));
    }
