...
public class InterVpnLinkListener extends AbstractDataChangeListener<InterVpnLink> implements  AutoCloseable {
    ...
    protected void add(InstanceIdentifier<InterVpnLink> identifier, InterVpnLink add) {
        ...
        long vpn1Id = VpnUtil.getVpnId(broker, vpn1Name);
        ...
        long vpn2Id = VpnUtil.getVpnId(broker, vpn2Name);
        ...
        if (firstDpnList != null && !firstDpnList.isEmpty()) {
            ...
            InterVpnLinkUtil.updateVpnFootprint(broker, fibManager, notificationsService, vpn1Name, secondDpnList);
            InterVpnLinkUtil.updateVpnFootprint(broker, fibManager, notificationsService, vpn2Name, firstDpnList);
