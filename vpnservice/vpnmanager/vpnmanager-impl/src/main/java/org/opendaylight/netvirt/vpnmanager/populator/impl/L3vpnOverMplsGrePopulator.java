...
public class L3vpnOverMplsGrePopulator extends L3vpnPopulator {
    ...
    public L3vpnOverMplsGrePopulator(VpnInterfaceManager context, String rd, Adjacency nextHop, String nextHopIp,
                                     String vpnName, String interfaceName, BigInteger dpnId) {
        ...
        if (rd != null) {
            ...
            for (VpnInstanceOpDataEntry vpn : vpnsToImportRoute) {
                ...
                if (vpnRd != null) {
                    ...
                    context.getFibManager().addOrUpdateFibEntry(broker, vpnRd, null /*macAddress*/,
            ...
            context.getFibManager().addOrUpdateFibEntry(broker, vpnName, null /*macAddress*/,
                    nextHop.getIpAddress(), Arrays.asList(nextHopIp), encapType, (int) label,
