...
public class InterVpnLinkUtil {
    ...
    public static void leakRoute(DataBroker broker, IBgpManager bgpManager, InterVpnLink interVpnLink,
        ...
        RoutePaths routePaths = VpnHelper.buildRoutePath(Arrays.asList(endpointIp), label);
        VrfEntry newVrfEntry = VpnHelper.buildVrfEntry(prefix, routePaths, RouteOrigin.INTERVPN);
