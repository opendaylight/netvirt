    ...
    public static String getEndpointIpAddressForDPN(DataBroker broker, BigInteger dpnId) {
        ...
        try {
            Optional<DPNTEPsInfo> tunnelInfo =
                SingleTransactionDataBroker.syncReadOptional(broker, LogicalDatastoreType.CONFIGURATION, tunnelInfoId);
            ...
            LOG.error("Error retrieving endpoint IP address for DPN {}", dpnId, e);
        }
        return nextHopIp;
    }
