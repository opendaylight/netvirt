...
public class ArpResponderHandler {
    ...
    private boolean anyOtherVpnIfaceOnDpnOfSubnet( BigInteger dpnId, String ifaceName,  Uuid subnetId,
             long vpnId) {
...
//    }
    ...
    public void addArpResponderFlow( BigInteger dpnId,  int lportTag,  String vpnName,  long vpnId,
             String interfaceName,  Uuid subnetId,  String gatewayIp,  String mac,
             MacType macType) {
...
//    }
    ...
    public void removeArpResponderFlow( BigInteger dpId,  int lportTag,  String ifName,
             String vpnName,  long vpnId,  Uuid subnetUuid) {
    ...
    public void removeArpResponderFlowOnRouterIfRemove(VpnInterface vpnInterface) {
        InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.l3vpn.rev130911.vpn.instance.to.vpn.id.VpnInstance> id = VpnUtil
                .getVpnInstanceToVpnIdIdentifier(vpnInterface.getVpnInstanceName());
