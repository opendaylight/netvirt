...
public class VpnNodeListener extends AbstractDataChangeListener<Node> implements AutoCloseable {
    ...
    private void registerListener(final DataBroker db) {
        listenerRegistration = db.registerDataChangeListener(LogicalDatastoreType.OPERATIONAL,
            getWildCardPath(), VpnNodeListener.this, AsyncDataBroker.DataChangeScope.SUBTREE);
    }
    ...
    public void processNodeAdd(BigInteger dpId) {
