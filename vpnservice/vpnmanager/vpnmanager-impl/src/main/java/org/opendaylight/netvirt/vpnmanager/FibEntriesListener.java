...
public class FibEntriesListener extends AbstractDataChangeListener<VrfEntry> implements AutoCloseable {
    ...
    public FibEntriesListener(final DataBroker db, final VpnManager vpnManager) {
    ...
    protected void remove(InstanceIdentifier<VrfEntry> identifier,
        ...
        VpnInstanceOpDataEntry vpnInstanceOpData = vpnManager.getVpnInstanceOpData(rd);
    ...
    protected void add(InstanceIdentifier<VrfEntry> identifier,
        ...
        VpnInstanceOpDataEntry vpn = vpnManager.getVpnInstanceOpData(rd);
        if(vpn != null) {
