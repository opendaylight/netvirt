...
public class FibEntriesListener extends AsyncDataTreeChangeListenerBase<VrfEntry, FibEntriesListener>
    ...
    protected void update(InstanceIdentifier<VrfEntry> identifier,
        ...
        List<RoutePaths> originalRoutePaths = new ArrayList<>();
        List<RoutePaths> updateRoutePaths = new ArrayList<>();
        originalRoutePaths.addAll(original.getRoutePaths());
        updateRoutePaths.addAll(update.getRoutePaths());
