...
public class L3vpnPopulator implements VpnPopulator {
    protected VpnInterfaceManager context; //TODO (KIRAN) : Context needs to be abstract entitiy/interface implemented
                                           //TODO  by classes of type Context(Managers/Listeners in our case)
    protected String rd;
    ...
    protected L3vpnPopulator(VpnInterfaceManager context, String rd, String vpnName, Adjacency nextHop, String nextHopIp) {
    ...
    protected void addPrefixToBGP(String rd, String macAddress, String prefix, String nextHopIp,
        ...
        try {
            ...
            context.getFibManager().addOrUpdateFibEntry(broker, rd, macAddress, prefix, Arrays.asList(nextHopIp),
