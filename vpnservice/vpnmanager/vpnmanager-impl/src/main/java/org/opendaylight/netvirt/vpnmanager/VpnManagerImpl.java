...
public class VpnManagerImpl implements IVpnManager {
    ...
    public void setupArpResponderFlowsToExternalNetworkIps(String id, Collection<String> fixedIps, String macAddress,
        ...
        setupArpResponderFlowsToExternalNetworkIps(id, fixedIps, macAddress, dpnId, extNetworkId, vpnId, writeTx,
                addOrRemove);
    }

    @Override
    public void setupArpResponderFlowsToExternalNetworkIps(String id, Collection<String> fixedIps, String macAddress,
            BigInteger dpnId, Uuid extNetworkId, long vpnId, WriteTransaction writeTx, int addOrRemove) {
        ...
        if (lportTag == null) {
            LOG.debug("No Lport tag found for interface {}. Delaying flows for router-id {}",
                    extInterfaceName, id);
            return;
        }
