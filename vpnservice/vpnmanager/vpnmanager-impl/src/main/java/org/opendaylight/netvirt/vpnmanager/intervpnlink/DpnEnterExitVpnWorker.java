...
import org.opendaylight.yang.gen.v1.urn.opendaylight.l3vpn.rev130911.AddDpnEventBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.l3vpn.rev130911.RemoveDpnEvent;
import org.opendaylight.yang.gen.v1.urn.opendaylight.l3vpn.rev130911.RemoveDpnEventBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.l3vpn.rev130911.add.dpn.event.AddEventData;
import org.opendaylight.yang.gen.v1.urn.opendaylight.l3vpn.rev130911.add.dpn.event.AddEventDataBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.l3vpn.rev130911.remove.dpn.event.RemoveEventData;
import org.opendaylight.yang.gen.v1.urn.opendaylight.l3vpn.rev130911.remove.dpn.event.RemoveEventDataBuilder;
...
public class DpnEnterExitVpnWorker implements FutureCallback<List<Void>> {
    ...
    private static Logger LOG = LoggerFactory.getLogger(DpnEnterExitVpnWorker.class);

    public DpnEnterExitVpnWorker(NotificationPublishService notifPublishService, BigInteger dpnId, String vpnName,
