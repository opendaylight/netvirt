...
public class InterVpnLinkNodeListener extends AsyncDataTreeChangeListenerBase<Node, InterVpnLinkNodeListener>
    ...
    private void reinstallInterVpnLink(InterVpnLinkDataComposite ivl) {
        ...
        dsJobCoordinator.enqueueJob(
                "REMOVE.INTERVPNLINK." + interVpnLinkIid.firstKeyOf(InterVpnLink.class).getName(),
                new InterVpnLinkRemoverTask(dataBroker, interVpnLinkIid));
        dsJobCoordinator.enqueueJob("IVPNLINK.CLEANED.CHECKER" + interVpnLink.getName(),
                new InterVpnLinkCleanedCheckerTask(dataBroker, interVpnLink));
        dsJobCoordinator.enqueueJob("IVpnLink.creation." + interVpnLink.getName(),
                new InterVpnLinkCreatorTask(dataBroker, interVpnLink));
    }
