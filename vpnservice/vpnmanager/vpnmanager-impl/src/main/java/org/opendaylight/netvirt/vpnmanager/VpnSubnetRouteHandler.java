...
public class VpnSubnetRouteHandler implements NeutronvpnListener {
    ...
    public void onSubnetAddedToVpn(SubnetAddedToVpn notification) {
        ...
        LOG.info("onSubnetAddedToVpn: Subnet " + subnetId.getValue() + " being added to vpn");
        long vpnId = VpnUtil.getVpnId(dataBroker, vpnName);
        if (vpnId == VpnConstants.INVALID_ID) {
            vpnInterfaceManager.waitForVpnInstance(vpnName, VpnConstants.PER_VPN_INSTANCE_MAX_WAIT_TIME_IN_MILLISECONDS,
                vpnInterfaceManager.getvpnInstanceToIdSynchronizerMap());
    ...
    private boolean addSubnetRouteToFib(String rd, String subnetIp, BigInteger nhDpnId, String vpnName,
        Long elanTag, int label, Uuid subnetId) {
