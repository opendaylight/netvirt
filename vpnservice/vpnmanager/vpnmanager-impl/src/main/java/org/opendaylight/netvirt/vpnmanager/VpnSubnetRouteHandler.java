            ...
            try {
                ...
                if ((nhDpnId != null) && (nhDpnId.equals(dpnId))) {
                    ...
                    if (last) {
                        ...
                        electNewDpnForSubnetRoute(subOpBuilder, nhDpnId, subnetId, subnetmap.getNetworkId(), true);
        ...
        if (isBgpVpn) {
            if (nhTepIp != null) {
                ...
                isRouteAdvertised = addSubnetRouteToFib(rd, subnetIp, nhDpnId, nhTepIp,
                        vpnName, elanTag, label, subnetId);
            ...
            isRouteAdvertised = addSubnetRouteToFib(rd, subnetIp, nhDpnId, null /*nhTepIp*/, vpnName, elanTag,
                    0 /*label*/, subnetId, isBgpVpn, networkId.getValue());
            subOpBuilder.setNhDpnId(nhDpnId);
            if (isRouteAdvertised) {
                subOpBuilder.setRouteAdvState(TaskState.Advertised);
            } else {
