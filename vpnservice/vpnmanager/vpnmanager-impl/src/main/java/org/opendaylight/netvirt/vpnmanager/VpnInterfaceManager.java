...
public class VpnInterfaceManager extends AsyncDataTreeChangeListenerBase<VpnInterface, VpnInterfaceManager>
    ...
    private void programMyMacAndArpResponderTbl(final BigInteger dpnId, final String vpnName, final long vpnId,
            final String interfaceName, final int lportTag, final String ipPreFix, final Adjacency nextHop, final WriteTransaction writeInvTxn,
        ...
        if (gwIp.isPresent()) {
            if (flowOperType == NwConstants.ADD_FLOW) {
                final Prefixes srcGwMac = VpnUtil.resolveGwSourceMacForVpnInterface(dataBroker,
                        writeOperTxn, dpnId, vpnName, interfaceName, ipPreFix, gwIp.get());
