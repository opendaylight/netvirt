...
public class VpnInterfaceManager extends AsyncDataTreeChangeListenerBase<VpnInterface, VpnInterfaceManager> {
    ...
    protected void processVpnInterfaceAdjacencies(BigInteger dpnId, final int lportTag, String vpnName,
        ...
        if (!adjacencies.isPresent()) {
            addVpnInterfaceToOperational(vpnName, interfaceName, dpnId, null, writeOperTxn, false,
        ...
        addVpnInterfaceToOperational(vpnName, interfaceName, dpnId, aug, writeOperTxn, false, stateIf);
        ...
        public void run() {
            ...
            for (UpdateData updData : processQueue) {
                ...
                for (VpnInstanceNames vpnInterfaceVpnInstance : updData.getOriginal().getVpnInstanceNames()) {
                    ...
                    maxInterfaceList ++;
                    LOG.debug("VPN Interface.delBindServices: interface {} vpn {} bindService",
                               interfaceName, oldVpnName);
                    updateBindServices(oldVpnName, interfaceName, updData.getOriginal(), false);
