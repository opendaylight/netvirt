        ...
        if (adjList != null) {
            ...
            for (Adjacency adj : adjList) {
                ...
                if (nextHopAdded) {
                    ...
                    fibManager.updateFibEntry(dataBroker, primaryRd, prefix, nhList, null);
        ...
        if (adjList != null) {
            ...
            for (Adjacency adj : adjList) {
                ...
                if(isNextHopRemoveReqd) {
                    ...
                    fibManager.updateFibEntry(dataBroker, primaryRd, prefix, new ArrayList<String>() /* empty */, null);
