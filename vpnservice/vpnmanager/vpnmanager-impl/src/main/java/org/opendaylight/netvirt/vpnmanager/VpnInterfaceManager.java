...
//    }
        ...
        if (adjacencies.isPresent()) {
            ...
            for (Adjacency nextHop : nextHops) {
                ...
                if (nextHop.isPrimaryAdjacency()) {
                    ...
                    addArpResponderFlow(dpnId, lPortTag, vpnName, interfaceName, subnetId);
                } else {
            ...
            if (!nextHops.isEmpty()) {
                ...
                for (Adjacency nextHop : nextHops) {
                    ...
                    if (!nextHop.isPrimaryAdjacency()) {
                        ...
                        removeArpResponderFlow(nextHop, lPortTag, dpnId);
                    }
    ...
    private void addArpResponderFlow(BigInteger dpId, int lPortTag, String vpnName, String ifName, Uuid subnetId){
    ...
    private void removeArpResponderFlow(final Adjacency adjacency, final int lPortTag, final BigInteger dpId){
