...
//    }
    ...
    protected void addExtraRoute(String destination, String nextHop, String rd, String routerID, int label,
        ...
        if ( optInterVpnLink.isPresent() ) {
            ...
            if (rd != null) {
                addPrefixToBGP(rd, destination, nextHopIpList, label, writeConfigTxn);
            } else {
                // ### add FIB route directly
                fibManager.addOrUpdateFibEntry(dataBroker, routerID, destination, nextHopIpList, label, RouteOrigin.STATIC, writeConfigTxn);
            }
        }
