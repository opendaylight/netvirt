...
public class VpnInterfaceManager extends AsyncDataTreeChangeListenerBase<VpnInterface, VpnInterfaceManager>
    ...
    private final Map<String, ConcurrentLinkedQueue<UnprocessesVpnInterfaceData>> unprocessedVpnInterfaces =
        ...
        if (interfaceState != null) {
            try {
                if (isVpnInstanceReady(vpnInterface.getVpnInstanceName())) {
                    ...
                    addToUnproccessesVpnInterfaces(
                            new UnprocessesVpnInterfaceData(identifier, vpnInterface, oldAdjs, newAdjs));
                }
            } catch (Exception e) {
    ...
    private void processSavedInterface(UnprocessesVpnInterfaceData intefaceData) {
    ...
    private void addToUnproccessesVpnInterfaces(final UnprocessesVpnInterfaceData interfaceData) {
        ...
        ConcurrentLinkedQueue<UnprocessesVpnInterfaceData> vpnInterfaces = unprocessedVpnInterfaces
    ...
    public void vpnInstanceIsReady(String vpnInstanceName) {
        synchronized (this) {
            ...
            ConcurrentLinkedQueue<UnprocessesVpnInterfaceData> concurrentLinkedQueue =
                    unprocessedVpnInterfaces.get(vpnInstanceName);
            if (concurrentLinkedQueue != null) {
                while (!concurrentLinkedQueue.isEmpty()) {
                    UnprocessesVpnInterfaceData savedInterface = concurrentLinkedQueue.poll();
    ...
    private static class UnprocessesVpnInterfaceData {
        InstanceIdentifier<VpnInterface> identifier;
        VpnInterface vpnInterface;
        List<Adjacency> oldAdjs;
        List<Adjacency> newAdjs;

        public UnprocessesVpnInterfaceData(InstanceIdentifier<VpnInterface> identifier, VpnInterface vpnInterface,
        ...
        public boolean equals(Object obj) {
            ...
            if (getClass() != obj.getClass())
                return false;
            UnprocessesVpnInterfaceData other = (UnprocessesVpnInterfaceData) obj;
            if (identifier == null) {
