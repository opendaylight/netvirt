...
public class VpnInterfaceManager extends AsyncDataTreeChangeListenerBase<VpnInterface, VpnInterfaceManager>
    ...
    public VpnInterfaceManager(final DataBroker dataBroker, final IBgpManager bgpManager,
        final OdlArputilService arpManager, final IdManagerService idManager, final IMdsalApiManager mdsalManager,
        final IFibManager fibManager, final OdlInterfaceRpcService ifaceMgrRpcService,
        ...
        if (!isInterfaceUp) {
            ...
            if (vpnId == VpnConstants.INVALID_ID) {
                ...
                if (vpnInstanceOpDataEntry == null) {
                    ...
                    if (vpnInstanceOpDataEntry == null) {
                        LOG.error(
                            "VpnInstanceOpData not populated even after {} ms for vpn {} rd {} vpninterface {}, "
                                + "bailing out ",
    ...
    private void addArpResponderFlow(final WriteTransaction writeInvTxn, final BigInteger dpId, final int lportTag,
        ...
        if (gatewayIp.isPresent()) {
            ...
            ArpResponderUtil.installFlow(mdsalManager, writeInvTxn, dpId, flowId, flowId,
                ...
                ArpResponderUtil.generateCookie(lportTag, gwIp),
