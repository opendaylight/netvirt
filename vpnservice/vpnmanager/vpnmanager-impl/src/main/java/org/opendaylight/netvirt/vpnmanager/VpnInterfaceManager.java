    ...
    private void removeVpnInterfaceFromVpn(final InstanceIdentifier<VpnInterface> identifier,
        ...
        jobCoordinator.enqueueJob("VPNINTERFACE-" + interfaceName + vpnName,
            () -> {
                ...
                ListenableFuture<Void> cfgFutr = txRunner.callWithNewWriteOnlyTransactionAndSubmit(writeConfigTxn -> {
                ...
                futures.add(cfgFutr);
                Futures.addCallback(cfgFutr, new PostVpnInterfaceWorker(interfaceName, false, "Config"));
                return futures;
            });
    }
