                        ...
                        if (vpnInterface != null) {
                            ...
                            for (VpnInstanceNames vpnInterfaceVpnInstance : vpnInterface.getVpnInstanceNames()) {
                                ...
                                LOG.info("VPN Interface add event - intfName {} onto vpnName {} running "
                                        + "oper-driven", vpnInterface.getName(), vpnName);
                            ...
                            if (update.getOperStatus().equals(Interface.OperStatus.Up)) {
                                ...
                                for (VpnInstanceNames vpnInterfaceVpnInstance : vpnInterface.getVpnInstanceNames()) {
                                    ...
                                    if (optVpnInterface.isPresent()) {
                                        ...
                                        vpnInterfaceManager.processVpnInterfaceDown(dpnId, vpnInterface.getName(),
