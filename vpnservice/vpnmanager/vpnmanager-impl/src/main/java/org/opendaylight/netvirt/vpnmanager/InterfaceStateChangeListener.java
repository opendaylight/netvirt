                        ...
                        if (configInterface != null && (configInterface.getType() != null)
                            ...
                            if (vpnInterface != null) {
                                ...
                                if (!vpnInterfaceManager.isVpnInstanceReady(vpnInterface.getVpnInstanceName())) {
                                    LOG.error("InterfaceStateChangeListener- VpnInstance for vpnInterface {} not ready, holding on ", vpnInterface.getName());
                                    return futures;
                                }
                    ...
                    () -> {
                        ...
                        if (vpnInterface != null) {
                            ...
                            if (update.getOperStatus().equals(Interface.OperStatus.Up)) {
                                if (!vpnInterfaceManager.isVpnInstanceReady(vpnInterface.getVpnInstanceName())) {
                                    LOG.error("InterfaceStateChangeListener Update - VpnInstance for vpnInterface {} not ready, holding on", vpnInterface.getName());
                                    return futures;
                                }
