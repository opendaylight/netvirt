...
public class ArpMonitorStopTask implements Callable<List<ListenableFuture<Void>>> {
    ...
    public ArpMonitorStopTask(MacEntry macEntry, DataBroker dataBroker, AlivenessMonitorService alivenessManager) {
        super();
    ...
    public List<ListenableFuture<Void>> call() throws Exception {
        ...
        removeMipAdjacency(macEntry.getIpAddress().getHostAddress(), macEntry.getVpnName(), macEntry.getInterfaceName(), tx);
        VpnUtil.removeVpnPortFixedIpToPort(dataBroker, macEntry.getVpnName(), macEntry.getIpAddress().getHostAddress());
