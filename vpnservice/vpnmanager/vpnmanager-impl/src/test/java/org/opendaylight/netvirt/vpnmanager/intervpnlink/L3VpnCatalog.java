...
public class L3VpnCatalog {
    ...
    static L3VpnComposite build(String vpnName, String vpnRd, long vpnTag, List<String> irts, List<String> erts) {
        ...
        return new L3VpnComposite(vpnInst,
                                  new VpnInstanceOpDataEntryBuilder().setVpnId(vpnTag).setVpnInstanceName(vpnName)
                                          .setVrfId(vpnRd).setVpnTargets(VpnOperDsUtils.makeVpnTargets(irts, erts))
                                          .build());
    }
