...
public class VpnSubnetRouteHandlerTest {
    ...
    VpnInterfaceOpData vpnIntfaces = null;
    ...
    private void setupMocks() {
        ...
        vpnIntfaces = new VpnInterfaceOpDataBuilder().setInterfaceName(interfaceName)
            .setVpnName(vpnName).setKey(new VpnInterfaceOpDataKey(interfaceName, vpnName)).build();
        List<VpnInterfaceOpData> vpnInterfaces = new ArrayList<>();
        ...
        subnetToDpn = new SubnetToDpnBuilder().setDpnId(dpId).setKey(new SubnetToDpnKey(dpId)).setVpnInterfaceOpData(
            vpnInterfaces).build();
