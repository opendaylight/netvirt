...
public class InterVpnLinkTestCatalog {
    ...
    static InterVpnLinkDataComposite build(String ivpnLinkName, String vpn1Name, String vpn1IpAddr,
        ...
        FirstEndpointState firstEndpointState = new FirstEndpointStateBuilder().setVpnUuid(new Uuid(vpn1Name))
                                                                               .setLportTag(vpn1LportTag)
                                                                               .setDpId(vpn1Dpns).build();
        SecondEndpointState secondEndpointState = new SecondEndpointStateBuilder().setVpnUuid(new Uuid(vpn2Name))
                                                                                  .setLportTag(vpn2LportTag)
    ...
    static void updateEndpointDpns(InterVpnLinkDataComposite ivl, boolean is1stEndpoint,
                                                List<BigInteger> newDpns) {
    ...
    static InterVpnLinkDataComposite I_VPN_LINK_12 =
        build("InterVpnLink VPN1-VPN2", L3VpnCatalog.VPN_1.vpnCfgData.getVpnInstanceName(), "1.1.1.1",
              L3VpnCatalog.VPN_2.vpnCfgData.getVpnInstanceName(), "2.2.2.2", false, false, false,
    ...
    static InterVpnLinkDataComposite I_VPN_LINK_34 =
        build("InterVpnLink VPN3-VPN4", L3VpnCatalog.VPN_3.vpnCfgData.getVpnInstanceName(), "3.3.3.3",
              L3VpnCatalog.VPN_4.vpnCfgData.getVpnInstanceName(), "4.4.4.4", false, false, false,
    ...
    static InterVpnLinkDataComposite I_VPN_LINK_56 =
        build("InterVpnLink VPN5-VPN6", L3VpnCatalog.VPN_5.vpnCfgData.getVpnInstanceName(), "5.5.5.5",
              L3VpnCatalog.VPN_6.vpnCfgData.getVpnInstanceName(), "6.6.6.6", false, false, false,
