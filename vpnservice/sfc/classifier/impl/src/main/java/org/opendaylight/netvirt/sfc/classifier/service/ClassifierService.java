...
public class ClassifierService {
    ...
    @Inject
    public ClassifierService(NetvirtProvider netvirtProvider, GeniusProvider geniusProvider, SfcProvider sfcProvider,
                             OpenFlow13Provider openFlow13Provider, DataBroker dataBroker) {
        this.netvirtProvider = netvirtProvider;
        this.geniusProvider = geniusProvider;
        this.sfcProvider = sfcProvider;
        this.openFlow13Provider = openFlow13Provider;
        this.dataBroker = dataBroker;
        List<ClassifierRenderer> classifierRenderers = new ArrayList<>();
