...
public class SfcProvider {
    ...
    public Optional<RenderedServicePath> getRenderedServicePath(String rspName) {
        ...
        return Optional.ofNullable(mdsalUtils.read(LogicalDatastoreType.OPERATIONAL, rspIid));
    }
    ...
    private Optional<ServiceFunction> getServiceFunction(SfName name) {
        ...
        return Optional.ofNullable(mdsalUtils.read(LogicalDatastoreType.CONFIGURATION, sfIid));
    }
