...
public class GeniusProvider {
    ...
    public void bindPortOnIngressClassifier(String interfaceName) {
        bindService(
                ...
                NwConstants.SFC_SERVICE_INDEX, // TODO Not sure what to put for this one
    ...
    public Optional<String> getIpFromInterfaceName(String interfaceName) {
        ...
        return Optional.ofNullable(ipList.get(0).toString());
    }
    ...
    public Optional<Long> getNodeConnectorIdFromInterfaceName(String interfaceName) {
        LOG.debug("getDpnIdFromInterfaceName: starting (logical interface={})", interfaceName);
        ...
        Optional<Long> nodeConnId = Optional.empty();
        try {
            ...
            nodeConnId = Optional.ofNullable(Long.valueOf(output.getResult().getNodeconnectorId().getValue()));
    ...
    private void bindService(short serviceId, String serviceName, int servicePriority,
        ...
        mdsalUtils.put(LogicalDatastoreType.CONFIGURATION, id, boundServices);
    ...
    private void unbindService(String interfaceName, short serviceId) {
        ...
        mdsalUtils.delete(LogicalDatastoreType.CONFIGURATION, id);

        LOG.info("Unbinding Service ID [{}] interface [{}]",
