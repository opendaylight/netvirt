...
public class GeniusProviderTest extends ConstantSchemaAbstractDataBrokerTest {
    ...
    public void bindPortOnIngressClassifier() {
        ...
        geniusProvider.bindPortOnIngressClassifier(GeniusProviderTestParams.INTERFACE_NAME.str());
        ...
        InstanceIdentifier<BoundServices> id = geniusProvider.getBindServiceId(NwConstants.SFC_CLASSIFIER_INDEX,
                GeniusProviderTestParams.INTERFACE_NAME.str(), true);
        Optional<BoundServices> boundServices = getBoundServices(id);
        assertTrue(boundServices.isPresent());

        // UnBind the Ingress Service
        geniusProvider.unbindPortOnIngressClassifier(GeniusProviderTestParams.INTERFACE_NAME.str());
    ...
    public void bindPortOnEgressClassifier() {
        ...
        geniusProvider.bindPortOnEgressClassifier(GeniusProviderTestParams.INTERFACE_NAME.str());

        // Now make sure its in the data store
        InstanceIdentifier<BoundServices> id = geniusProvider.getBindServiceId(
                NwConstants.EGRESS_SFC_CLASSIFIER_SERVICE_INDEX,
                GeniusProviderTestParams.INTERFACE_NAME.str(),
                false);
        Optional<BoundServices> boundServices = getBoundServices(id);
        assertTrue(boundServices.isPresent());

        // UnBind the Egress Service
        geniusProvider.unbindPortOnEgressClassifier(GeniusProviderTestParams.INTERFACE_NAME.str());
    ...
    public void getNodeIdFromLogicalInterface() {
        ...
        Optional<NodeId> nodeId = this.geniusProvider.getNodeIdFromLogicalInterface(
                GeniusProviderTestParams.INTERFACE_NAME_NO_EXIST.str());
        ...
        nodeId = this.geniusProvider.getNodeIdFromLogicalInterface(
                GeniusProviderTestParams.INTERFACE_NAME_INVALID.str());
        assertFalse(nodeId.isPresent());
        ...
        assertEquals(nodeId.get().getValue(), GeniusProviderTestParams.NODE_ID.str());
    }
    ...
    public void getNodeIdFromDpnId() {
        ...
        nodeId = this.geniusProvider.getNodeIdFromDpnId(new DpnIdType(GeniusProviderTestParams.DPN_ID.big()));
        assertTrue(nodeId.isPresent());
        assertEquals(nodeId.get().getValue(), GeniusProviderTestParams.NODE_ID.str());
    }
    ...
    public void getIpFromInterfaceName() {
        ...
        assertEquals(ipStr.get(), GeniusProviderTestParams.IPV4_ADDRESS_STR.str());
    }
    ...
    public void getDpnIdFromInterfaceName() {
        ...
        assertEquals(dpnId.get().getValue(), GeniusProviderTestParams.DPN_ID.big());
    }
    ...
    public void getNodeConnectorIdFromInterfaceName() {
        ...
        assertEquals(nodeConnStr.get(), GeniusProviderTestParams.NODE_CONNECTOR_ID_PREFIX.str()
                + GeniusProviderTestParams.INTERFACE_NAME.str());
    }
    ...
    public void getEgressVxlanPortForNode() {
        ...
        Optional<Long> ofPort = this.geniusProvider.getEgressVxlanPortForNode(
                GeniusProviderTestParams.DPN_ID_NO_EXIST.big());
        assertFalse(ofPort.isPresent());

        // Test that it correctly handles when there are no tunnel ports on the bridge
        ofPort = this.geniusProvider.getEgressVxlanPortForNode(GeniusProviderTestParams.DPN_ID_NO_PORTS.big());
        assertFalse(ofPort.isPresent());

        // Test that it correctly handles when there are no VXGPE tunnel ports on the bridge
        ofPort = this.geniusProvider.getEgressVxlanPortForNode(GeniusProviderTestParams.DPN_ID_NO_VXGPE_PORTS.big());
        assertFalse(ofPort.isPresent());

        // Test that is correctly handles when a terminationPoint has no options
        ofPort = this.geniusProvider.getEgressVxlanPortForNode(GeniusProviderTestParams.DPN_ID_NO_OPTIONS.big());
        assertFalse(ofPort.isPresent());

        // Test that it correctly returns the OpenFlow port when everything is correct
        ofPort = this.geniusProvider.getEgressVxlanPortForNode(GeniusProviderTestParams.DPN_ID.big());
        assertTrue(ofPort.isPresent());
        assertEquals(ofPort.get(), GeniusProviderTestParams.OF_PORT.longValue());
    }
