...
public class PortPairTranslator {
    ...
    private static final String SFF_LOGICAL_DEFAULT = "Netvirt-Logical-SFF";
    ...
    public static ServiceFunctionBuilder buildServiceFunction(
        ...
        logicalInterfaceDplBuilder.setServiceFunctionForwarder(new SffName(SFF_LOGICAL_DEFAULT));
