...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.sfc.acl.rev150105.NeutronMatchesBuilder;
...
public class FlowClassifierTranslator {
    ...
    public static Acl buildAcl(SfcFlowClassifier flowClassifier, String rspName) {
        ...
        NeutronMatchesBuilder neutronMatchesBuilder = new NeutronMatchesBuilder();
        ...
        if (flowClassifier.getLogicalSourcePort() != null) {
            neutronMatchesBuilder.setSourcePortUuid(flowClassifier.getLogicalSourcePort().getValue());
        }
        if (flowClassifier.getLogicalDestinationPort() != null) {
            neutronMatchesBuilder.setDestinationPortUuid((flowClassifier.getLogicalDestinationPort().getValue()));
        }
        ...
        matchesBuilder.addAugmentation(NeutronMatches.class, neutronMatchesBuilder.build());
