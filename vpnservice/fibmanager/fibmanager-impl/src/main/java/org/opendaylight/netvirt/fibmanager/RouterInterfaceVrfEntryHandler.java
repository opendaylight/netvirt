...
@Singleton
public class RouterInterfaceVrfEntryHandler extends BaseVrfEntryHandler implements AutoCloseable {
    ...
    protected Boolean installRouterFibEntries(VrfEntry vrfEntry, String rd,
