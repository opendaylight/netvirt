...
import org.opendaylight.yang.gen.v1.urn.opendaylight.genius.interfacemanager.rev160406.TunnelTypeMplsOverUdp;
...
//                }
    ...
    private void createRemoteFibEntry(final BigInteger remoteDpnId, final long vpnId, final VrfTablesKey vrfTableKey,
        ...
        for (String tunnelInterface : tunnelInterfaceList) {
            ...
            if (tunnel_type.equals(TunnelTypeMplsOverGre.class) || tunnel_type.equals(TunnelTypeMplsOverUdp.class)) {
