...
public class VrfEntryHelper
{
    ...
    static String getInterVpnFibFlowRef(String interVpnLinkName, String prefix, String nextHop ) {
    ...
    static String getTableMissFlowRef(BigInteger dpnId, short tableId, int tableMiss) {
