...
public class NexthopManager implements AutoCloseable {
    ...
    public AdjacencyResult getRemoteNextHopPointer(BigInteger remoteDpnId, long vpnId, String prefixIp,
                                                   String nextHopIp, String vpnName) {
        ...
        ElanInstance elanInstance = getElanInstanceForPrefix(vpnId, prefixIp, vpnName);
    ...
    private ElanInstance getElanInstanceForPrefix(long vpnId, String prefixIp, String vpnName) {
        ...
        if (elanInstance == null) {
            LOG.debug("No ELAN instance found for prefixIp {} and vpnId {}, "
                    + "will try to get ELAN interface for external network vpn", prefixIp, vpnId);
            elanInstance = elanService.getElanInstance(vpnName);
        }
