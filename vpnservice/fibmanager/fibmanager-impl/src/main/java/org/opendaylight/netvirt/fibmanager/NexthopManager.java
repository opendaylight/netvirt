...
public class NexthopManager implements AutoCloseable {
                ...
                if (macAddress != null) {
                    ...
                    if (nextHopSrcMac.isPresent()) {
                        LOG.trace("The Local NextHop Group Source Mac {} for VpnInrerface {} on VPN {}",
                                nextHopSrcMac.get(), ifName, vpnName);
                        listActionInfo.add(
    ...
    private Optional<String> getNextHopSourceMac(final String vpnName, final String vpnInterface) {
        ...
        final InstanceIdentifier<VpnInterfaceToGwSrcMacData> identifier = InstanceIdentifier
                ...
                .child(VpnInterfaceToGwSrcMacData.class, new VpnInterfaceToGwSrcMacDataKey(vpnInterface, vpnName));
        final Optional<VpnInterfaceToGwSrcMacData> srcGwMac = FibUtil.read(dataBroker, LogicalDatastoreType.OPERATIONAL,
                identifier);
