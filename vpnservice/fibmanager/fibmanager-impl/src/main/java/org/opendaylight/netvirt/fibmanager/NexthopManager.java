...
public class NexthopManager implements AutoCloseable {
    ...
    public AdjacencyResult getInterfaceTypeForInterfaceName(final BigInteger remoteDpnId, final long vpnId,
                                                            final VrfEntry vrfEntry, String nexHopIp,
        ...
        LOG.trace("getInterfaceTypeForInterfaceName: for vpnId {} dpnId {} IntfName {}", vpnId, remoteDpnId,
                interfaceName);
        return interfaceName != null ? new AdjacencyResult(interfaceName, egressIfType, nexHopIp,
