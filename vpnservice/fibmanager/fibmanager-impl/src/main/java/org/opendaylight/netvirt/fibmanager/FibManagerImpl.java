...
public class FibManagerImpl implements IFibManager {
    ...
    @Override
    public List<ListenableFuture<Void>> programDcGwLoadBalancingGroup(IpAddress dcGwIp, List<String> availableDcGws, BigInteger dpnId, int addOrRemove) {
        return nexthopManager.programDcGwLoadBalancingGroup(dcGwIp, availableDcGws, dpnId, addOrRemove);
    }
}
