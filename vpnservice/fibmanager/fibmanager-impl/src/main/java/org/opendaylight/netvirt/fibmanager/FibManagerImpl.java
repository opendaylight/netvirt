...
public class FibManagerImpl implements IFibManager {
    ...
    @Override
    public List<ListenableFuture<Void>> programDcGwLoadBalancingGroup(WriteTransaction tx, IpAddress dcGwIp, List<String> availableDcGws, BigInteger dpnId) {
        return nexthopManager.programDcGwLoadBalancingGroup(tx, dcGwIp, availableDcGws, dpnId);
    }
}
