...
public class FibManagerImpl implements IFibManager {
    ...
    @Override
    public void addOrUpdateFibEntry(DataBroker broker, String rd, String prefix, List<NexthopAddresses> nextHopList,
    ...
    @Override
    public void updateFibEntry(DataBroker broker, String rd, String prefix , List<NexthopAddresses> nextHopList, long label, WriteTransaction writeConfigTxn) {
