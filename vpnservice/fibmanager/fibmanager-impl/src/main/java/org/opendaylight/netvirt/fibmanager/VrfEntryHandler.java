...
@Singleton
public class VrfEntryHandler implements AutoCloseable {

    private static final Logger LOG = LoggerFactory.getLogger(VrfEntryHandler.class);
    ...
    @Inject
    public VrfEntryHandler(final DataBroker dataBroker, final NexthopManager nexthopManager) {
