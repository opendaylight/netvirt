...
public class FibUtil {
    ...
    public static void updateLbGroupInfo(BigInteger dpnId, String destinationIp, String groupIdKey,
        ...
        Nexthops nextHopsToGroupId = buildNextHops(destinationIp, groupIdKey, groupId);
    ...
    private static Nexthops buildNextHops(String destinationIp, String groupIdKey, String groupId) {
