...
import static org.opendaylight.netvirt.fibmanager.VrfEntryListener.areOpenStackVniSemanticsEnforced;
...
public class FibUtil {
    ...
    protected static boolean enforceVxlanDatapathSemanticsforInternalRouterVpn(DataBroker dataBroker, Uuid subnetId,
        ...
        return (isVxlanNetworkAndInternalRouterVpn(dataBroker, subnetId, getVpnNameFromId(dataBroker, vpnId), rd)
                && areOpenStackVniSemanticsEnforced);
    }

    protected static boolean enforceVxlanDatapathSemanticsforInternalRouterVpn(DataBroker dataBroker, Uuid subnetId,
                                                                               String vpnName, String rd) {
        return (isVxlanNetworkAndInternalRouterVpn(dataBroker, subnetId, vpnName, rd)
                && areOpenStackVniSemanticsEnforced);
    }
}
