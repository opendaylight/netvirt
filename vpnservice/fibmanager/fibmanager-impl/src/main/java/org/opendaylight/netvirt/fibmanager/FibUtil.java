...
public class FibUtil {
    ...
    public static String getJobKeyFromRd(String rd, String prefix) {
        return "FIB-" + rd + "-" + prefix;
    }

    public static String getJobKeyFromDpnid(Long vpnId, BigInteger dpnId) {
        return "FIB-" + dpnId.toString() + "-" + dpnId.toString() ;
    }
