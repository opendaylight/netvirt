    ...
    public static void addOrUpdateFibEntry(DataBroker broker, String rd, String prefix, List<String> nextHopList,
        ...
        try{
            ...
            if (! entry.isPresent()) {
                ...
                RoutePaths route = VpnHelper.buildRoutePath(nextHopList, label);
                routes.add(route);
                VrfEntry vrfEntry = VpnHelper.buildVrfEntry(prefix, routes, origin);
                ...
                if (!optRoutePath.isPresent()) {
                    RoutePaths newRoute = VpnHelper.buildRoutePath(nextHopList, label);
                    routes.add(newRoute);
    ...
    public static void removeOrUpdateFibEntry(DataBroker broker, String rd, String prefix, String nextHopToRemove,
        ...
        if (!optRoutePath.isPresent()) {
            ...
            InstanceIdentifier<RoutePaths> routesId =
                    InstanceIdentifier.builder(FibEntries.class).child(VrfTables.class, new VrfTablesKey(rd))
                    .child(VrfEntry.class, new VrfEntryKey(prefix)).child(RoutePaths.class, routePath.getKey()).build();
