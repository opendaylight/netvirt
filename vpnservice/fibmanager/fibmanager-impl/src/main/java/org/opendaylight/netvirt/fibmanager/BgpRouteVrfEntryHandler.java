...
public class BgpRouteVrfEntryHandler implements AutoCloseable, ResourceHandler, VrfEntryHandler {
    ...
    public short enqueue (InstanceIdentifier<VrfEntry> identifier, VrfEntry vrfEntry, String rd, short action) {
        ActionableResource actResource = new ActionableResourceImpl(rd.toString() + vrfEntry.getDestPrefix());
        actResource.setAction(action);
    ...
    public short enqueueForUpdate (InstanceIdentifier<VrfEntry> identifier, VrfEntry original, VrfEntry update, String rd) {
