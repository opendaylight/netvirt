                ...
                if (ipAddresses != null) {
                    ...
                    if (ipAddressesSize == 0) {
                        ...
                        if (vpnInterfaces == null || vpnInterfaces.isEmpty()) {
                            ...
                            try {
                                SingleTransactionDataBroker.syncDelete(dataBroker, LogicalDatastoreType.OPERATIONAL,
                                        id.child(org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.l3vpn.rev130911
                                                .vpn.instance.op.data.vpn.instance.op.data.entry.vpn.to.dpn.list
                                                .IpAddresses.class, new IpAddressesKey(ipAddr)));
                            } catch (TransactionCommitFailedException e) {
                                LOG.error("Failed to delete IpAddress {} from VpnToDpnList for Dpn {} for Vpn {}: {}",
                        ...
                        try {
                            SingleTransactionDataBroker.syncDelete(dataBroker, LogicalDatastoreType.OPERATIONAL,
                                    id.child(org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.l3vpn.rev130911.vpn
