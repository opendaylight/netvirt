                ...
                * */
                ...
                if (optVpnName.isPresent()) {
                    ...
                    if (opVpnInterface.isPresent()) {
                        long associatedVpnId = FibUtil.getVpnId(dataBroker, vpnName);
                        if (vpnId != associatedVpnId) {
                            LOG.warn("Prefixes {} are associated with different vpn instance"
                                         + " with id : {} rather than {}",
                ...
                if (numAdj > 1) {
                    ...
                    LOG.info("Clean up vpn interface {} from dpn {} to vpn {} list.", ifName, prefixInfo.getDpnId(),
                            rd);
                    tx.delete(LogicalDatastoreType.OPERATIONAL, FibUtil
                                     .getVpnInterfaceOpDataEntryIdentifier(ifName, vpnName));
                }
            }));
        }
    }
