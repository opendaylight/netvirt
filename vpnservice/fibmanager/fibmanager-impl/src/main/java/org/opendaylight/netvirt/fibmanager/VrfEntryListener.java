...
public class VrfEntryListener extends AsyncDataTreeChangeListenerBase<VrfEntry, VrfEntryListener>
    ...
    private void programRemoteFibEntries(final BigInteger remoteDpnId, final long vpnId, final VrfEntry vrfEntry,
    ...
    private void createRemoteFibEntry(final BigInteger remoteDpnId, final long vpnId, final VrfTablesKey vrfTableKey,
        ...
        programRemoteFibEntries(remoteDpnId, vpnId, vrfEntry, rd, adjacencyResults, vpnName, tx);
        if (!wrTxPresent) {
            tx.submit();
        }
    ...
    private void createRemoteFibEntryOnTunnelEvent(final BigInteger remoteDpnId, final long vpnId,
        ...
        AdjacencyResult adjacencyResult = nextHopManager.getTunnelTypeForEgressName(remoteDpnId, vpnId,
        ...
        programRemoteFibEntries(remoteDpnId, vpnId, vrfEntry, rd, (List<AdjacencyResult>) adjacencyResult, vpnName, tx);
        if (!wrTxPresent) {
            tx.submit();
        }
