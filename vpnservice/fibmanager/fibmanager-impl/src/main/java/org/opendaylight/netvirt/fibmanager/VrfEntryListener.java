...
public class VrfEntryListener extends AsyncDataTreeChangeListenerBase<VrfEntry, VrfEntryListener> implements AutoCloseable, ResourceHandler {
    ...
    protected void update(InstanceIdentifier<VrfEntry> identifier, VrfEntry original, VrfEntry update) {
        ...
        if ((RouteOrigin.value(update.getOrigin()) == RouteOrigin.STATIC) ||
                (RouteOrigin.value(update.getOrigin()) == RouteOrigin.CONNECTED) ||
                (RouteOrigin.value(update.getOrigin()) == RouteOrigin.LOCAL)) {
            ...
            if (subnetRoute == null) {
                ...
                if (((updateNhList == null) || (updateNhList.isEmpty()) &&
                    ...
                    final List<BigInteger> localDpnIdList = getDpnIdForPrefix(vpnId, rd, update);
