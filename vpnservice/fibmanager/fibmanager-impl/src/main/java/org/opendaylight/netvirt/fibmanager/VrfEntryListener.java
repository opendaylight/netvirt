...
public class VrfEntryListener extends AsyncDataTreeChangeListenerBase<VrfEntry, VrfEntryListener> implements AutoCloseable, ResourceHandler {
    ...
    public List<BigInteger> deleteLocalFibEntry(Long vpnId, String rd, VrfEntry vrfEntry) {
        ...
        if (localNextHopInfo == null) {
            //Is this fib route an extra route? If yes, get the nexthop which would be an adjacency in the vpn
            Routes extra_route = getVpnToExtraroute(dataBroker, rd, vrfEntry.getDestPrefix());
            if (extra_route != null) {
    ...
    public static  Routes getVpnToExtraroute(DataBroker broker, String vpnRd, String destPrefix) {
        ...
        Optional<Routes> vpnOpc = FibUtil.read(broker, LogicalDatastoreType.OPERATIONAL, vpnExtraRoutesId);
        return vpnOpc.isPresent() ? vpnOpc.get() : null;
    }
        ...
        public List<ListenableFuture<Void>> call() throws Exception {
            ...
            if (extraRoute != null) {
                ...
                FibUtil.delete(dataBroker, LogicalDatastoreType.OPERATIONAL,
                        getVpnToExtrarouteIdentifier(vpnName, rd, vrfEntry.getDestPrefix()));
            }
