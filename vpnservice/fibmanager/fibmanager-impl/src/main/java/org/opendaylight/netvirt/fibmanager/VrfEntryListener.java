...
public class VrfEntryListener extends AsyncDataTreeChangeListenerBase<VrfEntry, VrfEntryListener> implements AutoCloseable, ResourceHandler {
    ...
    protected void update(InstanceIdentifier<VrfEntry> identifier, VrfEntry original, VrfEntry update) {
        ...
        // Handle Internal Routes next (ie., STATIC only)
          if (isControllerManagedNonInterVpnLinkRoute(RouteOrigin.value(update.getOrigin()))) {
    ...
    private boolean isControllerManagedRoute(RouteOrigin routeOrigin) {
    ...
    private boolean isControllerManagedNonInterVpnLinkRoute(RouteOrigin routeOrigin)
    {
        if (routeOrigin == RouteOrigin.STATIC ||
                routeOrigin == RouteOrigin.CONNECTED ||
                routeOrigin == RouteOrigin.LOCAL) {
