...
public class VrfEntryListener extends AsyncDataTreeChangeListenerBase<VrfEntry, VrfEntryListener>
                            ...
                            if (localNextHopInfo != null) {
                                ...
                                if (vpnExtraRoutes == null || vpnExtraRoutes.isEmpty()) {
                                    ...
                                    for (Routes extraRoutes : vpnExtraRoutes) {
                                        BigInteger dpnId = checkCreateLocalFibEntry(localNextHopInfo, localNextHopIP,
                                                vpnId, rd, vrfEntry, lri.getParentVpnid(), extraRoutes, vpnExtraRoutes);
                                        returnLocalDpnId.add(dpnId);
                                    }
                                }
                            }
    ...
    private BigInteger checkCreateLocalFibEntry(Prefixes localNextHopInfo, String localNextHopIP,
        ...
        if (localNextHopInfo != null) {
            ...
            if (routes != null) {
                ...
                localGroupId = nextHopManager.getLocalNextHopGroup(parentVpnId,
                        localNextHopInfo.getVpnInterfaceName(), routes.getNexthopIpList().get(0) + "/32",
        ...
        LOG.debug("localNextHopInfo received is null for prefix {} on rd {} on vpn {}",
                vrfEntry.getDestPrefix(), rd, FibUtil.getVpnNameFromRd(dataBroker, rd));
        return BigInteger.ZERO;
    }
            ...
            () -> {
                ...
                synchronized (vpnInstance.getVpnInstanceName().intern()) {
                    ...
                    if (action == true) {
                        ...
                        List<String> usedRds = VpnHelper.getUsedRds(dataBroker, vpnInstance.getVpnId(),
                                vrfEntry.getDestPrefix());
                        if (usedRds.size() > 1) {
