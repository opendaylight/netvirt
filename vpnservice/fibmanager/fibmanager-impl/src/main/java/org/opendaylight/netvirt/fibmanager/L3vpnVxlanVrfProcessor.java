...
public class L3vpnVxlanVrfProcessor {
    private final Logger LOG = LoggerFactory.getLogger(L3vpnVxlanVrfProcessor.class);
    ...
    L3vpnVxlanVrfProcessor(InstanceIdentifier<VrfEntry> identifier, VrfEntry vrfEntry, DataBroker broker, VrfEntryListener vrfEntryListener) {
    ...
    L3vpnVxlanVrfProcessor(InstanceIdentifier<VrfEntry> identifier, VrfEntry original, VrfEntry update, DataBroker broker, VrfEntryListener vrfEntryListener) {
