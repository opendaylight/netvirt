...
public interface IFibManager {
    ...
    void updateFibEntry(DataBroker broker, String rd, String prefix , List<String> nextHopList, String gwMacAddress,
    ...
    boolean isControllerManagedVpnInterfaceRoute(RouteOrigin routeOrigin);
