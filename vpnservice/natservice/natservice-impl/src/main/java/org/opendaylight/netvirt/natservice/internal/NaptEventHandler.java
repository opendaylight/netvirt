    ...
    */
    ...
    public static void buildAndInstallNatFlows(BigInteger dpnId, short tableId, long vpnId, long routerId,
        ...
        FlowEntity snatFlowEntity = new FlowEntityBuilder()
            .dpnId(dpnId)
            .tableId(tableId)
            .flowId(switchFlowRef)
            .priority(NatConstants.DEFAULT_NAPT_FLOW_PRIORITY)
            .flowName(NatConstants.NAPT_FLOW_NAME)
            .idleTimeOut(idleTimeout)
            .hardTimeOut(0)
            .cookie(NatUtil.getCookieNaptFlow(routerId))
            .addAllMatchInfoList(buildAndGetMatchInfo(actualIp, actualPort, tableId, protocol, intranetVpnId))
            .addAllInstructionInfoList(buildAndGetSetActionInstructionInfo(translatedIp, translatedPort,
