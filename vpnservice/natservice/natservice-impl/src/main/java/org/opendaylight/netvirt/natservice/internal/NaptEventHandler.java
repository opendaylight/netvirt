    ...
    */
                ...
                if (!naptEntryEvent.isPktProcessed()) {
                    ...
                    Futures.addCallback(JdkFutureAdapters.listenInPoolThread(addFlowResult),
                            new FutureCallback<RpcResult<AddFlowOutput>>() {
                                    ...
                                    Futures.addCallback(JdkFutureAdapters.listenInPoolThread(addFlowResult),
                                            new FutureCallback<RpcResult<AddFlowOutput>>() {
                                                ...
                                                public void onFailure(Throwable t) {
                                                    LOG.error("Error configuring inbound SNAT flows using RPC for "
                                ...
                                @Override
                                public void onFailure(Throwable t) {
                                    LOG.error("Error configuring outbound SNAT flows using RPC for SNAT connection"
    ...
    public static FlowRef getFlowRef(BigInteger dpId, Flow flow) {
        ...
        InstanceIdentifier<Flow> flowInstanceId =
                ...
                .child(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.tables.table.Flow.class, flowKey)
                .build();
