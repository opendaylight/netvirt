...
public class NaptSwitchHA {
    ...
    private final EvpnFlowProgrammerHA evpnFlowProgrammerHA;
    ...
    public NaptSwitchHA(final DataBroker dataBroker, final IMdsalApiManager mdsalManager,
                        ...
                        final EvpnFlowProgrammerHA evpnFlowProgrammerHA) {
        ...
        this.evpnFlowProgrammerHA = evpnFlowProgrammerHA;
    }
    ...
    protected void removeSnatFlowsInOldNaptSwitch(String routerName, BigInteger naptSwitch,
        ...
        if (extNwProvType == ProviderTypes.VXLAN) {
            evpnFlowProgrammerHA.evpnRemoveSnatFlowsInOldNaptSwitch(routerName, routerId, vpnName, naptSwitch);
        } else {
