...
public class NatEvpnUtil {
    ...
    public static void addRoutesForVxLanProvType(DataBroker broker,
        ...
        try {
            ...
            addPrefixToInterface(broker, NatUtil.getVpnId(broker, vpnName), interfaceName, prefix, dpId,
                    /*isNatPrefix*/ true);
    ...
    static void makeL3GwMacTableEntry(final BigInteger dpnId, final long vpnId, String macAddress,
        ...
        LOG.trace("NAT Service : Create flow in table {} on DpnId = {} for External Vpn Id = {} and MacAddress = {}",
                NwConstants.L3_GW_MAC_TABLE, dpnId, vpnId, macAddress);
        ...
        LOG.trace("NAT Service : Successfully created flow entity {} on DPN = {}", l3GwMacTableFlowEntity, dpnId);
    }
    ...
    static void removeL3GwMacTableEntry(final BigInteger dpnId, final long vpnId, final String macAddress,
        ...
        LOG.trace("NAT Service : Remove flow in table {} on DpnId = {} for External Vpn Id = {} and MacAddress = {}",
                NwConstants.L3_GW_MAC_TABLE, dpnId, vpnId, macAddress);
