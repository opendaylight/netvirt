...
public class NatInterfaceStateChangeListener
    ...
    protected void add(InstanceIdentifier<Interface> identifier, Interface intrf) {
        ...
        coordinator.enqueueJob(NAT_DS_DJC + intrf.getName(), natIfaceStateAddWorker);
    }
    ...
    protected void remove(InstanceIdentifier<Interface> identifier, Interface intrf) {
        ...
        coordinator.enqueueJob(NAT_DS_DJC + intrf.getName(), natIfaceStateRemoveWorker);
    }
    ...
    protected void update(InstanceIdentifier<Interface> identifier, Interface original, Interface update) {
        ...
        coordinator.enqueueJob(NAT_DS_DJC + update.getName(), natIfaceStateupdateWorker);
    }
    ...
    private class NatInterfaceStateUpdateWorker implements Callable<List<ListenableFuture<Void>>> {
        ...
        public List<ListenableFuture<Void>> call() {
            ...
            try {
                ...
                LOG.error(
                        "NAT Service : UPDATE : Exception observed in handling updation of VPN Interface {}. "
