        ...
        public List<ListenableFuture<Void>> call() {
            ...
            try {
                ...
                org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.interfaces.rev140508.interfaces.Interface
                    configInterface = interfaceManager.getInterfaceInfoFromConfigDataStore(interfaceName);
                if (configInterface != null) {
                    if (!configInterface.getType().equals(Tunnel.class)) {
                        ...
                        RouterInterface routerInterface = NatUtil.getConfiguredRouterInterface(dataBroker,
                                interfaceName);
