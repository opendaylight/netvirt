...
public class InterfaceStateEventListener extends AbstractDataChangeListener<Interface> implements AutoCloseable {
    ...
    protected void add(InstanceIdentifier<Interface> identifier, Interface intrf) {
        ...
        try {
            ...
            Class<? extends InterfaceType> intrfType = intrf.getType();
            // if interface is tunnel
            if (intrfType != null && intrfType.equals(Tunnel.class)) {
    ...
    private void updateNaptTunnelsGroups(Interface intrf) {
        ...
        LOG.debug("updateNaptTunnelsGroups for dpnId {}", tunnelDpn);
        ...
        for (RouterDpnList routerDpnList : allRouterDpnList) {
             ...
             if (dpnRouterId != NatConstants.INVALID_ID) {
                 ...
                 // if the interface is of a neighbor dpn (not on the NAPT switch)
