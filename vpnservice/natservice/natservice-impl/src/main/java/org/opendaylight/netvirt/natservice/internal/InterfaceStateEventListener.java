...
public class InterfaceStateEventListener
    ...
    protected void remove(InstanceIdentifier<Interface> identifier, Interface delintrf) {
        ...
        coordinator.enqueueJob(NAT_FLOW_DJC + delintrf.getName(), natFlowRemoveWorker);
    }
    ...
    protected void update(InstanceIdentifier<Interface> identifier, Interface original, Interface update) {
        ...
        coordinator.enqueueJob(NAT_FLOW_DJC + update.getName(), natFlowUpdateWorker);
    ...
    protected void add(InstanceIdentifier<Interface> identifier, Interface intrf) {
        ...
        coordinator.enqueueJob(NAT_FLOW_DJC + intrf.getName(), natFlowAddWorker);
    }
