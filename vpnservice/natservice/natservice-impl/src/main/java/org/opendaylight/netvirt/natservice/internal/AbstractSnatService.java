...
public abstract class AbstractSnatService implements SnatServiceListener {
    ...
    private long createGroupId(String groupIdKey) {
        ...
        try {
            ...
            LOG.trace("createGroupId: Exception while creating group with key : {}",groupIdKey, e);
        }
        return 0;
    }
    ...
    private String getTunnelInterfaceName(BigInteger srcDpId, BigInteger dstDpId) {
        ...
        try {
            ...
            LOG.warn("getTunnelInterfaceName : Exception when getting tunnel interface Id for tunnel between {} and  {}",
                    srcDpId, dstDpId);
        }
        return null;
    }
