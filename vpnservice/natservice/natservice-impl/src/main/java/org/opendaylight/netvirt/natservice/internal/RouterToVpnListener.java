    ...
    void handleDNATConfigurationForRouterAssociation(String routerName, String vpnName, String externalNetwork) {
        ...
        for(Ports port : interfaces) {
            ...
            for(InternalToExternalPortMap intExtPortMap : intExtPortMapList) {
                ...
                floatingIpListener.createNATOnlyFlowEntries(dpnId, portName, routerName, vpnName, networkId, intExtPortMap.getInternalIp(), externalIp, intExtPortMap.getExternalMacAddress());
            }
        }
    }
    ...
    void handleDNATConfigurationForRouterDisassociation(String routerName, String vpnName, String externalNetwork) {
        ...
        for(Ports port : interfaces) {
            ...
            for(InternalToExternalPortMap intExtPortMap : intExtPortMapList) {
                ...
                //Create NAT entries with VPN Id
                floatingIpListener.createNATOnlyFlowEntries(dpnId, portName, routerName, null, networkId, intExtPortMap.getInternalIp(), externalIp, intExtPortMap.getExternalMacAddress());
            }
        }
    }
