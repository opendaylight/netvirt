...
public class EvpnFlowProgrammerHA {

    private static final Logger LOG = LoggerFactory.getLogger(EvpnFlowProgrammerHA.class);
    private final DataBroker dataBroker;
    private final IMdsalApiManager mdsalManager;
    private final IdManagerService idManager;
    private final EvpnSnatFlowProgrammer evpnSnatFlowProgrammer;

    public EvpnFlowProgrammerHA(final DataBroker dataBroker, final IMdsalApiManager mdsalManager,
