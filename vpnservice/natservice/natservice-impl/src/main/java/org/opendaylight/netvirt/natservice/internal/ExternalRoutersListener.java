...
public class ExternalRoutersListener extends AsyncDataTreeChangeListenerBase<Routers, ExternalRoutersListener> {
        ...
        for (Uuid subnet : subnetList) {
            ...
            if (sn.isPresent()) {
                ...
                try {
                    ...
                    LOG.warn("Invalid ip address {} with exception {}", subnetIp, e);
                    return;
                }
    ...
    public void close() {
        if (listenerRegistration != null) {
            try {
                ...
                LOG.error("Cleaning up ExternalRoutersListener failed with exception {}", e);
            }
    ...
    protected String getTunnelInterfaceName(BigInteger srcDpId, BigInteger dstDpId) {
        ...
        try {
            ...
            LOG.warn("NAT Service : Getting tunnel interface Id for tunnel between {} and  {} failed with exception {}",
                srcDpId, dstDpId, e);
        }
    ...
    protected void createGroupIdPool() {
        ...
        try {
            ...
            LOG.error("Create PortPool for NAPT Service failed with exception {}", e);
        }
    }
...
*/
    ...
    public void advToBgpAndInstallFibAndTsFlows(final BigInteger dpnId, final short tableId, final String vpnName,
        ...
        Futures.addCallback(future, new FutureCallback<RpcResult<Void>>() {
            ...
            public void onFailure(Throwable error) {
                log.error("NAT Service : Generate label or fib install process failed with error {}", error);
            }
    ...
    protected void delFibTsAndReverseTraffic(final BigInteger dpnId, long routerId, String extIp,
        ...
        Futures.addCallback(labelFuture, new FutureCallback<RpcResult<Void>>() {
            ...
            @Override
            public void onFailure(Throwable error) {
                LOG.error("NAT Service : Removing the label or custom fib entries failed with error {}", error);
            }
