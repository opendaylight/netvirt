...
*/
    ...
    public void advToBgpAndInstallFibAndTsFlows(final BigInteger dpnId, final short tableId, final String vpnName,
        ...
        if (extNwProviderType.getName().equals("VXLAN")) {
            ...
            //Inform to BGP
            NatUtil.addPrefixToBGP(dataBroker, bgpManager, fibManager, vpnName, rd, macAddress, externalIp,
                            ...
                            if (result.isSuccessful()) {
                               ...
                               //Get IPMaps from the DB for the router ID
                                ...
                                NatUtil.addPrefixToBGP(dataBroker, bgpManager, fibManager, vpnName, rd, macAddress,
                                        externalIp, nextHopIp, extNwProviderTypeEncap, label, 0, log, gwMacAddress,
