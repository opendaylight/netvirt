    ...
    public void updateNaptFlowsWithVpnId(BigInteger dpnId, long routerId, long bgpVpnId){
        ...
        for(IntextIpProtocolType intextIpProtocolType : intextIpProtocolTypes){
            ...
            for(IpPortMap ipPortMap : ipPortMaps){
                ...
                String internalMacAddress = ipPortMap.getInternalMac();
                LOG.debug("NAT Service : Found Internal MAC address {} for Internal IP {} and Internal Port {}",
                      internalMacAddress, internalIp, internalPort);
                ...
                NaptEventHandler.buildAndInstallNatFlows(dpnId, NwConstants.OUTBOUND_NAPT_TABLE, internetVpnid,
                   routerId, bgpVpnId, internalAddress, externalAddress, protocol, internalMacAddress, extGwMacAddress);
                NaptEventHandler.buildAndInstallNatFlows(dpnId, NwConstants.INBOUND_NAPT_TABLE, internetVpnid, routerId,
                    bgpVpnId, externalAddress, internalAddress, protocol, internalMacAddress, extGwMacAddress);
