...
public class ConntrackBasedSnatService extends AbstractSnatService {
    ...
    protected void createOutboundTblTrackEntry(BigInteger dpnId, Long routerId,
        ...
        ActionSetFieldMeta actionSetFieldMeta = new ActionSetFieldMeta(MetaDataUtil
                .getVpnIdMetadata(NatUtil.getVpnIdFromExternalSubnet(dataBroker, routerId, externalIp)));
    ...
    protected void installInboundEntry(BigInteger dpnId, long routerId, Long extNetId, List<ExternalIps> externalIps,
        ...
        matches.add(new MatchMetadata(MetaDataUtil.getVpnIdMetadata(NatUtil
                .getVpnIdFromExternalSubnet(dataBroker, routerId, externalIp)),
