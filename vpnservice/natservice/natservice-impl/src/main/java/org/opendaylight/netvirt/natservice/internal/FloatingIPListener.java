...
//                BigInteger.valueOf(vpnId), MetaDataUtil.METADATA_MASK_VRFID }));
    ...
    private FlowEntity buildDNATFlowEntity(BigInteger dpId, String internalIp, String externalIp, long routerId, long associatedVpn, String srcMac) {
...
//                (routerId), MetaDataUtil.METADATA_MASK_VRFID }));
    ...
    private void createDNATTblEntry(BigInteger dpnId, String internalIp, String externalIp, long routerId, long vpnId, long associatedVpnId, String srcMac) {
    ...
    void createNATFlowEntries(String interfaceName, final IpMapping mapping,
        ...
        String macOfRouterInterface = NatUtil.getMacOfRouterByDeviceOwner(dataBroker, routerName, NeutronConstants.DEVICE_OWNER_ROUTER_INF);
        createDNATTblEntry(dpnId, mapping.getInternalIp(), mapping.getExternalIp(), routerId, vpnId, associatedVpnId, macOfRouterInterface);
    ...
    void createNATOnlyFlowEntries(BigInteger dpnId,  String interfaceName, String routerName, String associatedVPN, Uuid externalNetworkId, String internalIp, String externalIp) {
        ...
        String macOfRouterInterface = NatUtil.getMacOfRouterByDeviceOwner(dataBroker, routerName, NeutronConstants.DEVICE_OWNER_ROUTER_INF);
        FlowEntity flowEntity = buildDNATFlowEntity(dpnId, internalIp, externalIp, routerId, associatedVpnId, macOfRouterInterface);
        mdsalManager.installFlow(flowEntity);
