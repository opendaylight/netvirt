...
//                (routerId), MetaDataUtil.METADATA_MASK_VRFID }));
    ...
    void createNATFlowEntries(String interfaceName, final InternalToExternalPortMap mapping,
        ...
        floatingIPHandler.onAddFloatingIp(dpnId, routerName, extNwId, interfaceName, mapping.getExternalIp(), mapping
                .getInternalIp(), mapping.getExternalMacAddress());
    }

    void createNATFlowEntries(BigInteger dpnId,  String interfaceName, String routerName, Uuid externalNetworkId, String internalIp, String externalIp, String externalMacAddress) {
        long routerId = NatUtil.getVpnId(dataBroker, routerName);
        if(routerId == NatConstants.INVALID_ID) {
            LOG.warn("NAT Service : Could not retrieve router id for {} to create NAT Flow entries", routerName);
            return;
        ...
        floatingIPHandler.onAddFloatingIp(dpnId, routerName, externalNetworkId, interfaceName, externalIp, internalIp, externalMacAddress);
    }

    void createNATOnlyFlowEntries(BigInteger dpnId, String interfaceName, String routerName, String associatedVPN, Uuid externalNetworkId, String internalIp, String externalIp, String externalMacAddress) {
...
//        }
    ...
    void removeNATFlowEntries(BigInteger dpnId, String interfaceName, String vpnName, String routerName, Uuid externalNetworkId, String ip, String internalIp, String externalIp) {
        long routerId = NatUtil.getVpnId(dataBroker, routerName);
        if(routerId == NatConstants.INVALID_ID) {
            LOG.warn("NAT Service : Could not retrieve router id for {} to remove NAT Flow entries", routerName);
            return;
