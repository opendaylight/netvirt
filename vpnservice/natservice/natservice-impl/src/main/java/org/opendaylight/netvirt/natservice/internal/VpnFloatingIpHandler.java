...
import static org.opendaylight.netvirt.natservice.internal.NatUtil.getMatchCriteriaForArpResponderFloatingIp;
...
public class VpnFloatingIpHandler implements FloatingIPHandler {
    ...
    private void setupArpResponderForFloatingIpPort(BigInteger dpnId, String vpnName, String ifName, String floatingIpMac,
        ...
        Flow arpResponderFloatingIPTableFlowEntity = MDSALUtil.buildFlowNew(NwConstants.ARP_RESPONDER_TABLE,
                ...
                0, 0, cookie, NatUtil.getMatchCriteriaForArpResponderFloatingIp(vpnId, externalIp),
