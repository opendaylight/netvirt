    ...
    public void onAddFloatingIp(final BigInteger dpnId, final String routerId,
        ...
        if (extNwProviderType.getName().equals("VXLAN")) {
            ...
            NatUtil.addPrefixToBGP(dataBroker, bgpManager, fibManager, vpnName, rd, macAddress, externalIp + "/32",
                    nextHopIp, extNwProviderTypeEncap, NatConstants.DEFAULT_LABEL_VALUE, l3Vni, LOG,
            ...
            NatUtil.makeL3GwMacTableEntry(dpnId, vpnId, floatingIpPortMacAddress, customInstructions, mdsalManager);
            ...
            ListenableFuture<RpcResult<Void>> future = Futures.transform(JdkFutureAdapters
                    ...
                    if (result.isSuccessful()) {
                        ...
                        //Other than VXLAN Provider Type L3VNI is not Applicable. Hence Default value is -1
                        //Inform BGP
                        NatUtil.addPrefixToBGP(dataBroker, bgpManager, fibManager, vpnName, rd, macAddress,
                            externalIp + "/32", nextHopIp, extNwProviderTypeEncap, label,
                                NatConstants.DEFAULT_L3VNI_VALUE, LOG, floatingIpPortMacAddress, writeTx,
