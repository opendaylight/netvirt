...
public class VpnFloatingIpHandler implements FloatingIPHandler {
    ...
    public void onRemoveFloatingIp(final BigInteger dpnId, String routerId, Uuid networkId, InternalToExternalPortMap
        ...
        if (floatingIpPortMacAddress != null) {
            vpnManager.setupSubnetMacIntoVpnInstance(vpnName, floatingIpPortMacAddress, dpnId, writeTx, NwConstants
                    .DEL_FLOW);
            setupArpResponderForFloatingIpPort(dpnId, vpnName, null, floatingIpPortMacAddress,label, externalIp, NwConstants.DEL_FLOW);
        }
    ...
    private void setupArpResponderForFloatingIpPort(BigInteger dpnId, String vpnName, String ifName, String floatingIpMac,
...
/*            ArpResponderUtil.installFlow(mdsalManager, writeTx, dpnId, flowId, flowId,
                    NwConstants.DEFAULT_ARP_FLOW_PRIORITY, cookie,
                    ArpResponderUtil.getMatchCriteriaForArpFloatingIp(vpnId, externalIp),
                    ArpResponderUtil.getActions(interfaceManager, ifName, externalIp, floatingIpMac));
*/
