...
public class SubnetGwMacChangeListener
    ...
    private INeutronVpnManager nvpnManager;
    private ExternalNetworkGroupInstaller extNetworkInstaller;

    public SubnetGwMacChangeListener(DataBroker broker, INeutronVpnManager nvpnManager,
            ExternalNetworkGroupInstaller extNetworkInstaller) {
