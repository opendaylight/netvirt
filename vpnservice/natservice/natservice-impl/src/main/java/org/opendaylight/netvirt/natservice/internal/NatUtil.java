    ...
    */
    ...
    public static void addPrefixToBGP(DataBroker broker,
        ...
        try {
            ...
            NexthopAddresses nextHopAddress = new NexthopAddressesBuilder().setKey(new NexthopAddressesKey(nextHopIp)).setIpAddress(nextHopIp).build();
            fibManager.addOrUpdateFibEntry(broker, rd, prefix, Arrays.asList(nextHopAddress), (int)label, origin, null);
            bgpManager.advertisePrefix(rd, prefix, Arrays.asList(nextHopAddress), (int)label);
