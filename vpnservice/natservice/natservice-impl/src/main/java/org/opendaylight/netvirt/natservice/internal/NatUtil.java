...
public class NatUtil {
    ...
    */
    ...
    public static Boolean checkIfFloatingIpIsPresentForDpn(DataBroker dataBroker, BigInteger dpnId, String rd,
        ...
        if (!dpnInVpn.isPresent()) {
            LOG.debug("vpn-to-dpn-list is empty for vpnName {}, dpn id {} and rd {} for removing floatingIp {}. "
                            + "Remove the flow INTERNAL_TUNNEL_TABLE (table=36)-> PDNAT_TABLE (table=25)", vpnName,
                    dpnId, rd, externalIp);
            return Boolean.FALSE;
        } else {
            LOG.debug("vpn-to-dpn-list is not empty for vpnName {}, dpn id {} and rd {} for removing floatingIp {}",
                    dpnId, rd, externalIp);
