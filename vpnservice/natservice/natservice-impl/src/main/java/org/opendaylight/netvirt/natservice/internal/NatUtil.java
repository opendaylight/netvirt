...
public class NatUtil {
    ...
    */
    ...
    static long createLPortTagForRouter(String routerIdKey, IdManagerService idManager) {
        LOG.debug("NAT Service : Create Router_lPort_Tag from ID Manager for Non-NAPT Switch to NAPT Switch to use "
                + "Tunnel ID");
        AllocateIdInput getIdInput = new AllocateIdInputBuilder()
        ...
        try {
            ...
            LOG.trace("NAT Service : idManager Failed with exception {} while creating Router_lPort_Tag "
