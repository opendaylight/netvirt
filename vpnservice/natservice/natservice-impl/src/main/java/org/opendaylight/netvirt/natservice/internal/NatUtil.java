...
public class NatUtil {
    ...
    */
    ...
    public static String getMacOfPortByDeviceInfo(DataBroker broker, String deviceId, String deviceOwner) {
        for (Port port : getNeutronPorts(broker)) {
            if (deviceId.equals(port.getDeviceId()) && deviceOwner.equals(port.getDeviceOwner())) {
