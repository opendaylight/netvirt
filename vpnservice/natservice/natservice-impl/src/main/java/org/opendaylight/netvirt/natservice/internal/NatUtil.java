...
public class NatUtil {
    ...
    */
    ...
    public static void addPrefixToBGP(DataBroker broker,
        ...
        try {
            ...
            addPrefixToInterface(broker, getVpnId(broker, vpnName), null /*interfaceName*/,prefix, dpId,
                    /*isNatPrefix*/ true, null /*providerType*/);
    ...
    static void addPrefixToInterface(DataBroker broker, long vpnId, String interfaceName, String ipPrefix,
                                     BigInteger dpId, boolean isNatPrefix, ProviderTypes provType) {
        ...
        if (provType == ProviderTypes.VXLAN) {
            prefix = new PrefixesBuilder().setDpnId(dpId).setIpAddress(ipPrefix).setVpnInterfaceName(interfaceName)
                    .setNatPrefix(isNatPrefix).build();
        } else {
            prefix = new PrefixesBuilder().setDpnId(dpId).setIpAddress(ipPrefix).setNatPrefix(isNatPrefix)
                    .build();
        }
        try {
