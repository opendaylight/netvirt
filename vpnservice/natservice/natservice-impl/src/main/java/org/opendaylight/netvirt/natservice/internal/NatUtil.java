...
public class NatUtil {
    ...
    */
    ...
    public static void createOpenDayLightVniRangesPool(NeutronvpnService neutronVpnService, IdManagerService idManager,
        ...
        try {
            ...
            if (result != null && result.get().isSuccessful()) {
                LOG.debug("NAT Service : Created OpenDaylight VXLAN VNI range pool {} with range {}-{}",
