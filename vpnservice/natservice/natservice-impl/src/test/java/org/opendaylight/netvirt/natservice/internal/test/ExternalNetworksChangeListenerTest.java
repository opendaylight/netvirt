...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.config.rev170410.netvirt.config.NatserviceConfig;
import org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.config.rev170410.netvirt.config.NatserviceConfigBuilder;
...
public class ExternalNetworksChangeListenerTest {
    ...
    public void setUp() throws Exception {
        ...
        NatserviceConfig natserviceConfig = new NatserviceConfigBuilder().setNatMode(NatMode.Controller).build();
        NetvirtConfig netvirtConfig = new NetvirtConfigBuilder().setNatserviceConfig(natserviceConfig).build();
