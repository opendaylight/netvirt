...
public class DhcpPktHandler implements PacketProcessingListener {
    ...
    private DhcpInfo getDhcpInfo(Port port, Subnet subnet) {
        ...
        if (port != null && subnet != null) {
            ...
            /* If an ODL network DHCP Port data was made available use the ports Fixed IP
             * as server IP for DHCP communication.
             */
            ...
            //When no DHCP port allocated continue legacy handling of DHCP service with Subnet Gateway IP
