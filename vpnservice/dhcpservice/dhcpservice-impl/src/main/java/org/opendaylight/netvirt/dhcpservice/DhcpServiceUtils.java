...
public class DhcpServiceUtils {
    ...
    private static ConcurrentHashMap<String, Port> portMap = new ConcurrentHashMap<String, Port>();
    ...
    public static void setupDhcpArpRequest(BigInteger dpId, short tableId, BigInteger vni, String dhcpIpAddress,
                                           int lportTag, Long elanTag, int addOrRemove, IMdsalApiManager mdsalUtil) {
    ...
    public static void addToPortCache(String interfaceName,Port port) {
        portMap.put(interfaceName, port);
    }

    public static Port getPortFromPortCache(String interfaceName) {
        return portMap.get(interfaceName);
    }

    public static void removeFromPortCache(String interfaceName) {
