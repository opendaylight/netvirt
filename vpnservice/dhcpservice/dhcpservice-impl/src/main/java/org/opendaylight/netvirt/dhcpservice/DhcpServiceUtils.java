...
public class DhcpServiceUtils {
    ...
    public static boolean isDpnAlreadyPresentInElanInstance(DataBroker broker, BigInteger dpId,
    ...
    public static Optional<String> getAvailableDpnInterface(DataBroker broker, BigInteger dpId,
                                                            String elanInstanceName) {
