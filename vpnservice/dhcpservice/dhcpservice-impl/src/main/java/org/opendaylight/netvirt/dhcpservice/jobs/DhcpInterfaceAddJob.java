        ...
        if (!dpnId.equals(DhcpMConstants.INVALID_DPID)) {
            ...
            if (null != subnet && subnet.isEnableDhcp()) {
                ...
                if (subnetToDhcp.isPresent()) {
                    ...
                    elanService.addArpResponderFlow(dpnId, interfaceName, subnetToDhcp.get().getPortFixedip(),
                            subnetToDhcp.get().getPortMacaddress(), intf.getIfIndex(), Collections.EMPTY_LIST);
                }
            }
        }
        return futures;
