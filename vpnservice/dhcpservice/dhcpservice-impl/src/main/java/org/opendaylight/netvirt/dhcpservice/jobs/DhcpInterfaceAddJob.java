            ...
            if (null != subnet && subnet.isEnableDhcp()) {
                ...
                DhcpServiceUtils.getNetworkDhcpPortData(dataBroker, networkId).ifPresent(networkToDhcp -> {
                    LOG.trace("Installing the Arp responder for interface {} with DHCP MAC {} & IP {}.",
                            interfaceName, networkToDhcp.getMacAddress(), networkToDhcp.getPortFixedip());
                    elanService.addArpResponderFlow(dpnId, interfaceName, networkToDhcp.getPortFixedip(),
                            networkToDhcp.getMacAddress(), java.util.Optional.of(intf.getIfIndex()), Collections.EMPTY_LIST);
                });
