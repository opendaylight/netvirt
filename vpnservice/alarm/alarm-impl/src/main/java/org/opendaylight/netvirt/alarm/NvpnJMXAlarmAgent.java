...
public class NvpnJMXAlarmAgent {
    ...
    public void registerMbean() {
        ...
        try {
            mbs.addNotificationListener(/*alarmName*/alarmName, alarmBean, null, null);
        } catch (InstanceNotFoundException e2) {
            Log.info("Registeration of listener failed for Mbean " + alarmName + " err=> " + e2);
        }
    }
    ...
    public void unregisterMbean() {
        try {
            ...
            Log.info("unregisteration of listener failed for Mbean " + alarmName + " err=> " + e1);
        }
        try {
            if (mbs.isRegistered(alarmName)) {
            ...
            Log.info("UnRegisteration failed for Mbean {} :{}", alarmName, e2);
        }
    }
