...
public class EvpnUtils {
    ...
    public boolean isEvpnPresent(String originalEvpnName, String updateEvpnName) {
    ...
    public boolean isL3vpnPresent(String originalL3vpnName, String updateL3vpnName) {
