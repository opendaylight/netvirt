...
public class EtreeGet extends OsgiCommandSupport {
        ...
        try {
            ...
            if(etreeName != null) {
                ...
                if (elanInstance == null || elanInstance.getAugmentation(EtreeInstance.class) == null) {
                    ...
                    System.out.println(String.format(ElanCLIUtils.ETREE_CLI_FORMAT, elanInstance.getElanInstanceName(), elanInstance.getMacTimeout(), elanInstance.getElanTag(), elanInstance.getDescription()));
                }
                ...
                if(elanInstanceList != null && !elanInstanceList.isEmpty()) {
                    ...
                    for(ElanInstance elanInstance : elanInstanceList) {
                        if (elanInstance.getAugmentation(EtreeInstance.class) != null) {
                            System.out.println(String.format(ElanCLIUtils.ETREE_CLI_FORMAT, elanInstance.getElanInstanceName(), elanInstance.getMacTimeout(), elanInstance.getElanTag(), elanInstance.getAugmentation(EtreeInstance.class).getEtreeLeafTagVal().getValue(), elanInstance.getDescription()));
                        }
                    }
                } else {
    ...
    private Object getEtreeHeaderOutput() {
        ...
        headerBuilder.append(String.format(ElanCLIUtils.ETREE_CLI_FORMAT, "Etree Instance", "Mac-TimeOut", "Etree Tag", "Etree Leaves Tag"));
