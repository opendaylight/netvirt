...
public class ElanLearntVpnVipToPortListener extends
    ...
    private class StaticMacAddWorker implements Callable<List<ListenableFuture<Void>>> {
        ...
        public List<ListenableFuture<Void>> call() throws Exception {
            ...
            addMacEntryToDsAndSetupFlows(interfaceName, macAddress,
                    elanInterface.get().getElanInstanceName(), interfaceTx, flowTx, ElanConstants.STATIC_MAC_TIMEOUT);
        ...
        private void addMacEntryToDsAndSetupFlows(String interfaceName, String macAddress, String elanName,
                WriteTransaction interfaceTx, WriteTransaction flowTx, int macTimeOut) throws ElanException {
    ...
    private class StaticMacRemoveWorker implements Callable<List<ListenableFuture<Void>>> {
        ...
        public List<ListenableFuture<Void>> call() throws Exception {
            ...
            WriteTransaction interfaceTx = broker.newWriteOnlyTransaction();
            WriteTransaction flowTx = broker.newWriteOnlyTransaction();
            deleteMacEntryFromDsAndRemoveFlows(interfaceName, macAddress,
                    elanInterface.get().getElanInstanceName(), interfaceTx, flowTx);
            List<ListenableFuture<Void>> futures = new ArrayList<>();
            futures.add(interfaceTx.submit());
            futures.add(flowTx.submit());
            return futures;
        ...
        private void deleteMacEntryFromDsAndRemoveFlows(String interfaceName,
