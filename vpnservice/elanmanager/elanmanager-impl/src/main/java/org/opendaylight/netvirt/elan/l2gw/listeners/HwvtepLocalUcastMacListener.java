 ...
 *
 * When a Ucast MAC addr appears in the hwvtep's operational DS, that MAC must be populated in DMAC tables in all Elan
 * participating DPNs. ELAN is selected according to field 'tunnel_key' of the Logical Switch to which the new MAC
 * belongs.
 *
 */
