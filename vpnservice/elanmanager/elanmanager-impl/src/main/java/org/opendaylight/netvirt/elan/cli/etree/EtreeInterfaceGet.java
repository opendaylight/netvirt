...
public class EtreeInterfaceGet extends OsgiCommandSupport {
    ...
    private Object getEtreeInterfaceHeaderOutput() {
        ...
        headerBuilder.append(String.format(ElanCLIUtils.ETREE_INTERFACE_CLI_FORMAT, "EtreeInstance/Tag", "EtreeInterface/Tag", "OpState" , "AdminState", "Root/Leaf"));
        ...
        if(!interfaceList.isEmpty()) {
            for (String elanInterface : interfaceList) {
                ...
                if (interfaceInfo != null) {
                    System.out.println(String.format(ElanCLIUtils.ETREE_INTERFACE_CLI_FORMAT, elanInstance.getElanInstanceName()+"/"+elanInstance.getElanTag(), elanInterface+"/"+interfaceInfo.getInterfaceTag(), interfaceInfo.getOpState(), interfaceInfo.getAdminState(), etreeInterface.getEtreeInterfaceType().getName()));
                }
            }
        }
    }
