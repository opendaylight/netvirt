...
public class HAConfigNodeListener extends HwvtepNodeBaseListener {
    ...
    @Inject
    public HAConfigNodeListener(DataBroker db, HAEventHandler haEventHandler, NodeCopier nodeCopier,
                                IidTracker iidTracker) throws Exception {
        super(LogicalDatastoreType.CONFIGURATION, db, iidTracker);
    ...
    void onPsNodeUpdate(InstanceIdentifier<Node> key,
        ...
        for (InstanceIdentifier<Node> childPsId : childPsIds) {
            ...
            haEventHandler.copyHAPSUpdateToChild(haPSUpdated, haPSOriginal, childPsId, tx);
        }
    }
    ...
    void onGlobalNodeUpdate(InstanceIdentifier<Node> key,
        ...
        for (InstanceIdentifier<Node> childId : children) {
            ...
            haEventHandler.copyHAGlobalUpdateToChild(haUpdated, haOriginal, childId, tx);
        }
    }
