...
public class ElanBridgeManager {
    ...
    private static final String BRIDGE_SIDE_PATCH_PORT_PREFIX = "patch-br-ex-";
    private static final String PATCH_PORT_PREFIX = "patch-br-int-";
    ...
    private List<InstructionInfo> getNormalInstructionInfoList(Node physnetNode) {
        List<InstructionInfo> instructionInfos = new ArrayList<InstructionInfo>();
        List<ActionInfo> actionInfos = new ArrayList<ActionInfo>();
        actionInfos.add(new ActionInfo(ActionType.output,
                            new String[] {physnetNode.getNodeId().getValue() + ":" + "NORMAL"}));
        instructionInfos.add(new InstructionInfo(InstructionType.apply_actions, actionInfos));
    ...
    private String getBridgeSidePatchName(String physicalInterfaceName) {
        return BRIDGE_SIDE_PATCH_PORT_PREFIX + physicalInterfaceName;
    }
