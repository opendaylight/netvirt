...
public class ElanInterfaceManager extends AsyncDataTreeChangeListenerBase<ElanInterface, ElanInterfaceManager>
    ...
    public static Boolean isOpenStackVniSemanticsEnforced;
    ...
    public ElanInterfaceManager(final DataBroker dataBroker, final IdManagerService managerService,
        ...
        isOpenStackVniSemanticsEnforced = neutronVpnManager.isOpenStackVniSemanticsEnforced();
    }
    ...
    public void removeElanInterface(List<ListenableFuture<Void>> futures, ElanInstance elanInfo, String interfaceName,
        ...
        if (interfaceInfo != null) {
            ...
            if (dpnInterfaces == null || dpnInterfaces.getInterfaces() == null
                ...
                if (!isOpenStackVniSemanticsEnforced) {
    ...
    * */
                ...
                if (remoteMacEntries != null) {
                    for (MacEntry macEntry : remoteMacEntries) {
                        ...
                        elanUtils.setupRemoteDmacFlow(dstDpId, remoteInterface.getDpId(),
                                remoteInterface.getInterfaceTag(), elanInstance.getElanTag(),
    ...
    public List<Bucket> getRemoteBCGroupBuckets(ElanInstance elanInfo, DpnInterfaces dpnInterfaces, BigInteger dpnId,
        ...
        if (isVxlan(elanInfo)) {
            listBucketInfo.addAll(getRemoteBCGroupTunnelBuckets(elanDpns, dpnId, bucketId,
                    isOpenStackVniSemanticsEnforced ? elanInfo.getSegmentationId() : elanTag));
        }
    ...
    public void setupTerminateServiceTable(ElanInstance elanInfo, BigInteger dpId, long elanTag,
        ...
        if (!isOpenStackVniSemanticsEnforced) {
            ...
            mdsalManager.addFlowToTx(dpId, flow, writeFlowGroupTx);
        } else {
