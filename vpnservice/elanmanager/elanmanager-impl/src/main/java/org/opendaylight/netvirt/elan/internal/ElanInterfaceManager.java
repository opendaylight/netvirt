            ...
            for (String remoteIf : remoteElanInterfaces) {
                ...
                if (remoteMacEntries != null) {
                    for (MacEntry macEntry : remoteMacEntries) {
                        ...
                        LOG.info("Programming remote dmac {} on the newly added DPN {} for elan {}", macAddress, dstDpId,
        ...
        if (staticMacAddresses != null) {
            ...
            for (PhysAddress physAddress : staticMacAddresses) {
                ...
                if (isInterfaceOperational) {
                    ...
                    // DPNs
                    LOG.info("programming smac and dmacs on source and other DPNs for elan {} and interface {}",
        ...
        if (elanInterfaceMac != null && elanInterfaceMac.getMacEntry() != null) {
            ...
            for (MacEntry macEntry : macEntries) {
                ...
                synchronized (ElanUtils.getElanMacDPNKey(elanInfo.getElanTag(), macAddress,
                    ...
                    LOG.info("Acquired lock for mac : " + macAddress + ". Proceeding with remote dmac install operation.");
