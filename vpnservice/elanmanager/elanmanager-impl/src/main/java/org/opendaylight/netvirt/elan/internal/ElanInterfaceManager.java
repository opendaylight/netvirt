...
public class ElanInterfaceManager extends AsyncDataTreeChangeListenerBase<ElanInterface, ElanInterfaceManager>
    ...
    List<ListenableFuture<Void>> removeEntriesForElanInterface(ElanInstance elanInfo, InterfaceInfo
        ...
        if (interfaceInfo != null) {
            if (existingElanInterfaceMac.isPresent()) {
                ...
                List<PhysAddress> macAddresses = macEntries.stream().map(macEntry -> {
                    ...
                    elanUtils.deleteMacFlows(elanInfo, interfaceInfo, macEntry, tx);
                    return macAddress;
            ...
            removeFilterEqualsTable(elanInfo, interfaceInfo, tx);
        ...
        return Collections.singletonList(ElanUtils.waitForTransactionToComplete(tx));
    }
