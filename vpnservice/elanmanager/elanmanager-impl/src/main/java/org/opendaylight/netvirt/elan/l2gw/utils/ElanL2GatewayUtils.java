...
public class ElanL2GatewayUtils {
     ...
     * @param interfaceName 
     */
    public static void installL2gwDeviceMacsInDpn(BigInteger dpnId, NodeId l2gwDeviceNodeId, ElanInstance elan, String interfaceName) {
     ...
     * @param interfaceName 
     */
    public static void installDmacFlowsOnDpn(BigInteger dpnId, L2GatewayDevice l2gwDevice, ElanInstance elan, String interfaceName) {
        ...
        if (l2gwDeviceLocalMacs != null && !l2gwDeviceLocalMacs.isEmpty()) {
            for (LocalUcastMacs localUcastMac : l2gwDeviceLocalMacs) {
                ...
                ElanUtils.installDmacFlowsToExternalRemoteMac(dpnId, l2gwDevice.getHwvtepNodeId(), elan.getElanTag(),
                        elan.getVni(), localUcastMac.getMacEntryKey().getValue(), elanName, interfaceName);
            }
    ...
    public static void installL2GwUcastMacInElan(final ElanInstance elan,
            final L2GatewayDevice extL2GwDevice, final String macToBeAdded, String interfaceName) {
