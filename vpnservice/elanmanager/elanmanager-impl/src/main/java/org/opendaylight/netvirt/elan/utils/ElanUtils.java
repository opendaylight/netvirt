...
public class ElanUtils {
            ...
            for (DpnInterfaces elanDpn : elanDpns) {
                ...
                if (elanDpn.getDpId().equals(dpId)) {
                    ...
                    if (isDpnPresent(elanDpn.getDpId())) {
                        if(Objects.equals(elanInfo.getSegmentType(), SegmentTypeVlan.class)) {
                            setupRemoteDmacFlowVlan(elanDpn.getDpId(), // srcDpn (the
                                    // remote DPN in
                                    // this case)
                            ...
                            LOG.debug("Dmac flow for vlan entry created for elan Name:{}, logical port Name:{} and mac address:{} on"
    ...
    public void setupRemoteDmacFlowVlan(BigInteger srcDpId, BigInteger destDpId, int lportTag, long elanTag,
                                        ...
                                        String interfaceName, String physnet, long segId) {
