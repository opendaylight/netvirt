...
public class ElanUtils {
    ...
    public void setupMacFlows(ElanInstance elanInfo, InterfaceInfo interfaceInfo, long macTimeout,
        ...
        coordinator.enqueueJob(getElanMacJobKey(elanInfo.getElanTag(), macAddress), new Callable<List<ListenableFuture<Void>>>() {
            @Override
    ...
    public static String getElanMacJobKey(long elanTag, String macAddress) {
        String key = "MAC-" + macAddress + " ELAN_TAG-" + elanTag;
        return key;
    }
}
