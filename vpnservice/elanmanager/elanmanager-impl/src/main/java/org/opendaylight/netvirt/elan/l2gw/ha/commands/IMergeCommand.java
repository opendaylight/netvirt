...
public interface IMergeCommand<T extends DataObject, BuilderType extends Builder, AugType extends DataObject> {
     ...
     */
    void mergeOperationalData(BuilderType dst,
     ...
     * @param nodePath nodePath of dest
     */
    void mergeConfigData(BuilderType dst,
                                AugType src,
                                InstanceIdentifier<Node> nodePath);
     ...
     */
    void mergeConfigUpdate(AugType existingData,
                                  AugType updated,
                                  AugType orig,
                                  InstanceIdentifier<Node> nodePath,
     ...
     * @param tx ReadWriteTransaction
     */
    void mergeOpUpdate(AugType existingData,
                              AugType updatedSrc,
                              AugType origSrc,
                              InstanceIdentifier<Node> nodePath,
                              ReadWriteTransaction tx);
