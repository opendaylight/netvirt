...
public class ElanVpnPortIpToPortListener extends
    ...
    public ElanVpnPortIpToPortListener(DataBroker broker, IInterfaceManager interfaceManager, ElanUtils elanUtils, final IMdsalApiManager mdsalManager) {
    ...
    protected void add(InstanceIdentifier<VpnPortipToPort> key, VpnPortipToPort dataObjectModification) {
        ...
        if (isLearnt) {
            ...
            // TODO if
            LOG.info("YAIR in add elanInterface {}", elanInterface);
