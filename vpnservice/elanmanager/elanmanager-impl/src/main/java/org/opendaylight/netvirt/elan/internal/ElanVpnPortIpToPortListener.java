...
public class ElanVpnPortIpToPortListener extends
        AsyncDataTreeChangeListenerBase<LearntVpnVipToPort, ElanVpnPortIpToPortListener> {
    ...
    public ElanVpnPortIpToPortListener(DataBroker broker, IInterfaceManager interfaceManager, ElanUtils elanUtils) {
        super(LearntVpnVipToPort.class, ElanVpnPortIpToPortListener.class);
        this.broker = broker;
    ...
    protected InstanceIdentifier<LearntVpnVipToPort> getWildCardPath() {
        return InstanceIdentifier.create(VpnPortIpToPortData.class).child(LearntVpnVipToPort.class);
    }
