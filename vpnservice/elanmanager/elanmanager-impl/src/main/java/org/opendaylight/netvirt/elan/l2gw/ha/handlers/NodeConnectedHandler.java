...
public class NodeConnectedHandler {
    ...
    /**
     * Takes the argument , create HA config noed in case not present , takes care of event of new Node connected.
     * Copy data of child HA to HA node upon creation .
     *
    ...
    /**
     * Copy HA node global data config to Child HA node .
     *
     * @param srcNode Node which to be transformeds
    ...
    /**
     * Copy HA child node global data operational to HA node .
     *
     * @param childNode HA Child Node
     * @param haNodePath HA node path
     * @param tx Transaction
    ...
    /**
     * Merge data to Physical switch from HAid .
     *
    ...
    /**
     * Copy HA physical switch config data to Child Physical switch node .
     *
    ...
    /**
     * Copy child physical switch node data to HA physical switch data .
     *
