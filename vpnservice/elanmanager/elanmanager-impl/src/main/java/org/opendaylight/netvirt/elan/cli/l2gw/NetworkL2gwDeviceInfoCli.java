...
public class NetworkL2gwDeviceInfoCli extends OsgiCommandSupport {
    ...
    void process(NodeId hwvtepNodeId, String elanName) {
        ...
        getLocalUcastMacs(hwvtepConfigNode, elanName);
        session.getConsole().println("Operational Data >>");
        Node hwvtepOpNode = opNodes.get(hwvtepNodeId);
        getLocalUcastMacs(hwvtepOpNode, elanName);
        session.getConsole().println("Config Data >>");
        getLocalMcastMacs(hwvtepConfigNode, elanName);
        session.getConsole().println("Operational Data >>");
        getLocalMcastMacs(hwvtepOpNode, elanName);
        session.getConsole().println("Config Data >>");
        getRemoteUcastMacs(hwvtepConfigNode, elanName);
        session.getConsole().println("Operational Data >>");
        getRemoteUcastMacs(hwvtepOpNode, elanName);
        session.getConsole().println("Config Data >>");
        getRemoteMcastMacs(hwvtepConfigNode, elanName);
        session.getConsole().println("Operational Data >>");
        getRemoteMcastMacs(hwvtepOpNode, elanName);
        Node hwvtepConfigPsNode = configPSNodes.get(hwvtepNodeId);
        session.getConsole().println("Config Data >>");
        getVlanBindings(hwvtepConfigPsNode, elanName);
        session.getConsole().println("Operational Data >>");
        Node hwvtepOpPsNode = opPSNodes.get(hwvtepNodeId);
        getVlanBindings(hwvtepOpPsNode, elanName);
    }

    void getRemoteUcastMacs(Node hwvtepNode, String elanName) {
    ...
    void getLocalUcastMacs(Node hwvtepNode, String elanName) {
    ...
    void getLocalMcastMacs(Node hwvtepNode, String elanName) {
    ...
    void getRemoteMcastMacs(Node hwvtepNode, String elanName) {
    ...
    void getVlanBindings(Node psNode, String elanName) {
