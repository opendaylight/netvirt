...
public class ElanPacketInHandler implements PacketProcessingListener {
    ...
    public void onPacketReceived(PacketReceived notification) {
        ...
        if (pktInReason == NoMatch.class && tableId == NwConstants.ELAN_SMAC_TABLE) {
            ...
            try {
                ...
                if (isInGracePeriod(interfaceName, macEntry)) {
                    return;
                }

                final DataStoreJobCoordinator portDataStoreCoordinator = DataStoreJobCoordinator.getInstance();
                enqueueJobForMacEntriesManipulation(macAddress, elanTag, interfaceName, elanName, physAddress,
    ...
    private boolean isInGracePeriod(String interfaceName, MacEntry macEntry) {
    ...
    private void enqueueJobForMacEntriesManipulation(final String macAddress, final long elanTag, String interfaceName,
        ...
        portDataStoreCoordinator.enqueueJob(ElanUtils.getElanMacKey(elanTag, macAddress), () -> {
            MacEntry macEntry = elanUtils.getInterfaceMacEntriesOperationalDataPath(interfaceName, physAddress);
            if (isInGracePeriod(interfaceName, macEntry)) {
                ElanManagerCounters.mac_in_grace_period.inc();
            ...
            writeTx.put(LogicalDatastoreType.OPERATIONAL, macEntryId, newMacEntry, true);
