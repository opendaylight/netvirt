...
@Singleton
public class ElanInstanceManagerImpl extends AsyncDataTreeChangeListenerBase<ElanInstance, ElanInstanceManager>
        implements ElanInstanceManager, AutoCloseable {

    private static final Logger LOG = LoggerFactory.getLogger(ElanInstanceManagerImpl.class);
    ...
    @Inject
    public ElanInstanceManagerImpl(final DataBroker dataBroker, final IdManagerService managerService,
    ...
    protected void remove(InstanceIdentifier<ElanInstance> identifier, ElanInstance deletedElan) {
        ...
        ElanUtils.removeAndGetElanInterfaces(elanName).forEach(
            elanInterfaceName -> dataStoreJobCoordinator.enqueueJob(elanInterfaceName, () -> {
