...
public class ElanNodeListener extends AbstractDataChangeListener<Node> implements AutoCloseable {
    ...
    private void setupTableMissSmacFlow(BigInteger dpId) {
        ...
        String[] header = new String[] {
            ...
            "0",
            Short.toString(NwConstants.ELAN_TEMP_SMAC_TABLE),
            String.valueOf(0),
            String.valueOf(0)
        };
        ...
        addPreTempSmacFlow(dpId);
        addTempSmacFlow(dpId);
    }

    private void addPreTempSmacFlow(BigInteger dpId) {
        //T48 - resubmit to T49 & T50
        List<ActionInfo> actionsInfo = new ArrayList<>();
        actionsInfo.add(new ActionInfo(ActionType.nx_resubmit,
                new String[] {Short.toString(NwConstants.ELAN_TEMP_SMAC_TABLE) }));
        actionsInfo.add(new ActionInfo(ActionType.nx_resubmit,
        ...
        FlowEntity doubleResubmitTable = MDSALUtil.buildFlowEntity(dpId, NwConstants.ELAN_PRETEMP_SMAC_TABLE,
                getTableMissFlowRef(NwConstants.ELAN_PRETEMP_SMAC_TABLE),
    ...
    private void addTempSmacFlow(BigInteger dpId) {
        ...
        FlowEntity flowEntity = MDSALUtil.buildFlowEntity(dpId, NwConstants.ELAN_SMAC_TABLE, new StringBuffer()
                .append(NwConstants.ELAN_SMAC_TABLE).append(NwConstants.FLOWID_SEPARATOR)
                .append(LEARN_MATCH_REG4_VALUE).toString(), 10, "ELAN sMac Table Reg4 Flow", 0, 0,
