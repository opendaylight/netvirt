...
public class VpnDpnToTransportZoneListener
    ...
    protected void update(InstanceIdentifier<VpnToDpnList> identifier, VpnToDpnList original, VpnToDpnList update) {
        ...
        update.getVpnInterfaces().removeAll(original.getVpnInterfaces());
        boolean shouldCreateVtep = transportZoneNotificationUtil.shouldCreateVtep(update.getVpnInterfaces());
        if (shouldCreateVtep) {
