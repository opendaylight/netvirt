...
public class ArpResponderUtil {
     ...
     */
    public static List<MatchInfo> getMatchCriteria(java.util.Optional<Integer> lportTag, ElanInstance elanInstance,
            String ipAddress) {

        BigInteger metadata = lportTag.map(v -> ElanUtils.getElanMetadataLabel(elanInstance.getElanTag(), v))
                .orElse(ElanUtils.getElanMetadataLabel(elanInstance.getElanTag()));
        BigInteger metadataMask = lportTag
...
//    }
     ...
     * @return List of ARP Responder Actions actions
     */
    public static List<Action> getExternalActions(IInterfaceManager ifaceMgrRpcService, String ifName, String ipAddress,
            String macAddress) {
    ...
    public static List<Instruction> getExtInterfaceInstructions(IInterfaceManager ifaceMgrRpcService,
        ...
        List<Action> actions = getExternalActions(ifaceMgrRpcService, extInterfaceName, ipAddress, macAddress);
        actions.removeIf(v -> {
     ...
     */
    public static String getFlowId(java.util.Optional<Integer> lportTag, String ipAdress) {
        return lportTag
     ...
     * @return Cookie
     */
    public static BigInteger generateCookie(java.util.Optional<Integer> lportTag, String ipAddress) {
