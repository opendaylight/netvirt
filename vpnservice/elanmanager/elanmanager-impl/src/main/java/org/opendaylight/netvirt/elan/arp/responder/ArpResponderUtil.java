...
public class ArpResponderUtil {
    ...
    public static List<MatchInfo> getMatchCriteria(int lportTag, ElanInstance elanInstance,
        ...
        BigInteger metadata = ElanUtils.getElanMetadataLabel(elanInstance.getElanTag(), lportTag);
        BigInteger metadataMask = MetaDataUtil.METADATA_MASK_SERVICE.or(MetaDataUtil.METADATA_MASK_LPORT_TAG);
