...
import org.opendaylight.netvirt.elanmanager.tests.utils.IdManagerTestImpl;
...
public class ElanServiceTestModule extends AbstractGuiceJsr250Module {
    ...
    protected void configureBindings() {
        ...
        //when(iVpnManager.getVpnRd(any(DataBroker.class), any(String.class))).thenReturn("100:1");
