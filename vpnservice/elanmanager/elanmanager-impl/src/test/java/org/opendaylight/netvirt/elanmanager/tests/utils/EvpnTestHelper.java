...
public class EvpnTestHelper  {
    ...
    public void attachEvpnToNetwork(ElanInstance elanInstance) throws TransactionCommitFailedException {
    ...
    public void detachEvpnToNetwork(String elanName) throws TransactionCommitFailedException {
        deleteEvpnNameInElan(elanName);
        deleteRdtoNetworks();
    }

    public void handleEvpnRt2Recvd(String macRecvd, String prefixRecvd) {
