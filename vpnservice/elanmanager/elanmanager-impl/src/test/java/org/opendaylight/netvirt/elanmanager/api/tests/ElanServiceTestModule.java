...
public class ElanServiceTestModule implements AutoCloseable {
    ...
    // TODO remove when https://git.opendaylight.org/gerrit/#/c/43645/ is merged
    public ElanServiceTestModule(DataBroker dataBroker) {
        this.dataBroker = dataBroker;
    }

    public DataBroker dataBroker() {
/* TODO uncomment when https://git.opendaylight.org/gerrit/#/c/43645/ is merged
        if (dataBroker == null) {
 ...
 */
    ...
    public IElanService elanService() throws Exception {
        if (elanService == null) {
