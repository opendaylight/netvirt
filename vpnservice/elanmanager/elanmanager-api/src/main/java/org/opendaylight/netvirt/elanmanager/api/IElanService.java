...
public interface IElanService extends IEtreeService {
     ...
     * @param instructions
     *            Custom instruction to be add before the ARP actions to be
     *            added
     */
    void addArpResponderFlow(BigInteger dpnId, String ingressInterfaceName, String ipAddress, String macAddress,
     ...
     */
    void removeArpResponderFlow(BigInteger dpnId, String ingressInterfaceName, String ipAddress, int lportTag);
}
