    ...
    public class AsIdReactor
        ...
        add(InstanceIdentifier<AsId> iid, AsId val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                if (br == null) {
                    LOG.error("{} Unable to process add for routerId {} asNum {}; {}", yangObj, routerId, asNum,
                            BgpRouterException.BGP_ERR_NOT_INITED, addWarn);
                    return;
                }
        ...
        remove(InstanceIdentifier<AsId> iid, AsId val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to process remove for asNum {}; {}", yangObj, asNum,
                            BgpRouterException.BGP_ERR_NOT_INITED, delWarn);
                    return;
                }
                try {
                    br.stopBgp(asNum);
    ...
    public class GracefulRestartReactor
        ...
        add(InstanceIdentifier<GracefulRestart> iid, GracefulRestart val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to add stale-path time {}; {}", yangObj, stalePathTime,
                            BgpRouterException.BGP_ERR_NOT_INITED, addWarn);
                    return;
                }
                try {
        ...
        remove(InstanceIdentifier<GracefulRestart> iid, GracefulRestart val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to delete stale-path time; {}", yangObj,
                            BgpRouterException.BGP_ERR_NOT_INITED, delWarn);
                    return;
                }
                try {
        ...
        protected void update(InstanceIdentifier<GracefulRestart> iid,
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to update stale-path time to {}; {}", yangObj, stalePathTime,
                            BgpRouterException.BGP_ERR_NOT_INITED, addWarn);
                    return;
                }
                try {
    ...
    public class LoggingReactor
        ...
        add(InstanceIdentifier<Logging> iid, Logging val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to add logging for qbgp; {}", yangObj,
                            BgpRouterException.BGP_ERR_NOT_INITED, addWarn);
                    return;
                }
                try {
        ...
        remove(InstanceIdentifier<Logging> iid, Logging val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to remove logging for qbgp; {}", yangObj,
                            BgpRouterException.BGP_ERR_NOT_INITED, delWarn);
                    return;
                }
                try {
        ...
        protected void update(InstanceIdentifier<Logging> iid,
            ...
            synchronized (BgpConfigurationManager.this) {
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to update logging for qbgp; {}", yangObj,
                            BgpRouterException.BGP_ERR_NOT_INITED, addWarn);
                    return;
                }
                try {
    ...
    public class NeighborsReactor
        ...
        add(InstanceIdentifier<Neighbors> iid, Neighbors val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to process add for peer {} as {}; {}", yangObj, peerIp, as,
                            BgpRouterException.BGP_ERR_NOT_INITED, addWarn);
                    return;
                }
                try {
        ...
        remove(InstanceIdentifier<Neighbors> iid, Neighbors val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to process remove for peer {}; {}", yangObj, peerIp,
                            BgpRouterException.BGP_ERR_NOT_INITED, delWarn);
                    return;
                }
                try {
    ...
    public class EbgpMultihopReactor
        ...
        add(InstanceIdentifier<EbgpMultihop> iid, EbgpMultihop val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to process add for peer {}; {}", yangObj, peerIp,
                            BgpRouterException.BGP_ERR_NOT_INITED, addWarn);
                    return;
                }
                try {
    ...
    public class NetworksReactor
        ...
        add(InstanceIdentifier<Networks> iid, Networks val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to process add for rd {} prefix {} nexthop {}; {}", yangObj, rd, pfxlen, nh,
                            BgpRouterException.BGP_ERR_NOT_INITED, addWarn);
                    return;
                }
        ...
        remove(InstanceIdentifier<Networks> iid, Networks val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to process remove for rd {} prefix {}; {}", yangObj, rd, pfxlen,
                            BgpRouterException.BGP_ERR_NOT_INITED, delWarn);
                    return;
                }
                Long label = val.getLabel();
    ...
    public class VrfsReactor
        ...
        add(InstanceIdentifier<Vrfs> iid, Vrfs val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to process add for rd {}; {}", yangObj, rd,
                            BgpRouterException.BGP_ERR_NOT_INITED, addWarn);
                    return;
                }
                try {
                    br.addVrf(rd, val.getImportRts(),
                            val.getExportRts());
                } catch (Exception e) {
                    LOG.error(yangObj + "Add received exception: \"" + e + "\"; "
                            + addWarn);
        ...
        remove(InstanceIdentifier<Vrfs> iid, Vrfs val) {
            ...
            synchronized (BgpConfigurationManager.this) {
                ...
                BgpRouter br = getClient(yangObj);
                if (br == null) {
                    LOG.error("{} Unable to process remove for rd {}; {}", yangObj, rd,
                            BgpRouterException.BGP_ERR_NOT_INITED, delWarn);
                    return;
                }
                try {
