...
public class BgpManagerImplModule extends AbstractBgpManagerImplModule {
    ...
    public AutoCloseable createInstance() {
        ...
        return (AutoCloseable) Reflection.newProxy(BgpManagerProxyInterface.class, new AbstractInvocationHandler() {
            @Override
    ...
    private static interface BgpManagerProxyInterface
            extends IBgpManager {
    }
}
