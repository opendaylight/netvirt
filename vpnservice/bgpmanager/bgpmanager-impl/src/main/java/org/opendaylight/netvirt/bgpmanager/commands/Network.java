    ...
    protected Object doExecute() throws Exception {
        ...
        switch (action) {
            case "add":
                ...
                LOGGER.info("ADD: Adding Fib entry rd {} prefix {} nexthop {} label {} afi {}", rd, pfx, nh, label, afi);
                bm.addPrefix(rd, null /*maAddress*/, pfx, nh,
                        VrfEntry.EncapType.Mplsgre, label, 0 /*l3vni*/, null /*gatewayMacAddress*/, Long.parseLong(afi), staticOrigin);
