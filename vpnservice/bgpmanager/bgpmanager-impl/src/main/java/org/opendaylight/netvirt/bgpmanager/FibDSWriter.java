...
public class FibDSWriter {
    ...
    public synchronized void addFibEntryToDS(String rd, String prefix, List<String> nextHopList,
        ...
        try{
            ...
            long routeLabel = label;
            RoutePaths routes = VpnHelper.buildRoutePath(nextHopList, routeLabel);
    ...
    public synchronized void removeFibEntryFromDS(String rd, String prefix, long label) {
        ...
        InstanceIdentifier<RoutePaths> routePathId = idBuilder.build();
