...
public class FibDSWriter {
    ...
    public synchronized void addMacEntryToDS(String rd, String macAddress, List<String> nextHopList,
    ...
    public synchronized void removeMacEntryFromDS(String rd, String macAddress) {
