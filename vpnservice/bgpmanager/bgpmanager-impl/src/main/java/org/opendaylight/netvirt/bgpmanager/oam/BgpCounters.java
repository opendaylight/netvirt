...
public class BgpCounters implements Runnable, AutoCloseable {
        ...
        try (Scanner scanner = new Scanner(file)) {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (str.contains("State/PfxRcd")) {
                    ...
                    //KEY Format : /entitycounter/entitytype:<bgp-peer>/entityid:<asid=value;neighborip=value>/<countername>
                    String bgpCounterNbrPktsRXkey = "/entitycounter/entitytype:bgp-peer/entityid:<asid=" 
                                              + as + ";neighborip=" + strIp + ">/" + BgpConstants.BGP_COUNTER_NBR_PKTS_RX;
                    updateCounter(bgpCounterNbrPktsRXkey, Long.parseLong(rx));
                    
                    //KEY Format : /entitycounter/entitytype:<bgp-peer>/entityid:<asid=value;neighborip=value>/<countername>
                    String bgpCounterNbrPktsTXkey = "/entitycounter/entitytype:bgp-peer/entityid:<asid=" 
                                             + as + ";neighborip=" + strIp + ">/"+BgpConstants.BGP_COUNTER_NBR_PKTS_TX;
     ...
     */
    private void parseIpBgpVpnv6All() {//kiran
    ...
    private void parseBgpL2vpnEvpnAll() {
        ...
        //KEY Format : /aggregatecounter/[source:<application-or-service-name>]/totalprefixes
        String bgpCounterTotalPFXkey = "/aggregatecounter/[source:" + BgpConstants.BGP_COUNTER_TOTAL_PFX + "]/totalprefixes";
    ...
    private int processRouteCount(String rd, int startIndex, List<String> inputStrs) {
        int num = startIndex;
        long routeCount = 0;
        //KEY Format : /entitycounter/entitytype:<bgp-rd>/entityid:<rd=value>/<countername>
        String bgpCounterRdRouteCountKey = "/entitycounter/entitytype:bgp-rd/entityid:<rd=" + rd + ">/" + BgpConstants.BGP_COUNTER_RD_ROUTE_COUNT;
