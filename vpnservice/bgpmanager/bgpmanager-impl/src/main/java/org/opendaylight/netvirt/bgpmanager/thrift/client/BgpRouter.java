...
public class BgpRouter {
            ...
            case NBR:
                if (bop.add) {
                    ...
                    if (result == 0 && op.strs[1] != null) { // createPeer worked and password is specified
                        ...
                        if (result != 0) {
                            throw new BgpRouterException(BgpRouterException.Function.SET_PEER_PASSWORD, result);
                        }
                    }
                } else { // delete
    ...
    public synchronized void addNeighbor(String nbrIp, long nbrAsNum, String md5Secret)
            throws TException, BgpRouterException {
