...
public class BgpUtil implements AutoCloseable {
     ...
     * @param as string.
     * @param rx BgpNeighborPacketsReceived value.
     * @param tx BgpNeighborPacketsSent value.
     * @param strIp neighbor-ip value.
     * @param rd BgpRdRouteCount value.
     * @return counterKey string.
     */
