...
public class BgpUtil implements AutoCloseable {
    ...
    /**
     *   This method generates bgp counter keys.
     * - Key is created based on the inputs of the counter
     * - Keys generated for the following counters
     * - BgpNeighborPacketsReceived, BgpNeighborPacketsSent
     * - BgpRdRouteCount, BgpTotalPrefixes:Bgp_Total_Prefixes
     */
    public static String generateBgpCounterKey(
        ...
        if (rx != null) {
            counterKey += entityTypeBgpPeer + as + neighborIp + strIp + angularBracket
