...
public class ShowSubnet extends OsgiCommandSupport {
    ...
    protected Object doExecute() throws Exception {
        if (subnetmap == null && subnetopdata == null) {
            ...
            Optional<SubnetOpData> optionalSubnetOpData = syncReadOptional(dataBroker, OPERATIONAL, subOpIdentifier2);
            ...
            InstanceIdentifier<SubnetOpDataEntry> subOpIdentifier = InstanceIdentifier.builder(SubnetOpData.class)
                .child(SubnetOpDataEntry.class, new SubnetOpDataEntryKey(new Uuid(subnetopdata), null)).build();
