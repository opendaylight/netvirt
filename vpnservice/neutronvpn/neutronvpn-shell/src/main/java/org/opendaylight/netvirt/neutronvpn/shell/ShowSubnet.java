    ...
    protected Object doExecute() throws Exception {
        if (subnetmap == null && subnetopdata == null && (options == null || options.isEmpty())) {
            ...
            System.out.println("Key: " + data.getKey() + "\n" + "VpnId: " + data.getVpnId() + "\n"
                    ...
                    + "RouterInterfacePortId: " + data.getRouterInterfacePortId() + "\n"
        ...
        if (optionsSubnetmapall) {
            ...
            Optional<Subnetmaps> optionalSubnetmaps =  syncReadOptional(dataBroker, OPERATIONAL, subMapIdentifier);
                ...
                subnetmapList.forEach(sn -> {
                    if (sn != null) {
                        ...
                        if (sn.getPortList() != null) {
                            System.out.println("There are " + sn.getPortList().size() + "in the list of port");
