...
public class NeutronSubnetGwMacResolver {
    ...
    private static final ThreadFactory threadFactory = new ThreadFactoryBuilder().setNameFormat("Gw-Mac-Res").build();
    private static final ScheduledExecutorService executorService = Executors
            .newSingleThreadScheduledExecutor(threadFactory);

    public NeutronSubnetGwMacResolver(IVpnManager vpnManager, OdlArputilService arputilService,
