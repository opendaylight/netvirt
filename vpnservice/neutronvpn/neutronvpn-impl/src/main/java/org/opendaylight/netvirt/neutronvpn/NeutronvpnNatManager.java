...
public class NeutronvpnNatManager implements AutoCloseable {
    ...
    public void addExternalSubnet(Network network, Subnet subnet) {
        ...
        try {
            ...
            LOG.info("Creating external subnet {}", subnetId);
    ...
    public void updateExternalSubnet(Network network, Subnet subnet) {
        Uuid netId = network.getUuid();
        Uuid subnetId = subnet.getUuid();
        InstanceIdentifier<Subnets> subnetsIdentifier = InstanceIdentifier.builder(ExternalSubnets.class).
                child(Subnets.class, new SubnetsKey(subnetId)).build();
        ...
        try {
            ...
            LOG.info("Updating external subnet {}", subnetId);
    ...
    public void removeExternalSubnet(Subnet subnet) {
        Uuid subnetId = subnet.getUuid();
        InstanceIdentifier<Subnets> subnetsIdentifier = InstanceIdentifier.builder(ExternalSubnets.class).
                child(Subnets.class, new SubnetsKey(subnetId)).build();
