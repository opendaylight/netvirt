...
public class InterfaceStateToTransportZoneListener extends AbstractDataChangeListener<Interface> implements AutoCloseable{
    ...
    private static final String TUNNEL_PORT = "eth0";
    ...
    public void close() throws Exception {
        ...
        LOG.info("InterfaceStateToTransportZone listener Closed");
    }


    /**
     * registers listener for Interface state
     * @param db
     */
    private void registerListener(final DataBroker db) {
        try {
            listenerRegistration = db.registerDataChangeListener(LogicalDatastoreType.OPERATIONAL,
                    getWildCardPath(), InterfaceStateToTransportZoneListener.this, DataChangeScope.SUBTREE);
        } catch (final Exception e) {
    ...
    protected void update(InstanceIdentifier<Interface> identifier, Interface original, Interface update) {
        updateTrasportZone(update);
    }


    @Override
    protected void add(InstanceIdentifier<Interface> identifier, Interface add) {
        updateTrasportZone(add);
    }
     ...
     * @param inter
     */
    private void updateTrasportZone(Interface inter) {
            ...
            try{
                ...
                if (zone != null) {
                    if (!currentPortNodeTepPresent(zone, dpnId)) {
                        ...
                        persistTransportZone(zone, inter.getName());
                    }
                }else{
    ...
    private void persistTransportZone(TransportZone zone, String interName) {
    ...
    private IpAddress getNodeIP(BigInteger dpId) throws Exception {
        ...
        String localIp = NeutronvpnUtils.getOpenvswitchOtherConfig(node, LOCAL_IP, dataBroker);
        if(localIp == null){
