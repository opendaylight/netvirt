...
public class NeutronNetworkChangeListener extends AsyncDataTreeChangeListenerBase<Network, NeutronNetworkChangeListener>
    ...
    protected void add(InstanceIdentifier<Network> identifier, Network input) {
        ...
        if (NeutronvpnUtils.isVxlanNetwork(input) && NeutronUtils.getSegmentationIdFromNeutronNetwork(input,
                NetworkTypeVxlan.class) == null) {
            LOG.error("Segmentation ID is null for configured VxLAN provider network {}. Abandoning any further "
