...
public class NeutronvpnUtils {
     ...
     * externalVpn (vpn on externalProvider network) then <font color=#ff9900>its Uuid</font> will be returned.
     ...
     * @param subnetId the Uuid of subnet for which found the IP version used
