...
>>>>>>> a771ba92ca69... neutronvpn: create ipv4 or ipv6 context
    ...
    protected static VpnInstanceOpDataEntry getAllVpnInstanceOpData(DataBroker broker, String vpnName) {
        ...
        if (vpnInstanceOpDataOptional.isPresent()) {
            ...
            for (VpnInstanceOpDataEntry vpnInstanceOpData: vpnInstanceOpDataList) {
                if (vpnInstanceOpData.getName() == vpnName) {
