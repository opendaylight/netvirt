...
public class NeutronEvpnManager {
    ...
    public Future<RpcResult<GetEVPNOutput>> getEVPN(GetEVPNInput input) {
        ...
        if (inputVpnId == null) {
            // get all vpns
            Optional<VpnInstances> optionalVpns = NeutronEvpnUtils.getConfigVpnInstances(dataBroker);
            ...
            Optional<VpnInstance> optionalVpn = NeutronEvpnUtils.getConfigVpnInstanceByName(dataBroker, name);
    ...
    public Future<RpcResult<DeleteEVPNOutput>> deleteEVPN(DeleteEVPNInput input) {
        ...
        for (Uuid vpn : vpns) {
            ...
            Optional<VpnInstance> optionalVpn = NeutronEvpnUtils.getConfigVpnInstanceByName(dataBroker,
                    vpn.getValue());
