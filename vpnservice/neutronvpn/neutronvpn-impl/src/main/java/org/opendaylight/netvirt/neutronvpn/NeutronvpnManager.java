...
public class NeutronvpnManager implements NeutronvpnService, AutoCloseable, EventListener {
    ...
    private void updateVpnInstanceWithIpFamily(String vpnName, IpVersionChoice ipVersion) {
        ...
        Optional<VpnInstance> optionalVpn = NeutronvpnUtils.read(dataBroker, LogicalDatastoreType.CONFIGURATION,
                vpnIdentifier);
        LOG.debug("updateVpnInstanceWithIpFamily : vpnName {} with IpVersionChoice {}", vpnName, ipVersion);
        ...
        if (vpnInstance.getVpnConfig() == null) {
            LOG.error("updateVpnInstanceWithIpFamily : vpnName {} with IpVersionChoice {} failed", vpnName, ipVersion);
            return;
        }
        if (ipVersion.isIpVersionChosen(IpVersionChoice.IPV4) && (vpnInstance.getIpv4Family() == null)) {
            ...
            LOG.info("updateVpnInstanceWithIpFamily : vpnName {}. IPv4 VPN family created", vpnName);
        }
        if (ipVersion.isIpVersionChosen(IpVersionChoice.IPV6) && (vpnInstance.getIpv6Family() == null)) {
            ...
            LOG.info("updateVpnInstanceWithIpFamily : vpnName {}. IPv6 VPN family created", vpnName);
        ...
        if (ipVersion.isIpVersionChosen(IpVersionChoice.UNDEFINED)) {
            ...
            if (newIpVersion.isIpVersionChosen(IpVersionChoice.IPV4) && (vpnInstance.getIpv6Family() != null)) {
                LOG.info("updateVpnInstanceWithIpFamily : vpnName {}. IPv6 VPN family removed", vpnName);
            ...
            if (newIpVersion.isIpVersionChosen(IpVersionChoice.IPV6) && (vpnInstance.getIpv4Family() != null)) {
                LOG.info("updateVpnInstanceWithIpFamily : vpnName {}. IPv4 VPN family removed", vpnName);
        ...
        try {
            ...
            LOG.warn("updateVpnInstanceWithIpFamily : Error configuring feature ", ex);
        }
        LOG.debug("updateVpnInstanceWithIpFamily : updating existing vpninstance node");
    }
        ...
        try {
            ...
            if (optionalVpnInterface.isPresent()) {
                VpnInterfaceBuilder vpnIfBuilder = new VpnInterfaceBuilder(optionalVpnInterface.get())
                                      .setVpnInstanceNames(Collections.singletonList(vpnId.getValue()));
            ...
            for (final Uuid portId : portList) {
                ...
                portDataStoreCoordinator.enqueueJob("PORT-" + portId.getValue(), () -> {
                    ...
                    if (vpnIface == null) {
                        ...
                        writeVpnInterfaceToDs(Collections.singletonList(vpnId), vpnInfName, portAdj,
