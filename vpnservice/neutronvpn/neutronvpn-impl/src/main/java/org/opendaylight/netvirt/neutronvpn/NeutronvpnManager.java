...
public class NeutronvpnManager implements NeutronvpnService, AutoCloseable, EventListener {
    ...
    protected void addSubnetToVpn(final Uuid vpnId, Uuid subnet) {
        ...
        if (portList != null) {
            for (final Uuid portId : portList) {
                ...
                portDataStoreCoordinator.enqueueJob("PORT-" + portId.getValue(), () -> singletonList(
                    managedNewTransactionRunner.callWithNewWriteOnlyTransactionAndSubmit(wrtConfigTxn -> {
                        ...
                        if (vpnIface == null) {
                            ...
                            writeVpnInterfaceToDs(Collections.singletonList(vpnId), vpnInfName,
                                          portAdj, isRouterInterface, wrtConfigTxn);
    ...
    // TODO Clean up the exception handling
    @SuppressWarnings("checkstyle:IllegalCatch")
    private void writeVpnInterfaceToDs(Collection<Uuid> vpnIdList, String infName, Adjacencies adjacencies,
