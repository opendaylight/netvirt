...
public class NeutronvpnManager implements NeutronvpnService, AutoCloseable, EventListener {
    ...
    public Future<RpcResult<GetL3VPNOutput>> getL3VPN(GetL3VPNInput input) {
        ...
        try {
            ...
            List<org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.neutronvpn.rev150602.getl3vpn.output.L3vpnInstances> vpnList = new ArrayList<>();
            for (VpnInstance vpnInstance : vpns) {
                ...
                L3vpnInstancesBuilder vpn = new L3vpnInstancesBuilder();
            ...
            opBuilder.setL3vpnInstances(vpnList);
    ...
    public List<String> showVpnConfigCLI(Uuid vpnuuid) {
        ...
        try {
            ...
            if (rpcResult.isSuccessful()) {
                ...
                result.add("------------------------------------------------------------------------------------");
                result.add("");
                List<org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.neutronvpn.rev150602.getl3vpn.output.L3vpnInstances> VpnList = rpcResult.getResult().getL3vpnInstances();
