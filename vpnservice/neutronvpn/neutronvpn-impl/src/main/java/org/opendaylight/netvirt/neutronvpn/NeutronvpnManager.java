...
public class NeutronvpnManager implements NeutronvpnService, AutoCloseable, EventListener {
    ...
    public void setNvpnNatManager(NeutronvpnNatManager argNvpnNatManager) {
        if (nvpnNatManager == null) {
            nvpnNatManager = argNvpnNatManager;
        }
    }
    ...
    public Future<RpcResult<CreateL3VPNOutput>> createL3VPN(CreateL3VPNInput input) {
        ...
        for (L3vpn vpn : vpns) {
            ...
            if (vpn.getRouterIds() != null && !vpn.getRouterIds().isEmpty()) {
                ...
                for (Uuid routerId : routerIdsList) {
                    if (neutronvpnUtils.getNeutronRouter(routerId) == null) {
        ...
        try {
            ...
            if (isBeingAssociated) {
                updateVpnInterface(vpn, null,
                            neutronvpnUtils.getNeutronPort(sm.getRouterInterfacePortId()),
            ...
            for (Uuid port : portList) {
                ...
                jobCoordinator.enqueueJob("PORT-" + port.getValue(), () -> {
                    ...
                    if (isBeingAssociated) {
                        ...
                        removeVpnFromVpnInterface(vpn,
                               neutronvpnUtils.getNeutronPort(port), wrtConfigTxn);
                    }
                    futures.add(wrtConfigTxn.submit());
                    return futures;
                });
...
//                    interfaces.add(routerInterface);
    ...
    private void checkAlarmExtraRoutes(Uuid vpnId, List<Routes> routeList) {
        ...
        for (Routes route : routeList) {
            ...
            // 2. Router ID
            List<Uuid> routerUuidList = neutronvpnUtils.getRouterforVpn(vpnId);
                ...
                try {
                    ...
                    if (vpnId != null) {
                        ...
                        if (neutronvpnUtils.getIsExternal(network)) {
                            ...
                            neutronvpnUtils.updateVpnInstanceOpVpn(VpnInstanceOpDataEntry
