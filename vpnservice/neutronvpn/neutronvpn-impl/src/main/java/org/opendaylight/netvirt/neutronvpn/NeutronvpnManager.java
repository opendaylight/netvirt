...
public class NeutronvpnManager implements NeutronvpnService, AutoCloseable, EventListener {
    ...
    protected void createVpnInterface(Uuid vpnId, Uuid routerId, Port port, WriteTransaction wrtConfigTxn) {
        ...
        createVpnInterface(vpnId, infName, adjs, wrtConfigTxn);
        if (routerId != null) {
    ...
    private void createExternalVpnInterface(Uuid vpnId, String infName) {
        createVpnInterface(vpnId, infName, null, null);
    }

    private void createVpnInterface(Uuid vpnId, String infName, Adjacencies adjacencies,
