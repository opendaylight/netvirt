...
public class NeutronvpnManager implements NeutronvpnService, AutoCloseable, EventListener {
    ...
    protected void addSubnetToVpn(final Uuid vpnId, Uuid subnet) {
        ...
        LOG.info("addSubnetToVpn: sn {}", sn.toString());
        LOG.info("addSubnetToVpn: sn IP {}", sn.getSubnetIp().toString());
        IpVersionChoice ipVersion = NeutronUtils.getIpVersion(sn.getSubnetIp());
        LOG.info("addSubnetToVpn: ipVersion {}", ipVersion.toString());
    ...
    protected void removeSubnetFromVpn(final Uuid vpnId, Uuid subnet) {
        ...
        if (sn != null) {
            ...
            //InstanceIdentifier<Subnetmaps> subnetMapsId = InstanceIdentifier.create(Subnetmaps.class)
            //        .child(Subnetmap.class);
