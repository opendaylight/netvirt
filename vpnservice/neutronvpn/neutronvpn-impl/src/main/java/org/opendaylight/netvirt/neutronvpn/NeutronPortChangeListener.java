...
public class NeutronPortChangeListener extends AbstractDataChangeListener<Port> implements AutoCloseable {
    ...
    protected void update(InstanceIdentifier<Port> identifier, Port original, Port update) {
        ...
        if ((update.getDeviceOwner() != null) && (update.getDeviceId() != null)) {
            ...
            if (NeutronConstants.DEVICE_OWNER_GATEWAY_INF.equals(update.getDeviceOwner())) {
                ...
                elanService.handleRouterEntitiesFlows(update.getMacAddress().getValue(), update.getNetworkId(),
                        NwConstants.ADD_FLOW);
            }
        }
    ...
    private void handleRouterGatewayUpdated(Port routerGwPort) {
        ...
        elanService.handleRouterEntitiesFlows(routerGwPort.getMacAddress().getValue(), networkId,
                NwConstants.ADD_FLOW);
