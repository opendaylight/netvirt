...
public class NeutronPortChangeListener extends AsyncDataTreeChangeListenerBase<Port, NeutronPortChangeListener>
    ...
    private Interface createInterface(Port port) {
        ...
        ParentRefsBuilder parentRefsBuilder = getParentRefsBuilder(interfaceName);
    ...
    private ParentRefsBuilder getParentRefsBuilder(String interfaceName) {
        String parentRefName = null;
        // FIXME this utility isn't very good for scale/performance as it traverses all nodes,
