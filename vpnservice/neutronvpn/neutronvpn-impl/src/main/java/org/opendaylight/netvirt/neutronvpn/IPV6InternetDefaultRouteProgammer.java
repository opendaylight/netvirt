...
public class IPV6InternetDefaultRouteProgammer {
    ...
    @Inject
    public IPV6InternetDefaultRouteProgammer(final NeutronvpnUtils nvpnUtils) {
...
//        }
        ...
        instructions.add((InstructionInfo) new InstructionGotoTable(NwConstants.EXTERNAL_TUNNEL_TABLE)
