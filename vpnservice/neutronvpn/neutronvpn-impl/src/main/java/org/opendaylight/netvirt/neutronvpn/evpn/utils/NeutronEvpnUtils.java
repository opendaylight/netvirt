...
public class NeutronEvpnUtils {
    ...
    public void updateElanWithVpnInfo(String elanInstanceName, VpnInstance vpnInstance, boolean isDelete) {
    ...
    public void updateVpnWithElanInfo(VpnInstance vpnInstance, String elanInstanceName, boolean isDelete) {
        String rd = vpnManager.getPrimaryRdFromVpnInstance(vpnInstance);
    ...
    public void updateElanAndVpn(VpnInstance vpnInstance, String subnetVpn, boolean isDelete) {
        LOG.debug("updating elan {} in vpn {}, isDelete={} ", subnetVpn, vpnInstance.getVpnInstanceName(), isDelete);
        updateVpnWithElanInfo(vpnInstance, subnetVpn, isDelete);

        LOG.debug("updating vpn {}, in elan {} isDelete={} ", subnetVpn, vpnInstance.getVpnInstanceName(), isDelete);
        // this data store update has to be done for l3vpn as well once routing use case for rt2 is supported.
        updateElanWithVpnInfo(subnetVpn, vpnInstance, isDelete);
        return;
    }
}
