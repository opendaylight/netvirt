...
public class NeutronTrunkChangeListener extends AsyncClusteredDataTreeChangeListenerBase<Trunk, NeutronTrunkChangeListener>
    ...
    protected void add(InstanceIdentifier<Trunk> identifier, Trunk input) {
        ...
        LOG.trace("Adding Trunk : key: {}, value={} to port {}",
                identifier, input, port.getUuid().getValue());
    }
