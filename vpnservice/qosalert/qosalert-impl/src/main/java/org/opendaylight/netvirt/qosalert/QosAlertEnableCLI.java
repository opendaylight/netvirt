...
import org.opendaylight.netvirt.qosalert.QosAlertManager;
...
public class QosAlertEnableCLI extends OsgiCommandSupport {
    ...
    @Argument(index = 0, name = "<value>", description = "true | false to enable/disable QoS packet drop alert", required = true, multiValued = false)
    private String value;

    private QosAlertManager qosAlertManager;

    final Logger LOG = LoggerFactory.getLogger(QosAlertEnableCLI.class);
    ...
    protected Object doExecute() throws Exception{
        ...
        try{
            ...
            LOG.error("Error in enable-qos-alert: {}", e);
        }
