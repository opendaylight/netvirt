...
public final class QosAlertManager implements Runnable {
    ...
    static final FutureCallback<Void> DEFAULT_FUTURE_CALLBACK =
        ...
        if(nodesOptional.isPresent()) {
            ...
            for(Node node : nodeList) {
                ...
                for( NodeConnector nodeConnector : node.getNodeConnector()) {
                    ...
                    FlowCapableNodeConnectorStatisticsData statsData = nodeConnector.getAugmentation(FlowCapableNodeConnectorStatisticsData.class);
