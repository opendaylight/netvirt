...
public class QosAlertThresholdCLI extends OsgiCommandSupport {
    ...
    @Argument(index = 0, name = "<threshold>", description = "threshold value in % 1..100", required = true, multiValued = false)
    private String threshold;

    final Logger LOG = LoggerFactory.getLogger(QosAlertThresholdCLI.class);
    ...
    protected Object doExecute() throws Exception{
        ...
        try{
            ...
            qosAlertManager.setThreshold(Integer.parseInt(threshold));
        }catch (Exception e) {
            LOG.error("Error in drop-packet-threshold {}", e);
        }
