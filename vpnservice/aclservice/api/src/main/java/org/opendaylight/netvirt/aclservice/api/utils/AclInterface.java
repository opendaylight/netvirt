...
public class AclInterface {
    ...
    /** The orig port security enabled. */
    Boolean origPortSecurityEnabled;

    /** The orig security groups. */
    List<Uuid> origSecurityGroups;

    /** The orig allowed address pairs. */
    List<AllowedAddressPairs> origAllowedAddressPairs;
    ...
    /**
     * Gets the orig port security enabled.
     *
     * @return the orig port security enabled
     */
    public Boolean getOrigPortSecurityEnabled() {
        return origPortSecurityEnabled;
    }

    /**
     * Sets the orig port security enabled.
     *
     * @param origPortSecurityEnabled the new orig port security enabled
     */
    public void setOrigPortSecurityEnabled(Boolean origPortSecurityEnabled) {
        this.origPortSecurityEnabled = origPortSecurityEnabled;
    }

    /**
     * Gets the orig security groups.
     *
     * @return the orig security groups
     */
    public List<Uuid> getOrigSecurityGroups() {
        return origSecurityGroups;
    }

    /**
     * Sets the orig security groups.
     *
     * @param origSecurityGroups the new orig security groups
     */
    public void setOrigSecurityGroups(List<Uuid> origSecurityGroups) {
        this.origSecurityGroups = origSecurityGroups;
    }

    /**
     * Gets the orig allowed address pairs.
     *
     * @return the orig allowed address pairs
     */
    public List<AllowedAddressPairs> getOrigAllowedAddressPairs() {
        return origAllowedAddressPairs;
    }

    /**
     * Sets the orig allowed address pairs.
     *
     * @param origAllowedAddressPairs the new orig allowed address pairs
     */
    public void setOrigAllowedAddressPairs(List<AllowedAddressPairs> origAllowedAddressPairs) {
        this.origAllowedAddressPairs = origAllowedAddressPairs;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((origPortSecurityEnabled == null) ? 0 : origPortSecurityEnabled.hashCode());
        result = prime * result + ((origSecurityGroups == null) ? 0 : origSecurityGroups.hashCode());
        result = prime * result + ((securityGroups == null) ? 0 : securityGroups.hashCode());
        result = prime * result + ((origAllowedAddressPairs == null) ? 0 : origAllowedAddressPairs.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (origPortSecurityEnabled == null) {
            if (other.origPortSecurityEnabled != null) {
                return false;
            }
        } else if (!origPortSecurityEnabled.equals(other.origPortSecurityEnabled)) {
            return false;
        }
        if (origSecurityGroups == null) {
            if (other.origSecurityGroups != null) {
                return false;
            }
        } else if (!origSecurityGroups.equals(other.origSecurityGroups)) {
            return false;
        }
        ...
        if (origAllowedAddressPairs == null) {
            if (other.origAllowedAddressPairs != null) {
                return false;
            }
        } else if (!origAllowedAddressPairs.equals(other.origAllowedAddressPairs)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "AclInterface [portSecurityEnabled=" + portSecurityEnabled + ", interfaceId=" + interfaceId
                ...
                + ", allowedAddressPairs=" + allowedAddressPairs + ", origPortSecurityEnabled="
                + origPortSecurityEnabled + ", origSecurityGroups=" + origSecurityGroups
                + ", origAllowedAddressPairs=" + origAllowedAddressPairs + "]";
    }
}
