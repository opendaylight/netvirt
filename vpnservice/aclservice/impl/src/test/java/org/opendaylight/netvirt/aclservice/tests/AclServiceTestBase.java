...
public abstract class AclServiceTestBase {
    ...
    public void setUpData() throws Exception {
        ...
        AllowedAddressPairs aapPort1 = buildAap(IP_PREFIX_1, PORT_MAC_1);
        AllowedAddressPairs aapPort2 = buildAap(IP_PREFIX_2, PORT_MAC_2);
        AllowedAddressPairs aapPort3 = buildAap(IP_PREFIX_3, PORT_MAC_3);
        AllowedAddressPairs aapPort4 = buildAap(IP_PREFIX_4, PORT_MAC_4);
