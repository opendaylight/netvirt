...
class FlowEntryObjects {
    ...
    static def fixedFlowsPort1() {
         ...
         result.addAll(fixedIngressFlowsPort1)
         result.addAll(fixedEgressFlowsPort1)
         result
    }
    ...
    static def etherFlows() {
         ...
         result.addAll(fixedIngressFlowsPort1)
         result.addAll(fixedEgressFlowsPort1)
         result.addAll(etherEgressFlowsPort1)
         result.addAll(fixedIngressFlowsPort2)
         result.addAll(etherIngressFlowsPort2)
         result.addAll(fixedEgrssFlowsPort2)
         result.addAll(etheregressFlowPort2)
         result
    }
    ...
    static def tcpFlows() {
         val result = new ArrayList
         result.addAll(fixedIngressFlowsPort1)
         result.addAll(tcpIngressFlowPort1)
         result.addAll(fixedEgressFlowsPort1)
         result.addAll(fixedIngressFlowsPort2)
         result.addAll(tcpIngressFlowPort2)
         result.addAll(fixedEgrssFlowsPort2)
         result.addAll(tcpEgressFlowPort2)
         result
    }
    ...
    static def udpFlows() {
         ...
         result.addAll(fixedIngressFlowsPort1)
         result.addAll(fixedEgressFlowsPort1)
         result.addAll(udpEgressFlowsPort1)
         result.addAll(fixedIngressFlowsPort2)
         result.addAll(udpIngressFlowsPort2)
         result.addAll(fixedEgrssFlowsPort2)
         result.addAll(udpEgressFlowsPort2)
         result
    }
    ...
    static def icmpFlows() {
         val result = new ArrayList
         result.addAll(fixedIngressFlowsPort1)
         result.addAll(icmpIngressFlowsPort1)
         result.addAll(fixedEgressFlowsPort1)
         result.addAll(fixedIngressFlowsPort2)
         result.addAll(icmpIngressFlowsPort2)
         result.addAll(fixedEgrssFlowsPort2)
         result.addAll(icmpEgressFlowsPort2)
         result
    }
