...
abstract class AceMatchesFactory {
    ...
    Matches create() {
        ...
        destRemoteIpPrefix().ifPresent(
            // TODO shouldn't this be setDestinationIpv4Network instead of setSourceIpv4Network here??
            destRemoteIpPrefix -> aceIpv4Builder.setSourceIpv4Network(new Ipv4Prefix(destRemoteIpPrefix)));
        if (protocol() != -1) {
