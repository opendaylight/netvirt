/*
 * Copyright (c) 2016 Ericsson India Global Services Pvt Ltd. and others. All
 * rights reserved.
 *
...
public class AclLiveStatisticsRpcServiceTest {
    ...
    private void assertStatsOutput(RpcResult<GetAclPortStatisticsOutput> output, Direction inputDirection) {
        ...
        List<AclInterfaceStats> lstAclInterfaceStats = aclPortStats.getAclInterfaceStats();
        assertNotNull(lstAclInterfaceStats);
        assertFalse(lstAclInterfaceStats.isEmpty());
        for (AclInterfaceStats stats : lstAclInterfaceStats) {
