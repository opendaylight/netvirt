...
public class AclServiceTest {
    ...
    public void newInterfaceWithEtherTypeAcl() throws Exception {
        // Given
        setUpData();
        Matches matches = ImmutableAceMatchesFactory.builder()
                .destLowerPort(-1).destUpperPort(-1).protocol(-1)
                .destRemoteIpPrefix(AclConstants.IPV4_ALL_NETWORK)
                .build().create();
        ...
        matches = ImmutableAceMatchesFactory.builder()
                .destLowerPort(-1).destUpperPort(-1).protocol(-1)
                .build().create();
        dataBrokerUtil.put(ImmutableIdentifiedAceBuilder.builder()
            .sgUuid(SG_UUID)
    ...
    public void newInterfaceWithTcpDstAcl() throws Exception {
        ...
        setUpData();
        Matches matches = ImmutableAceMatchesFactory.builder()
                .destLowerPort(80).destUpperPort(80).protocol(NwConstants.IP_PROT_TCP)
                .build().create();
        dataBrokerUtil.put(ImmutableIdentifiedAceBuilder.builder()
            .sgUuid(SG_UUID)
            .newRuleName(SR_UUID_1)
    ...
    public void newInterfaceWithUdpDstAcl() throws Exception {
        ...
        setUpData();
        Matches matches = ImmutableAceMatchesFactory.builder()
                .destLowerPort(80).destUpperPort(80).protocol(NwConstants.IP_PROT_UDP)
                .build().create();
        dataBrokerUtil.put(ImmutableIdentifiedAceBuilder.builder()
            .sgUuid(SG_UUID)
            .newRuleName(SR_UUID_1)
    ...
    public void newInterfaceWithIcmpAcl() throws Exception {
        ...
        setUpData();
        Matches matches = ImmutableAceMatchesFactory.builder()
                .destLowerPort(2).destUpperPort(3).protocol(NwConstants.IP_PROT_ICMP)
                .build().create();
        dataBrokerUtil.put(ImmutableIdentifiedAceBuilder.builder()
            .sgUuid(SG_UUID)
            .newRuleName(SR_UUID_1)
