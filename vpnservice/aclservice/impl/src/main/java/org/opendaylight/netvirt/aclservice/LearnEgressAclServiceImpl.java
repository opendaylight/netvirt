...
public class LearnEgressAclServiceImpl extends AbstractEgressAclServiceImpl {
    ...
    protected String syncSpecificAclFlow(BigInteger dpId, int lportTag, int addOrRemove, Ace ace, String portId,
        ...
        PacketHandling packetHandling = ace.getActions().getPacketHandling();
        if (packetHandling instanceof Permit) {
            addLearnActions(flowMatches, actionsInfos);
            actionsInfos.add(new ActionNxResubmit(NwConstants.LPORT_DISPATCHER_TABLE));
        } else if (packetHandling instanceof Deny) {
        ...
        syncFlow(dpId, NwConstants.INGRESS_LEARN_ACL_FILTER_TABLE, flowNameAdded, AclConstants.PROTO_MATCH_PRIORITY,
