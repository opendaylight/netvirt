...
public class StatefulEgressAclServiceImpl extends AbstractEgressAclServiceImpl {
    ...
    protected String syncSpecificAclFlow(BigInteger dpId, int lportTag, int addOrRemove, Ace ace, String portId,
        ...
        final String applyChangeOnExistingTrafficFlowName = flowName + "Egress" + lportTag + "_FlowAfterRuleDeleted";
        ...
        instructions = StatefulAclServiceHelper.createCtMarkInstructionForNewState(getEgressAclFilterTable(), elanId);
        syncFlow(dpId, NwConstants.INGRESS_ACL_STATEFUL_APPLY_CHANGE_EXIST_TRAFFIC_TABLE,
                ...
                0, AclConstants.COOKIE_ACL_BASE, applyChangeOnExistingTrafficFlowMatches,
                instructions, (addOrRemove == NwConstants.DEL_FLOW) ? 0 : 1);
