...
public abstract class AbstractAclServiceImpl implements AclServiceListener {
    ...
    public boolean updateAcl(AclInterface portBefore, AclInterface portAfter) {
        ...
        if (isPortSecurityEnableBefore != isPortSecurityEnable) {
            if (isPortSecurityEnable) {
                ...
                updateRemoteAclFilterTable(portAfter, NwConstants.DEL_FLOW);
            }
    ...
    private void processInterfaceUpdate(AclInterface portBefore, AclInterface portAfter) {
        ...
        List<AllowedAddressPairs> addedAllowedAddressPairs = AclServiceUtils
                .getUpdatedAllowedAddressPairs(portAfter.getAllowedAddressPairs(), portBefore.getAllowedAddressPairs());
        List<AllowedAddressPairs> deletedAllowedAddressPairs = AclServiceUtils
    ...
    private void programAclWithAllowedAddress(BigInteger dpId, List<AllowedAddressPairs> allowedAddresses, int lportTag,
            List<Uuid> aclUuidList, Action action, int addOrRemove, String portId) {
     ...
     *
     * @param aclUuidList
     *            the list of acl uuid to be applied
     * @param dpId
     *            the dpId
     * @param lportTag
     *            the lport tag
