...
public abstract class AbstractAclServiceImpl implements AclServiceListener {
    ...
    protected void syncCtMarkClearFlow(BigInteger dpId, int priority, List<MatchInfoBase> matches,
            Short filterTable, String clearCtMarkFlowName, Ace ace, Short tableId,
        ...
        syncFlow(dpId, tableId, clearCtMarkFlowName, priority, "ACL",
