    ...
    protected void add(InstanceIdentifier<Interface> key, Interface added) {
        ...
        AclInterface aclInterface = aclInterfaceCache.addOrUpdate(added.getName(), (prevAclInterface, builder) -> {
            ...
            if (AclServiceUtils.isOfInterest(prevAclInterface)) {
                ...
                SortedSet<Integer> ingressRemoteAclTags = aclServiceUtils
                        .getRemoteAclTags(aclInPort.getSecurityGroups(), DirectionIngress.class, dataBroker);
                SortedSet<Integer> egressRemoteAclTags = aclServiceUtils.getRemoteAclTags(aclInPort.getSecurityGroups(),
                        DirectionEgress.class, dataBroker);
