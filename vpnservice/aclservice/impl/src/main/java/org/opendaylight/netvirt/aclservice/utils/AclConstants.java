...
public final class AclConstants {
    ...
    public static final Integer CT_STATE_UNTRACKED_PRIORITY = 340;
    public static final Integer CT_STATE_TRACKED_EXIST_PRIORITY = 330;
    public static final Integer CT_STATE_TRACKED_INVALID_PRIORITY = 320;
    public static final Integer CT_STATE_TRACKED_NEW_PRIORITY = 310;
    public static final Integer CT_STATE_TRACKED_NEW_DROP_PRIORITY = 50;
    public static final Integer NO_PRIORITY = 50;

    public static final Integer ACE_WITHOUT_REMOTE_ACL_PRIORITY = 240;
    public static final Integer ACE_LAST_REMOTE_ACL_PRIORITY = 230;
    public static final Integer ACE_GOTO_NEXT_REMOTE_ACL_PRIORITY = 220;
    public static final Integer ACE_FIRST_REMOTE_ACL_PRIORITY = 210;
    public static final Integer ACL_DEFAULT_PRIORITY = 100;
    public static final Integer ACL_PORT_SPECIFIC_DROP_PRIORITY = 50;
    ...
    public static final int INVALID_ACL_TAG = -1;
    public static final int TRACKED_CT_STATE = 0x20;
    public static final int TRACKED_CT_STATE_MASK = 0x20;

    public static final String ACL_TAG_POOL_NAME = "ACL-TAG-POOL";
