...
public final class AclServiceUtils {
    ...
    public static java.util.Optional<BigInteger> getDpIdFromIterfaceState(org.opendaylight.yang.gen.v1.urn
        ...
        if (ofportIds != null && !ofportIds.isEmpty()) {
            ...
            return java.util.Optional.of(BigInteger.valueOf(MDSALUtil.getDpnIdFromPortName(nodeConnectorId)));
        } else {
    ...
    public static java.util.Optional<Long> getElanIdFromInterface(String elanInterfaceName, DataBroker broker) {
    ...
    public static java.util.Optional<ElanInterface> getElanInterfaceByElanInterfaceName(String elanInterfaceName,
            DataBroker broker) {
        InstanceIdentifier<ElanInterface> elanInterfaceId = getElanInterfaceConfigurationDataPathId(elanInterfaceName);
        return Optionals.of(read(broker, LogicalDatastoreType.CONFIGURATION, elanInterfaceId));
    }
    ...
    public static java.util.Optional<ElanInstance> getElanInstanceByName(String elanInstanceName, DataBroker broker) {
        InstanceIdentifier<ElanInstance> elanIdentifierId = getElanInstanceConfigurationDataPath(elanInstanceName);
        return Optionals.of(read(broker, LogicalDatastoreType.CONFIGURATION, elanIdentifierId));
    }
