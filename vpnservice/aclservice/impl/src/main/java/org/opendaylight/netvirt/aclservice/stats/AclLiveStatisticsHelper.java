...
public final class AclLiveStatisticsHelper {
    ...
    public static List<AclInterfaceStats> getAclInterfaceStats(Direction direction, List<String> interfaceNames,
        ...
        for (String interfaceName : interfaceNames) {
            ...
            if (rpcResult != null && rpcResult.isSuccessful() && rpcResult.getResult() != null) {
                ...
                handleRpcErrors(lstAclInterfaceStats, aclStatsBuilder, rpcResult);
            }
        }
     ...
     */
    private static void handleRpcErrors(List<AclInterfaceStats> lstAclInterfaceStats,
            AclInterfaceStatsBuilder aclStatsBuilder, RpcResult<GetFlowStatisticsOutput> rpcResult) {
