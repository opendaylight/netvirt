...
public final class Optionals {
    ...
    public static <T> IfPresentElse ifPresent(
            com.google.common.base.Optional<T> guavaOptional, Consumer<? super T> consumer) {
        return ifPresent(of(guavaOptional), consumer);
    }
