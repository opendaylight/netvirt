...
public class StatefulIngressAclServiceImpl extends AbstractIngressAclServiceImpl {
    ...
    protected String syncSpecificAclFlow(BigInteger dpId, int lportTag, int addOrRemove, Ace ace, String portId,
        ...
        List<InstructionInfo> instructions = createInstructionForAclFlow(lportTag, ace, portId, flowMap,
                flowName, ServiceModeIngress.class);
        ...
        String dropFlowName = flowName + "Ingress" + lportTag + "_DropAfterRuleDeleted";
            ...
            syncFlow(dpId, NwConstants.EGRESS_ACL_FILTER_TABLE, dropFlowName,
                    AclConstants.CT_STATE_DROP_FLOW_PRIORITY, "ACL", AclConstants.DROP_FLOW_IDLE_TIMOUT,
                        AclConstants.DROP_FLOW_HARD_TIMOUT, AclConstants.COOKIE_ACL_BASE, dropMatches,
                            instructions, NwConstants.DEL_FLOW);
        } else {
            syncFlow(dpId, NwConstants.EGRESS_ACL_FILTER_TABLE, dropFlowName, AclConstants.CT_STATE_DROP_FLOW_PRIORITY,
                   "ACL", AclConstants.DROP_FLOW_IDLE_TIMOUT, AclConstants.DROP_FLOW_HARD_TIMOUT,
                        AclConstants.COOKIE_ACL_BASE, dropMatches, instructions, NwConstants.ADD_FLOW);
        }
        return flowName;
    }
