...
public class PolicyProfileChangeListener
    ...
    protected void remove(InstanceIdentifier<PolicyProfile> key, PolicyProfile policyProfile) {
        ...
        routeGroupProgramer.updatePolicyClassifierGroups(policyClassifier, underlayNetworks, NwConstants.DEL_FLOW);
        ...
        policyIdManager.releasePolicyClassifierGroupId(policyClassifier);
    ...
    protected void add(InstanceIdentifier<PolicyProfile> key, PolicyProfile policyProfile) {
        ...
        routeGroupProgramer.updatePolicyClassifierGroups(policyClassifier, underlayNetworks, NwConstants.ADD_FLOW);
