...
public class PolicyProfileChangeListener
    ...
    protected void remove(InstanceIdentifier<PolicyProfile> key, PolicyProfile policyProfile) {
        ...
        routeGroupProgramer.programPolicyClassifierGroups(policyClassifier, dpnIds, NwConstants.DEL_FLOW);
        updatePolicyAclRules(policyClassifier, underlayNetworks, NwConstants.DEL_FLOW);
        routeFlowProgrammer.programPolicyClassifierFlows(policyClassifier, underlayNetworks, NwConstants.DEL_FLOW);
    ...
    protected void add(InstanceIdentifier<PolicyProfile> key, PolicyProfile policyProfile) {
        ...
        List<BigInteger> dpnIds = policyServiceUtil.getUnderlayNetworksDpns(underlayNetworks);
        routeGroupProgramer.programPolicyClassifierGroups(policyClassifier, dpnIds, NwConstants.ADD_FLOW);
        ...
        routeFlowProgrammer.programPolicyClassifierFlows(policyClassifier, underlayNetworks, NwConstants.ADD_FLOW);
    }
