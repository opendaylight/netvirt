...
public class PolicyIdManager {
    ...
    public long getPolicyClassifierGroupId(String policyClassifier, BigInteger dpId) {
        return allocateId(policyClassifier + '-' + dpId, PolicyServiceConstants.POLICY_GROUP_POOL_NAME);
    }

    public void releasePolicyClassifierGroupId(String policyClassifierName, BigInteger dpId) {
        releaseId(policyClassifierName, PolicyServiceConstants.POLICY_GROUP_POOL_NAME);
    }
    ...
    private void createIdPools() {
        ...
        createIdPool(PolicyServiceConstants.POLICY_GROUP_POOL_NAME,
                PolicyServiceConstants.POLICY_GROUP_LOW_ID, PolicyServiceConstants.POLICY_GROUP_HIGH_ID);
    }
