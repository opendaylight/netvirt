...
public class PolicyIdManager {
    ...
    public long getPolicyClassifierGroupId(String policyClassifierName, BigInteger dpId) {
        return allocateId(getPolicyClassifierGroupKey(policyClassifierName, dpId),
                PolicyServiceConstants.POLICY_GROUP_POOL_NAME);
    }

    public void releasePolicyClassifierGroupId(String policyClassifierName, BigInteger dpId) {
        releaseId(getPolicyClassifierGroupKey(policyClassifierName, dpId),
                PolicyServiceConstants.POLICY_GROUP_POOL_NAME);
    }

    public static String getPolicyClassifierGroupKey(String policyClassifier, BigInteger dpId) {
