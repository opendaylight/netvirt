...
public class PolicyServiceUtil {
    ...
    public String getAcePolicyClassifier(Ace ace) {
        ...
        try {
            ...
            LOG.warn("Failed to parse policy classifier direction {}", setPolicyClassifier.getDirection());
            return null;
        }
    ...
    private Map<String, String> getOpenvswitchOtherConfigMap(Node node) {
        String localIps = southboundUtils.getOpenvswitchOtherConfig(node, LOCAL_IPS);
        return extractMultiKeyValueToMap(localIps);
    }
