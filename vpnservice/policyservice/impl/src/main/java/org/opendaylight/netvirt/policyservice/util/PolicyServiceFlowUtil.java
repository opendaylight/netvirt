...
public class PolicyServiceFlowUtil {
    ...
    public List<InstructionInfo> getPolicyClassifierInstructions(long policyClassifierId) {
        ...
        // policy classifier should be written to reg6 once genius will add support for
        // masked matching on nicira registers
        instructions.add(new InstructionWriteMetadata(MetaDataUtil.getClassifierMetaData(policyClassifierId),
