...
public class VPNServiceChainHandlerTest {
    ...
    public void testprogramScfToVpnPipeline() throws Exception {
        ...
        stubGetVrfEntries(RD, Collections.singletonList(FibHelper.buildVrfEntry("11.12.13.14", 2000L, DC_GW_IP, RouteOrigin.STATIC).build()));
    ...
    public void testProgramVpnToScfPipeline() throws Exception {
        ...
        stubGetRouteDistinguisher(VPN_NAME, RD);
        stubGetVpnInstance(RD);
        VrfEntry vrfEntry = FibHelper.buildVrfEntry("11.12.13.14", 2000L, DC_GW_IP, RouteOrigin.STATIC).build();
        ...
        FlowEntity expectedLFibFlowEntity =
            VpnServiceChainUtils.buildLFibVpnPseudoPortFlow(DPN_ID, vrfEntry.getRoutePaths().get(0).getLabel(),
                                                            vrfEntry.getRoutePaths().get(0).getNexthopAddress(), LPORT_TAG);
