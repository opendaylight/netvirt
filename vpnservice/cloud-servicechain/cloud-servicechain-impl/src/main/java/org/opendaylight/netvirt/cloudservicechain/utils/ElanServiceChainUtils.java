...
import org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.cloud.servicechain.state.rev160711.elan.to.pseudo.port.data.list.ElanToPseudoPortDataBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.cloud.servicechain.state.rev160711.elan.to.pseudo.port.data.list.ElanToPseudoPortDataKey;
...
public class ElanServiceChainUtils {
    ...
    public static void updateElanToLportTagMap(final DataBroker broker, final String elanInstanceName,
        ...
        ElanToPseudoPortDataKey key = new ElanToPseudoPortDataKey(Long.valueOf(lportTag), scfTag);
        ...
        if (addOrRemove == NwConstants.ADD_FLOW) {
            ElanToPseudoPortData newValue =
                    new ElanToPseudoPortDataBuilder().setKey(key).setElanLportTag(Long.valueOf(lportTag))
