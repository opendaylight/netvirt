...
public class VpnServiceChainUtils {
    ...
    public static void programLFibEntriesForSCF(IMdsalApiManager mdsalMgr, BigInteger dpId, List<VrfEntry> vrfEntries,
        ...
        java.util.Optional.ofNullable(vrfEntries).map(entries -> {
            entries.stream()
                    ...
                    .forEach(routePath -> {
                        ...
                        LOG.debug(
                                "LFIB Entry for label={}, destination={}, nexthop={} {} successfully in dpn={}",
            ...
            LOG.warn("LFIB entry not modified since vrfEntry list is null/empty");
            return null;
        });
    }
