...
public class AbstractNetOvs implements NetOvs {
    ...
    @Override
    public String createRouterInterface(String routerName, String networkName, String ipPfx) {
        PortInfo portInfo = new PortInfo(-1, NetvirtITConstants.GATEWAY_SUFFIX, ipPfx);
    ...
    @Override
    public void preparePortForPing(String portName, String ipPfx) throws InterruptedException, IOException {
    }
