...
import org.opendaylight.netvirt.federation.plugin.FederatedSecurityGroupPair;
...
public class AbstractEnd2EndTest {
    ...
    public void initialization() {
        ...
        List<FederatedSecurityGroupPair> federatedSecurityGroupsPairs =
            Arrays.asList(new FederatedSecurityGroupPair(CONSUMER_SEC_GROUP_ID, PRODUCER_SEC_GROUP_ID));
