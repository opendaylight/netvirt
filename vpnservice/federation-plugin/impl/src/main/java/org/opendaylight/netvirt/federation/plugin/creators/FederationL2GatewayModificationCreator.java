...
public class FederationL2GatewayModificationCreator
        implements FederationPluginModificationCreator<L2gateway, Neutron> {
    ...
    @Override
    public Collection<DataTreeModification<L2gateway>> createDataTreeModifications(Neutron neutron) {
        if (neutron == null || neutron.getL2gateways() == null) {
            LOG.debug("No L2 Gateways found");
