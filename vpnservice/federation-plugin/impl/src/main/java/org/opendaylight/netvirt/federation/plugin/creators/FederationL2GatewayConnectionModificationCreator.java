...
public class FederationL2GatewayConnectionModificationCreator
        implements FederationPluginModificationCreator<L2gatewayConnection, Neutron> {
    ...
    @Override
    public Collection<DataTreeModification<L2gatewayConnection>> createDataTreeModifications(Neutron neutron) {
        if (neutron == null || neutron.getL2gatewayConnections() == null) {
            LOG.debug("No L2 Gateways connections found");
