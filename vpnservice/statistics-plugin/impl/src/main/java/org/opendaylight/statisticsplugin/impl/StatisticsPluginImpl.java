...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.statistics.plugin.rev150105.result.Groups;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.statistics.plugin.rev150105.result.GroupsBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.statistics.plugin.rev150105.result.groups.Counters;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.statistics.plugin.rev150105.result.groups.CountersBuilder;
...
public class StatisticsPluginImpl implements StatisticsPluginService {
    ...
    public Future<RpcResult<GetNodeConnectorCountersOutput>> getNodeConnectorCounters(GetNodeConnectorCountersInput input) {
        ...
        try {
            if (!getNodeConnectorResult(groups, dpId, portNumber)) {
        ...
        gpcob.setGroups(groups);
        return RpcResultBuilder.success(gpcob.build()).buildFuture();
    }

    
    
    private boolean getNodeConnectorResult(List<Groups> groups, BigInteger dpId, String portNumber)
