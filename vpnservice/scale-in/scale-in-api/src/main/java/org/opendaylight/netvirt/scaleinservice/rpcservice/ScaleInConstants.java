...
public final class ScaleInConstants {
    ...
    public static final InstanceIdentifier<Topology> OVSDB_NODE_IID = InstanceIdentifier.create(NetworkTopology.class)
            .child(Topology.class, new TopologyKey(OVSDB_TOPOLOGY_ID));
    public static final InstanceIdentifier<BridgeExternalIds> EXTERNAL_IID
            = InstanceIdentifier.create(NetworkTopology.class)
            .child(Topology.class, new TopologyKey(OVSDB_TOPOLOGY_ID))
            .child(Node.class).augmentation(OvsdbBridgeAugmentation.class)
            .child(BridgeExternalIds.class, new BridgeExternalIdsKey(TOMBSTONED));

    private ScaleInConstants() {
    }

    public static InstanceIdentifier<BridgeExternalIds> buildBridgeExternalIids(String nodeId) {
        return OVSDB_NODE_IID
