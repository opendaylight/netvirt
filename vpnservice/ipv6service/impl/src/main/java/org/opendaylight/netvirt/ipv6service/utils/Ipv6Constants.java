...
public class Ipv6Constants {
    ...
    // TODO: ServiceBinding constants have to be used from genius headers.
    public static final short IPV6_SERVICE_INDEX = 3;
    public static final short IPV6_TABLE = (short) 45;
    public static final BigInteger COOKIE_IPV6_BASE = new BigInteger("4000000", 16);
    public static final BigInteger COOKIE_VM_INGRESS_TABLE = new BigInteger("4000001", 16);
