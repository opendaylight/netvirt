...
import org.opendaylight.netvirt.ipv6service.utils.Ipv6RtrAdvertType;
...
public class Ipv6PktHandler implements AutoCloseable, PacketProcessingListener {
    ...
    private class PacketHandler implements Runnable {
        ...
        private void processRouterSolicitationRequest() {
            ...
            ipv6RouterAdvert.transmitRtrAdvertisement(Ipv6RtrAdvertType.SOLICITED_ADVERTISEMENT, routerPort,
                                                      packet.getIngress(), rsPdu);
            pktProccessedCounter++;
        }
