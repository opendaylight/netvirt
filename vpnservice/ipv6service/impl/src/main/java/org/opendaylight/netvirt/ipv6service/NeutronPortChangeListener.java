...
public class NeutronPortChangeListener extends AbstractDataChangeListener<Port> implements AutoCloseable {
    ...
    private void registerListener(final DataBroker db) {
        try {
            ...
            LOG.error("IPv6Service Neutron Port DataChange listener registration failed!", e);
            throw new IllegalStateException("IPv6Service Neutron Port DataChange listener registration failed.", e);
        }
    }
