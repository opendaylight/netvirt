...
public class NeutronPortChangeListener extends AbstractDataChangeListener<Port> implements AutoCloseable {
    ...
    private void registerListener(final DataBroker db) {
        try {
            ...
            LOG.error("IPv6service Manager Port DataChange listener registration fail!", e);
            throw new IllegalStateException("IPv6service Manager Port DataChange listener registration failed.", e);
        }
    }
