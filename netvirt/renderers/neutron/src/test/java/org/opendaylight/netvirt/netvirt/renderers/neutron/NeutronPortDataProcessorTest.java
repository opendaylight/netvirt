...
public class NeutronPortDataProcessorTest extends AbstractDataBrokerTest {
    ...
    public void testRemove() throws Exception {
        //Create NeutronPortDataProcessor
        org.opendaylight.yang.gen.v1.urn.opendaylight.netvirt.ports.rev151227.ports.Port netvirtPort;
        ...
        netvirtPort = readFromMdSal(neutronPort.getUuid());
    ...
    public void testUpdate() throws Exception {
        ...
        netvirtPort = readFromMdSal(neutronPort1.getUuid());
        assertNotNull(netvirtPort);
