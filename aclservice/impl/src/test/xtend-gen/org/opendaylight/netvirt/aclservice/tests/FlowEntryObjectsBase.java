...
public class FlowEntryObjectsBase {
  ...
  protected Iterable<FlowEntity> fixedEgressFlowsPort1() {
    ...
    final Procedure1<FlowEntityBuilder> _function_1 = (FlowEntityBuilder it) -> {
      it.setDpnId(BigInteger.valueOf(123L));
      it.setCookie(BigInteger.valueOf(110100480L));
      it.setFlowId("Egress_DHCP_Client_v6_123_987_0D:AA:D8:42:30:F3_Permit_");
      it.setFlowName("ACL");
      ActionNxResubmit _actionNxResubmit = new ActionNxResubmit(((short) 17));
      InstructionApplyActions _instructionApplyActions = new InstructionApplyActions(
        Collections.<ActionInfo>unmodifiableList(CollectionLiterals.<ActionInfo>newArrayList(_actionNxResubmit)));
    ...
    return Iterables.<FlowEntity>concat(Collections.<FlowEntity>unmodifiableList(CollectionLiterals.<FlowEntity>newArrayList(_doubleGreaterThan, _doubleGreaterThan_1, _doubleGreaterThan_2, _doubleGreaterThan_3, _doubleGreaterThan_4, _doubleGreaterThan_5, _doubleGreaterThan_6, _doubleGreaterThan_7)), _fixedEgressArpFlowsPort1);
  }
  ...
  protected Iterable<FlowEntity> fixedEgressFlowsPort2() {
    ...
    final Procedure1<FlowEntityBuilder> _function_1 = (FlowEntityBuilder it) -> {
      it.setDpnId(BigInteger.valueOf(123L));
      it.setCookie(BigInteger.valueOf(110100480L));
      it.setFlowId("Egress_DHCP_Client_v6_123_987_0D:AA:D8:42:30:F4_Permit_");
      it.setFlowName("ACL");
      ActionNxResubmit _actionNxResubmit = new ActionNxResubmit(((short) 17));
      InstructionApplyActions _instructionApplyActions = new InstructionApplyActions(
        Collections.<ActionInfo>unmodifiableList(CollectionLiterals.<ActionInfo>newArrayList(_actionNxResubmit)));
    ...
    return Iterables.<FlowEntity>concat(Collections.<FlowEntity>unmodifiableList(CollectionLiterals.<FlowEntity>newArrayList(_doubleGreaterThan, _doubleGreaterThan_1, _doubleGreaterThan_2, _doubleGreaterThan_3, _doubleGreaterThan_4, _doubleGreaterThan_5, _doubleGreaterThan_6, _doubleGreaterThan_7)), _fixedEgressArpFlowsPort2);
  }
  ...
  protected List<FlowEntity> fixedEgressFlowsPort3() {
    ...
    final Procedure1<FlowEntityBuilder> _function_1 = (FlowEntityBuilder it) -> {
      it.setDpnId(BigInteger.valueOf(123L));
      it.setCookie(BigInteger.valueOf(110100480L));
      it.setFlowId("Egress_DHCP_Client_v6_123_987_0D:AA:D8:42:30:F5_Permit_");
      it.setFlowName("ACL");
      ActionNxResubmit _actionNxResubmit = new ActionNxResubmit(((short) 17));
      InstructionApplyActions _instructionApplyActions = new InstructionApplyActions(
        Collections.<ActionInfo>unmodifiableList(CollectionLiterals.<ActionInfo>newArrayList(_actionNxResubmit)));
