            ...
            switch (flowStats.getTableId()) {
                case NwConstants.INGRESS_ACL_FILTER_CUM_DISPATCHER_TABLE:
                    if (flowStats.getPriority().equals(AclConstants.CT_STATE_TRACKED_INVALID_PRIORITY)) {
                        ...
                        portEgressBytesBuilder.setDropCount(portEgressBytesBuilder.getDropCount().add(flowStats.getByteCount().getValue()));
                        portEgressPacketsBuilder.setDropCount(portEgressPacketsBuilder.getDropCount().add(flowStats.getPacketCount().getValue()));
                ...
                case NwConstants.EGRESS_ACL_FILTER_CUM_DISPATCHER_TABLE:
                    if (flowStats.getPriority().equals(AclConstants.CT_STATE_TRACKED_INVALID_PRIORITY)) {
                        ...
                        portIngressBytesBuilder.setDropCount(portIngressBytesBuilder.getDropCount().add(flowStats.getByteCount().getValue()));
                        portIngressPacketsBuilder.setDropCount(portIngressPacketsBuilder.getDropCount().add(flowStats.getPacketCount().getValue()));
                    } else if (flowStats.getPriority().equals(AclConstants.ACE_LAST_REMOTE_ACL_PRIORITY)) {
                        portIngressBytesBuilder.setDropCount(portIngressBytesBuilder.getDropCount().add(flowStats.getByteCount().getValue()));
                        portIngressPacketsBuilder.setDropCount(portIngressPacketsBuilder.getDropCount().add(flowStats.getPacketCount().getValue()));
                    }
