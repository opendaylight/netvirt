...
public abstract class AbstractAclServiceImpl implements AclServiceListener {
    ...
    protected void syncFlow(BigInteger dpId, String interfaceId, short tableId, String flowId, int priority,
        ...
        jobCoordinator.enqueueJob((AclConstants.ACL_FLOW_NAME + interfaceId), () -> {
            if (addOrRemove == NwConstants.DEL_FLOW) {
                FlowEntity flowEntity = MDSALUtil.buildFlowEntity(dpId, tableId, flowId, priority,
                        AclConstants.ACL_FLOW_NAME, idleTimeOut, hardTimeOut, cookie, matches, null);
                ...
                FlowEntity flowEntity = MDSALUtil.buildFlowEntity(dpId, tableId, flowId, priority,
                        AclConstants.ACL_FLOW_NAME, idleTimeOut, hardTimeOut, cookie, matches, instructions);
