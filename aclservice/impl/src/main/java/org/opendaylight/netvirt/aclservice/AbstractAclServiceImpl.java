...
public abstract class AbstractAclServiceImpl implements AclServiceListener {
    ...
    public boolean applyAcl(AclInterface port) {
        ...
        if (port.getInterfaceType() == InterfaceType.DhcpService) {
            ...
            programAclWithAllowedAddress(flowEntries, port, port.getAllowedAddressPairs(), Action.ADD, NwConstants.ADD_FLOW);
    ...
    public boolean removeAcl(AclInterface port) {
        ...
        if (port.getInterfaceType() == InterfaceType.DhcpService) {
            ...
            programAclWithAllowedAddress(flowEntries, port, port.getAllowedAddressPairs(), Action.REMOVE, NwConstants.DEL_FLOW);
