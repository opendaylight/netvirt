    ...
    public void recoverService(String entityId) {
        ...
        for (AclInterface aclInterface : aclInterfaces) {
            ...
            if (interfaceOptional.isPresent()) {
                ...
                Interface interfaceAfter = new InterfaceBuilder(interfaceBefore).build();
                InterfaceAcl interfaceAclAfter = interfaceAfter.getAugmentation(InterfaceAcl.class);
                List<Uuid> sgList = interfaceAclAfter.getSecurityGroups();
                sgList.remove(aclId);
