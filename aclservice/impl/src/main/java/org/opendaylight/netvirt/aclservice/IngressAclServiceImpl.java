...
public class IngressAclServiceImpl extends AbstractAclServiceImpl {
    ...
    private void programCommitterDropFlow(BigInteger dpId, int lportTag, int addOrRemove) {
        ...
        BigInteger metaData = MetaDataUtil.getLportTagMetaData(lportTag)
                .or(MetaDataUtil.getAntiSpoofDropStatFlowMetaData(AclConstants.ANTI_SPOOF_CLASSIFIER_TYPE));
        BigInteger metaDataMask =
                MetaDataUtil.METADATA_MASK_LPORT_TAG.or(MetaDataUtil.METADATA_ANTI_SPOOF_DROP_STAT);
