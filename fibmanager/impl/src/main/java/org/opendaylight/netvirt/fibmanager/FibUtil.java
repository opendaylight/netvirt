...
public class FibUtil {
    ...
    static InstanceIdentifier<VpnInstanceOpDataEntry> getVpnInstanceOpDataIdentifier(String vpnInstanceName) {
        return InstanceIdentifier.builder(VpnInstanceOpData.class)
            .child(VpnInstanceOpDataEntry.class, new VpnInstanceOpDataEntryKey(vpnInstanceName)).build();
    }

    Optional<VpnInstanceOpDataEntry> getVpnInstanceOpData(String vpnInstanceName) {
        InstanceIdentifier<VpnInstanceOpDataEntry> id = getVpnInstanceOpDataIdentifier(vpnInstanceName);
        return MDSALUtil.read(dataBroker, LogicalDatastoreType.OPERATIONAL, id);
    }

    VpnInstanceOpDataEntry getVpnInstance(String vpnInstanceName) {
        InstanceIdentifier<VpnInstanceOpDataEntry> id =
                InstanceIdentifier.create(VpnInstanceOpData.class)
                        .child(VpnInstanceOpDataEntry.class, new VpnInstanceOpDataEntryKey(vpnInstanceName));
     ...
     * @param vpnInstanceName The vpn instance uuid
     *
     * @return The vpn instance
     */
    public Optional<String> getVpnNameFromRd(String vpnInstanceName) {
        return Optional.fromJavaUtil(
                getVpnInstanceOpData(vpnInstanceName).toJavaUtil().map(VpnInstanceOpDataEntry::getVpnInstanceName));
    }
    ...
    public void updateUsedRdAndVpnToExtraRoute(WriteTransaction writeOperTxn, String tunnelIpRemoved,
                                               String vpnInstanceName, String primaryRd, String prefix) {
        Optional<VpnInstanceOpDataEntry> optVpnInstance = getVpnInstanceOpData(vpnInstanceName);
