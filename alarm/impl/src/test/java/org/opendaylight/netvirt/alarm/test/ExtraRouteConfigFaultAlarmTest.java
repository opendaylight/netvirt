...
public class ExtraRouteConfigFaultAlarmTest {
    ...
    public void testNeutronvpnMoreNextHopThanRD() {
        ...
        neutronvpnAlarmTest.raiseNeutronvpnAlarm(typeAlarm, detailsAlarm);
        neutronvpnAlarmTest.raiseNeutronvpnAlarm(typeAlarm + "_Second", detailsAlarm);
        ...
        neutronvpnAlarmTest.clearNeutronvpnAlarm(typeAlarm, detailsAlarm);

        neutronvpnAlarmTest.clearNeutronvpnAlarm(typeAlarm + "_Second", detailsAlarm);
