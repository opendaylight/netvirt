...
public class StatisticsCounters {
    ...
    public StatisticsCounters(MetricProvider metricProvider) {
        ...
        this.failedGettingNodeCountersMeter = meter("failed_getting_node_counters");
        this.failedGettingNodeConnectorCountersMeter = meter("failed_getting_node_connector_counters");
        this.failedGettingAggregatedNodeCountersMeter = meter("failed_getting_aggregated_node_counters");
        this.failedGeneratingUniqueRequestIdMeter = meter("failed_generating_unique_request_id");
        this.unknownRequestHandlerMeter = meter("unknown_request_handler");
        this.failedCreatingIngressCounterDataConfigMeter = meter("failed_creating_ingress_counter_data_config");
        this.failedCreatingEgressCounterDataConfigMeter = meter("failed_creating_egress_counter_data_config");
        this.failedReadingCounterDataFromConfigMeter = meter("failed_reading_counter_data_from_config");
        this.failedGettingCounterResultsMeter = meter("failed_getting_counter_results");
        this.failedCreatingCountersConfigMeter = meter("failed_creating_counters_config");
        this.failedGettingCounterResultsPortRemovalMeter = meter("failed_getting_counter_results_port_removal");
        this.ingressCountersServiceBindMeter = meter("ingress_counters_service_bind");
        this.egressCountersServiceBindMeter = meter("egress_counters_service_bind");
        this.ingressCountersServiceUnbindMeter = meter("ingress_counters_service_unbind");
        this.egressCountersServiceUnbindMeter = meter("egress_counters_service_unbind");
        this.failedGettingFlowCountersMeter = meter("failed_getting_flow_counters");
        this.failedGettingRpcResultForNodeConnectorCountersMeter =
                meter("failed_getting_rpc_result_for_node_connector_counters");
        this.failedGettingResultMapForNodeConnectorCountersMeter =
                meter("failed_getting_result_map_for_node_connector_counters");
    }
