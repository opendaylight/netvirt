...
*/
    ...
    public void removeNaptFlowsFromActiveSwitch(long routerId, String routerName,
        ...
        LOG.info("removeNaptFlowsFromActiveSwitch : Remove the flow in table {} for the active switch with the "
                 + "DPN ID {} and router ID {}", NwConstants.NAPT_PFIB_TABLE, dpnId, routerId);
        mdsalManager.removeFlowToTx(natPfibFlowEntity, removeFlowInvTx);
