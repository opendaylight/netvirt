...
public class VxlanGreConntrackBasedSnatService extends ConntrackBasedSnatService {
    ...
    public VxlanGreConntrackBasedSnatService(DataBroker dataBroker, IMdsalApiManager mdsalManager,
            ...
            NAPTSwitchSelector naptSwitchSelector, ExternalRoutersListener externalRouterListener,
            IElanService elanManager, final IFibManager fibManager, final IInterfaceManager interfaceManager,
        ...
        super(dataBroker, mdsalManager, itmManager, odlInterfaceRpcService, idManager, naptSwitchSelector,
                fibManager, interfaceManager, natDataUtil);
