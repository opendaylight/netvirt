    ...
    */
    ...
    public static Boolean validateIsIntefacePartofRouter(DataBroker broker, String routerName, String interfaceName) {
        ...
        try {
            ...
            LOG.error("Read Failed Exception While read RouterInterface data for router {}", routerName);
    ...
    */
    ...
    public static Boolean isRouterInterfacePort(DataBroker broker, String ifaceName) {
        ...
        if (neutronPort == null) {
            ...
            return (neutronPort.getDeviceOwner().equalsIgnoreCase(NatConstants.NETWORK_ROUTER_INTERFACE) ? Boolean.TRUE
                : Boolean.FALSE);
        }
    }
    ...
    private static Port getNeutronPort(DataBroker broker, String ifaceName) {
        ...
        try {
            ...
            LOG.error("Read Failed Exception While Reading Neutron Port for {}", ifaceName);
            portsOptional = Optional.absent();
        }
        if (!portsOptional.isPresent()) {
            LOG.error("getNeutronPort : No neutron ports found");
            return null;
        }
