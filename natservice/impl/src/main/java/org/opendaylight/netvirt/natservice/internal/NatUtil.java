...
public final class NatUtil {
    ...
    */
    ...
    @Nullable
    public static NeutronVpnPortipPortData getNeutronVpnVipToPortData(DataBroker dataBroker) {
        try {
            return SingleTransactionDataBroker.syncRead(dataBroker,
                    LogicalDatastoreType.OPERATIONAL, getNeutronVpnVipToPortDataId());
        }
        catch (ReadFailedException e) {
    ...
    public static InstanceIdentifier<NeutronVpnPortipPortData> getNeutronVpnVipToPortDataId() {
        return InstanceIdentifier.builder(NeutronVpnPortipPortData.class).build();
    }
