...
public final class NatUtil {
    ...
    */
    ...
    public static void addPseudoPortToElanDpn(String elanInstanceName, String routerInterfacePortId,
    ...
    public static void removePseudoPortFromElanDpn(String elanInstanceName, String routerInterfacePortId,
            BigInteger dpnId, DataBroker dataBroker) {
        InstanceIdentifier<DpnInterfaces> elanDpnInterfaceId = getElanDpnInterfaceOperationalDataPath(
                elanInstanceName,dpnId);
        try {
