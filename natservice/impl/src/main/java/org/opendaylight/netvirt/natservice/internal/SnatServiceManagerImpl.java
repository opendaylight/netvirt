...
public class SnatServiceManagerImpl implements SnatServiceManager {
    ...
    public SnatServiceManagerImpl(final SnatServiceImplFactory factory) {
        ...
        Ipv6ForwardingService ipv6ForwardingServiceImpl = factory.createFlatVlanIpv6ServiceImpl();
        if (ipv6ForwardingServiceImpl != null) {
            addNatServiceListener(ipv6ForwardingServiceImpl);
        }
