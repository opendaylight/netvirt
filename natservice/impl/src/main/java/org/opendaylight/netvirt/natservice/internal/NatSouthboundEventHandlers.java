...
public class NatSouthboundEventHandlers {
    ...
    void handleRouterInterfacesDownEvent(String routerName, String interfaceName, BigInteger dpnId,
        ...
        NatUtil.removeFromNeutronRouterDpnsMap(dataBroker, routerName, dpnId, writeOperTxn);
                ...
                synchronized (dpnLock.intern()) {
                    ...
                    futures.add(txRunner.callWithNewReadWriteTransactionAndSubmit(tx -> {
                        if (state.equals(IntfTransitionState.STATE_DOWN)) {
                            ...
                            NatUtil.removeFromNeutronRouterDpnsMap(dataBroker, routerName, interfaceName,
                                    intfDpnId, tx);
    ...
    private void processInterfaceAdded(String portName, String routerId, BigInteger dpnId, VipState vipState) {
        ...
        future.addListener(() -> {
            if (vipState != null) {
                this.vipStateTracker.writeVipState(vipState);
            }
