...
public class NaptPacketInHandler implements PacketProcessingListener {
    ...
    private static final  ConcurrentMap<String,NatPacketProcessingState> INCOMING_PACKET_MAP = new ConcurrentHashMap<>();
            ...
            if (inPayload != null) {
                ...
                if (internalIPAddress != null) {
                    ...
                    if (state == null) {
                        ...
                        INCOMING_PACKET_MAP.put(sourceIPPortKey, state);
