        ...
        */
        ...
        for (final String externalIp : externalIps) {
            ...
            if (extNwProvType == ProviderTypes.VXLAN) {
                ...
                Uint32 label = externalRouterListner.checkExternalIpLabel(routerId,
                        externalIp);
        ...
        for (Ports port : routerPorts.nonnullPorts()) {
            ...
            for (InternalToExternalPortMap intExtPortMap : port.nonnullInternalToExternalPortMap()) {
                ...
                if (extNwProvType == ProviderTypes.VXLAN) {
                    ...
                    Uint32 label = floatingIPListener.getOperationalIpMapping(routerName, interfaceName, internalIp);
