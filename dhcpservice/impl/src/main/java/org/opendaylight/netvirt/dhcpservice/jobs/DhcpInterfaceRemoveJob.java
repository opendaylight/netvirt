...
public class DhcpInterfaceRemoveJob implements Callable<List<? extends ListenableFuture<?>>> {
    ...
    @Override
    public List<? extends ListenableFuture<?>> call() throws ExecutionException, InterruptedException {
    ...
    private List<? extends ListenableFuture<?>> unInstallDhcpEntries(String interfaceName, Uint64 dpId)
