...
public class DhcpPktHandler implements PacketProcessingListener {
    ...
    public DhcpPktHandler(final DhcpManager dhcpManager,
        ...
        this.pktDropCounter = metricProvider.newCounter(buildDhcpMetricDescriptor("packet.drop"),
                "mac", "interface", "reason");
        this.pktInCounter = metricProvider.newCounter(buildDhcpMetricDescriptor("packet.in"), "mac");
    }
