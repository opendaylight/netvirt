...
@Singleton
public class HwvtepPhysicalSwitchChildListener extends AsyncDataTreeChangeListenerBase<PhysicalSwitchAugmentation,
        HwvtepPhysicalSwitchChildListener> implements ClusteredDataTreeChangeListener<PhysicalSwitchAugmentation> {
    ...
    @Override
    protected HwvtepPhysicalSwitchChildListener getDataTreeChangeListener() {
        return HwvtepPhysicalSwitchChildListener.this;
    }
