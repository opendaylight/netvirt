...
public class AssociateHwvtepToElanJob implements Callable<List<ListenableFuture<Void>>> {
    ...
    public List<ListenableFuture<Void>> call() throws Exception {
        ...
        ListenableFuture<Void> lsCreateFuture = createLogicalSwitch();
    ...
    private ListenableFuture<Void> createLogicalSwitch() {
        ...
        ListenableFuture<Void> lsCreateFuture = HwvtepUtils.addLogicalSwitch(dataBroker, hwvtepNodeId, logicalSwitch);
