...
public class TerminationPointCmd extends MergeCommand<TerminationPoint, NodeBuilder, Node> {
    ...
    public boolean areEqual(TerminationPoint updated, TerminationPoint orig) {
        ...
        List<VlanBindings> up = updatedAugmentation != null ? Arrays.asList(updatedAugmentation.nonnullVlanBindings()) : null;
        List<VlanBindings> or = origAugmentation != null ? Arrays.asList(origAugmentation.nonnullVlanBindings()) : null;
