...
public class ElanUtils {
    ...
    public void setupMacFlows(ElanInstance elanInfo, InterfaceInfo interfaceInfo,
                              ...
                              TypedWriteTransaction<Configuration> writeFlowGroupTx) throws ElanException {
    ...
    public static ElanInstance updateOperationalDataStore(IdManagerService idManager,
            ElanInstance elanInstanceAdded, List<String> elanInterfaces, TypedWriteTransaction<Operational> tx) {
        ...
        tx.put(getElanInstanceOperationalDataPath(elanInstanceName), elanInfo, CREATE_MISSING_PARENTS);
        ...
        tx.put(getElanMacTableOperationalDataPath(elanInstanceName), elanMacTable, CREATE_MISSING_PARENTS);
        ...
        // data-store
        tx.put(getElanInfoEntriesOperationalDataPath(elanTag), elanTagName);
        ...
        tx.merge(ElanHelper.getElanInstanceConfigurationDataPath(elanInstanceName), elanInstanceWithTag,
