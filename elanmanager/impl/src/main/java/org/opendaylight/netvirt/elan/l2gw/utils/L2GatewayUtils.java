...
public final class L2GatewayUtils {
    ...
    public static String getConfigDbVersion(DataBroker broker, NodeId nodeId) {
        ...
        try {
            ...
            LOG.error("Failed to created Node {} for retriving configDbVersion");
        }
        String dbVersion = "";
        if (hwvtepNode != null) {
    ...
    public static Node getHwVtepNode(DataBroker dataBroker, LogicalDatastoreType datastoreType, NodeId nodeId) throws ExecutionException, InterruptedException {
