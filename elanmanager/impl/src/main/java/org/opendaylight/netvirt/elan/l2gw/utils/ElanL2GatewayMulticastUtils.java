...
public class ElanL2GatewayMulticastUtils {
    ...
    public ListenableFuture<Void> handleMcastForElanL2GwDeviceAdd(String elanName, ElanInstance elanInstance,
        ...
        tx.put(LogicalDatastoreType.CONFIGURATION, tepPath,
                buildExternalTeps(device));
        JdkFutures.addErrorLogging(tx.submit(), LOG, "Failed to write to config external tep {}", tepPath);
    ...
    public List<ListenableFuture<Void>> handleMcastForElanL2GwDeviceDelete(String elanName,
        ...
        return Arrays.asList(updateMcastMacsFuture, deleteRemoteMcastMacFuture, tx.submit());
    }
