...
public class ElanBridgeManager implements IElanBridgeManager {
    ...
    private final SingleTransactionDataBroker stDataBroker;
     ...
     * @param singleTransactionDataBroker SingleTransactionDataBroker
     */
    @Inject
    public ElanBridgeManager(ElanConfig elanConfig, IInterfaceManager interfaceManager,
            SouthboundUtils southboundUtils, SingleTransactionDataBroker singleTransactionDataBroker) {
        //TODO: ClusterAware!!!??
        this.stDataBroker = singleTransactionDataBroker;
    ...
    private void copyBridgeToConfig(Node brIntNode) {
        ...
        try {
            this.stDataBroker.syncUpdate(LogicalDatastoreType.CONFIGURATION, brNodeIid, bridgeNodeBuilder.build());
