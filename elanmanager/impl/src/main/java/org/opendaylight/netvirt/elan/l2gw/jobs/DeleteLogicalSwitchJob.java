 ...
 */
public class DeleteLogicalSwitchJob implements Callable<List<FluentFuture<? extends @NonNull CommitInfo>>> {
    ...
    @Override
    public List<FluentFuture<? extends @NonNull CommitInfo>> call() {
        if (cancelled) {
        ...
        List<FluentFuture<? extends @NonNull CommitInfo>> futures = new ArrayList<>();
