...
public class ElanInterfaceManager extends AsyncDataTreeChangeListenerBase<ElanInterface, ElanInterfaceManager>
    ...
    * */
    ...
    List<ListenableFuture<Void>> addElanInterface(ElanInterface elanInterface,
        ...
        ListenableFuture<Void> future = txRunner.callWithNewReadWriteTransactionAndSubmit(OPERATIONAL, tx -> {
            ...
            if (holder.dpId != null && !holder.dpId.equals(ElanConstants.INVALID_DPN)) {
                synchronized (elanInstanceName.intern()) {
                    ...
                    Optional<DpnInterfaces> existingElanDpnInterfaces = tx.read(elanDpnInterfaces).get();
                    ...
                    if (holder.isFirstInterfaceInDpn) {
                        ...
                        if (!existingElanDpnInterfaces.isPresent()) {
                            holder.dpnInterfaces =
                                createElanInterfacesList(elanInstanceName, interfaceName, holder.dpId, tx);
                        } else {
                        ...
                        holder.dpnInterfaces =
                            updateElanDpnInterfacesList(elanInstanceName, holder.dpId, elanInterfaces, tx);
                    }
                }
            }
        ...
        futures.add(ElanUtils.waitForTransactionToComplete(future));
