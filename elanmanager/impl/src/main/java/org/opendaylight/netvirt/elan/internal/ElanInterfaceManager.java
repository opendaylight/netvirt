    ...
    * */
    ...
    private void setExternalTunnelTable(Uint64 dpnId, ElanInstance elanInfo,
        ...
        FlowEntity flowEntity = MDSALUtil.buildFlowEntity(dpnId, NwConstants.EXTERNAL_TUNNEL_TABLE,
                ...
                0, // idleTimeout
                0, // hardTimeout
                Uint64.valueOf(ITMConstants.COOKIE_ITM_EXTERNAL.toJava().add(BigInteger.valueOf(elanTag))),
                buildMatchesForVni(Uint64.valueOf(ElanUtils.getVxlanSegmentationId(elanInfo))),
    ...
    public void setupTerminateServiceTable(ElanInstance elanInfo, Uint64 dpId, long elanTag,
            TypedWriteTransaction<Configuration> writeFlowGroupTx) {
        ...
        FlowEntity flowEntity = MDSALUtil.buildFlowEntity(dpId, NwConstants.INTERNAL_TUNNEL_TABLE,
                ...
                elanTag), 0, 0, Uint64.valueOf(ITMConstants.COOKIE_ITM.toJava().add(BigInteger.valueOf(elanTag))),
