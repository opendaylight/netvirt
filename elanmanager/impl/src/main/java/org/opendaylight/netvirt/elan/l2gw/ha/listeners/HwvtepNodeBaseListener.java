...
public abstract class HwvtepNodeBaseListener implements DataTreeChangeListener<Node>, AutoCloseable {
    ...
    public static final Logger LOG = LoggerFactory.getLogger("HwvtepEventLogger");
    ...
    public HwvtepNodeBaseListener(DataBroker dataBroker) throws Exception {
        this.dataBroker = dataBroker;
    }

    protected void  registerListener(LogicalDatastoreType datastoreType, DataBroker broker,
                                     final HwvtepNodeBaseListener listener) throws Exception {
        ...
        registration = looper.loopUntilNoException(() ->
                broker.registerDataTreeChangeListener(treeId, listener));
    }
    ...
    public void onDataTreeChanged(final Collection<DataTreeModification<Node>> changes) {
        HAJobScheduler.getInstance().submitJob(() -> {
            ...
            try {
                ...
                LOG.error("Failed to copy ha updates", e3);
            }
        });
    }
    ...
    private void processDisconnectedNodes(Collection<DataTreeModification<Node>> changes,
        ...
        for (DataTreeModification<Node> change : changes) {
            ...
            try {
                ...
                LOG.error("Exception during Processing DisConnected Node {}", nodeId, e);
            }
        }
    }
