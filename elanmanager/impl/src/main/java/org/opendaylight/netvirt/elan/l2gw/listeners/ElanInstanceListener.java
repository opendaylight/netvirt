...
@Singleton
public class ElanInstanceListener extends AsyncClusteredDataTreeChangeListenerBase<ElanInstance, ElanInstanceListener> implements ElanRecoverableListener {
    ...
    @Inject
    public ElanInstanceListener(final DataBroker db, final ElanClusterUtils elanClusterUtils, final ElanServiceRecoveryHandler elanServiceRecoveryHandler) {
        super(ElanInstance.class, ElanInstanceListener.class);
        broker = db;
        this.txRunner = new ManagedNewTransactionRunnerImpl(db);
        this.elanClusterUtils = elanClusterUtils;
        registerListener();
        elanServiceRecoveryHandler.addRecoverableListener(this);
    }
