...
public class BcGroupUpdateJob extends DataStoreJob {
    ...
    public List<ListenableFuture<Void>> call() throws Exception {
        ...
        if (addedDpn != null && add) {
            installDpnDefaultFlows(elanName, Uint64.valueOf(addedDpn));
    ...
    public void installDpnDefaultFlows(String elan, Uint64 dpnId, L2GatewayDevice device) {
        ...
        if (INSTALLED_FLOW_FOR_TUNNEL.putIfAbsent(Pair.of(dpnId.toJava(), device.getTunnelIp()), Boolean.TRUE) == null) {
    ...
    public void makeTunnelIngressFlow(Uint64 dpnId, long portNo, String interfaceName, int ifIndex) {
        ...
        mkInstructions.add(new InstructionWriteMetadata(Uint64.fromLongBits(MetaDataUtil.getLportTagMetaData(ifIndex).longValue() | 1L),
