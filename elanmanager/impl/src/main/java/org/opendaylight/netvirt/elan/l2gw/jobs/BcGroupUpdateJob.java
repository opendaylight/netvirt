...
public class BcGroupUpdateJob extends DataStoreJob {
    ...
    public List<ListenableFuture<Void>> call() throws Exception {
        ...
        if (elanInstanceOptional.isPresent()) {
            txRunner.callWithNewWriteOnlyTransactionAndSubmit(CONFIGURATION, confTx -> elanL2GatewayMulticastUtils
                    .updateRemoteBroadcastGroupForAllElanDpns(elanInstanceOptional.get(), confTx));
        }
        return null;
    }
